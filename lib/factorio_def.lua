...
defines = {
  ...
  prototypes = {
    achievement = {
      ...
      use__entity__in__energy__production__achievement = 29,
      use__item__achievement = 30,
    },
    active__trigger = {
    ...
    entity = {
      ...
      curved__rail__a = 30,
      curved__rail__b = 31,
      decider__combinator = 32,
      deconstructible__tile__proxy = 33,
      display__panel = 34,
      electric__energy__interface = 35,
      electric__pole = 36,
      electric__turret = 37,
      elevated__curved__rail__a = 38,
      elevated__curved__rail__b = 39,
      elevated__half__diagonal__rail = 40,
      elevated__straight__rail = 41,
      entity__ghost = 42,
      explosion = 43,
      fire = 44,
      fish = 45,
      ...
      fluid__wagon = 47,
      furnace = 48,
      fusion__generator = 49,
      fusion__reactor = 50,
      gate = 51,
      generator = 52,
      half__diagonal__rail = 53,
      heat__interface = 54,
      heat__pipe = 55,
      highlight__box = 56,
      infinity__cargo__wagon = 57,
      ...
      segment = 103,
      segmented__unit = 104,
      selector__combinator = 105,
      simple__entity = 106,
      simple__entity__with__force = 107,
      simple__entity__with__owner = 108,
      smoke__with__trigger = 109,
      solar__panel = 110,
      space__platform__hub = 111,
      speech__bubble = 112,
      spider__leg = 113,
      spider__unit = 114,
      spider__vehicle = 115,
...
---@alias defines.cargo_destination number
...
---@alias defines.logistic_group_type number
...
---@alias defines.prototypes.mod_data number
...
---@alias defines.segmented_unit_activity_mode number
---@alias defines.segmented_unit_ai_state number
---@alias defines.segmented_unit_created_cause number
...
---@alias defines.territory_created_cause number
...
--- concepts
  ...
  ---@alias AddRecordData {station: string, rail: LuaEntity, rail_direction: defines.rail_direction, temporary: boolean, created_by_interrupt: boolean, allows_unloading: boolean, wait_conditions: WaitCondition[], index: ScheduleRecordPosition}
  ...
  ---@alias Alert {tick: uint32, target: LuaEntity, prototype: LuaEntityPrototype, position: MapPosition, icon: SignalID, message: LocalisedString}
  ...
  ---@alias AmmoType {action: TriggerItem[], target_type: TargetType, clamp_position: boolean, energy_consumption: double, range_modifier: double, cooldown_modifier: double, consumption_modifier: float, target_filter: string[]}
  ...
  ---@alias ArithmeticCombinatorParameters {first_signal: SignalID, first_signal_networks: CircuitNetworkSelection, first_constant: int32, operation: ArithmeticCombinatorParameterOperation, second_signal: SignalID, second_signal_networks: CircuitNetworkSelection, second_constant: int32, output_signal: SignalID}
  ...
  ---@alias AsteroidMapSettings {spawning_rate: double, max_ray_portals_expanded_per_tick: uint32}
  ---@alias AttackParameterFluid {type: string, damage_modifier: double}
  ---@alias AttackParameters {type: "projectile" | "stream" | "beam", range: float, min_range: float, range_mode: RangeMode, fire_penalty: float, rotate_penalty: float, health_penalty: float, min_attack_distance: float, turn_range: float, damage_modifier: float, ammo_consumption_modifier: float, cooldown: float, warmup: uint32, movement_slow_down_factor: double, movement_slow_down_cooldown: float, ammo_type: AmmoType, ammo_categories: string[]}
  ---@alias AttackReactionItem {range: float, action: TriggerItem, reaction_modifier: float, damage_type: LuaDamagePrototype}
  ...
  ---@alias AutoplaceSpecification {placement_density: uint32, control: string, probability_expression: NoiseExpressionSourceString, richness_expression: NoiseExpressionSourceString, order: string, default_enabled: boolean, tile_restriction: AutoplaceSpecificationRestriction[], force: string}
  ...
  ---@alias BlueprintEntity {entity_number: uint32, name: string, position: MapPosition, direction: defines.direction, mirror: boolean, quality: string, items: BlueprintInsertPlan[], tags: Tags, wires: BlueprintWire[], burner_fuel_inventory: BlueprintInventoryWithFilters}
  ...
  ---@alias BlueprintItemFilter {index: uint32, name: ItemID, quality: QualityID, comparator: ComparatorString}
  ---@alias BlueprintItemIDAndQualityIDPair {name: string, quality: string}
  ---@alias BlueprintLogisticFilter {index: LogisticFilterIndex, type: SignalIDType, name: string, quality: string, comparator: ComparatorString, count: int32, max_count: ItemCountType, minimum_delivery_count: ItemCountType, import_from: string}
  ...
  ---@alias BlueprintSignalIcon {signal: SignalID, index: uint32}
  ---@alias BlueprintWire tuple<uint32, defines.wire_connector_id, uint32, defines.wire_connector_id>
  ---@alias BlueprintWireEnd {entity: BlueprintEntity, surface_index: uint32, connector: defines.wire_connector_id}
  ...
  ---@alias CargoDestination {type: defines.cargo_destination, station: LuaEntity, hatch: LuaCargoHatch, transform_launch_products: boolean, surface: SurfaceIdentification, position: MapPosition, land_at_exact_position: boolean, space_platform: LuaSpacePlatform}
  ---@alias CargoLandingPadBlueprintControlBehavior {circuit_mode_of_operation: defines.control_behavior.cargo_landing_pad.exclusive_mode}
  ---@alias ChartTagSpec {position: MapPosition, icon: SignalID, text: string, last_user: PlayerIdentification}
  ---@alias ChunkPosition {x: int32, y: int32} | (tuple<int32, int32>)
  ---@alias ChunkPositionAndArea {x: int32, y: int32, area: BoundingBox}
  ---@alias CircuitCondition {comparator: ComparatorString, first_signal: SignalID, second_signal: SignalID, constant: int32}
  ---@alias CircuitConditionDefinition {comparator: ComparatorString, first_signal: SignalID, second_signal: SignalID, constant: int32, fulfilled: boolean}
  ...
  ---@alias CompiledLogisticFilter {index: LogisticFilterIndex, type: SignalIDType, name: string, quality: string, comparator: ComparatorString, count: int32, max_count: ItemCountType, minimum_delivery_count: ItemCountType}
  ...
  ---@alias CraftingQueueItem {index: uint32, recipe: string, count: uint32, prerequisite: boolean}
  ...
  ---@alias CustomCommandData {name: string, tick: uint32, player_index: uint32, parameter: string}
  ---@alias CustomEntityStatus {diode: defines.entity_status_diode, label: LocalisedString}
  ---@alias CustomTooltipField {name: LocalisedString, value: LocalisedString, quality_header: string, quality_values: table<string, LocalisedString>, order: uint8, show_in_factoriopedia: boolean, show_in_tooltip: boolean}
  ---@alias CutsceneWaypoint {position: MapPosition, target: LuaEntity | LuaCommandable, transition_time: uint32, time_to_wait: uint32, zoom: double}
  ...
  ---@alias DeciderCombinatorCondition {first_signal: SignalID, first_signal_networks: CircuitNetworkSelection, second_signal: SignalID, second_signal_networks: CircuitNetworkSelection, constant: int32, comparator: ComparatorString, compare_type: "and" | "or"}
  ---@alias DeciderCombinatorOutput {signal: SignalID, copy_count_from_input: boolean, constant: int32, networks: CircuitNetworkSelection}
  ...
  ---@alias DecorativeResult {position: TilePosition, decorative: LuaDecorativePrototype, amount: uint32}
  ---@alias DetailedItemOnLine {stack: LuaItemStack, position: float, unique_id: uint32}
  ...
  ---@alias DisplayResolution {width: uint32, height: uint32}
  ...
  ---@alias EjectedItem {item: ItemIDAndQualityIDPair, position: MapPosition, movement: Vector, platform_speed_at_creation: double, creation_tick: MapTick, expiration_tick: MapTick}
  ...
  ---@alias EquipmentPoint {x: uint32, y: uint32}
  ---@alias EquipmentPosition {x: int32, y: int32} | (tuple<int32, int32>)
  ---@alias EquipmentPrototypeFilter {filter: "item-to-place" | "type", mode: "or" | "and", invert: boolean}
  ---@alias EquipmentWithQualityCounts {name: string, count: uint32, quality: string}
  ---@alias EquipmentWithQualityID LuaEquipmentPrototype | LuaEquipment | string | EquipmentIDAndQualityIDPair
  ---@alias EventData {name: defines.events, tick: uint32, mod_name: string}
  ...
  ---@alias FluidBoxConnectionRecord {this_linked_connection_id: uint32, other_entity: LuaEntity, other_linked_connection_id: uint32}
  ...
  ---@alias FluidProduct {type: "fluid", name: string, amount: double, amount_min: double, amount_max: double, probability: double, ignored_by_stats: double, ignored_by_productivity: double, temperature: float, fluidbox_index: uint32}
  ...
  ---@alias GuiAnchor {gui: defines.relative_gui_type, position: defines.relative_gui_position, type: string, name: string, names: string[], ghost_mode: "both" | "only_ghosts" | "only_real"}
  ---@alias GuiArrowSpecification {margin: uint32, type: GuiArrowType}
  ...
  ---@alias GuiLocation {x: int32, y: int32} | (tuple<int32, int32>)
  ...
  ---@alias HeatSetting {temperature: double, mode: HeatSettingMode}
  ...
  ---@alias IconDrawSpecification {shift: Vector, scale: float, scale_for_many: float, render_layer: "entity-info-icon" | "entity-info-icon-above" | "air-entity-info-icon"}
  ---@alias IconSequencePositioning {inventory_index: defines.inventory, max_icons_per_row: uint8, max_icon_rows: uint8, shift: Vector, scale: float, separation_multiplier: float, multi_row_initial_height_modifier: float}
  ---@alias InfinityInventoryFilter {name: ItemID, quality: QualityID, count: ItemCountType, mode: "at-least" | "at-most" | "exactly", index: uint32}
  ---@alias InfinityPipeFilter {name: string, percentage: double, temperature: double, mode: "at-least" | "at-most" | "exactly" | "add" | "remove"}
  ---@alias Ingredient {type: "item" | "fluid", name: string, amount: double, ignored_by_stats: uint32 | double}
  ---@alias InserterBlueprintControlBehavior {circuit_set_filters: boolean, circuit_read_hand_contents: boolean, circuit_hand_read_mode: defines.control_behavior.inserter.hand_read_mode, circuit_set_stack_size: boolean, stack_control_input_signal: SignalID, circuit_enabled: boolean, circuit_condition: CircuitCondition, connect_to_logistic_network: boolean, logistic_condition: CircuitCondition}
  ---@alias InventoryIndex uint8
  ---@alias InventoryPosition {inventory: defines.inventory, stack: ItemStackIndex, count: ItemCountType}
  ---@alias InventoryWithCustomStackSizeSpecification {stack_size_multiplier: double, stack_size_min: ItemCountType, stack_size_max: ItemCountType, stack_size_override: table<string, ItemCountType>, with_bar: boolean}
  ...
  ---@alias ItemStackLocation {inventory: defines.inventory, slot: uint32}
  ...
  ---@alias LampBlueprintControlBehavior {use_colors: boolean, red_signal: SignalID, green_signal: SignalID, blue_signal: SignalID, rgb_signal: SignalID, color_mode: defines.control_behavior.lamp.color_mode, circuit_enabled: boolean, circuit_condition: CircuitCondition, connect_to_logistic_network: boolean, logistic_condition: CircuitCondition}
  ...
  ---@alias LogisticContainerBlueprintControlBehavior {circuit_mode_of_operation: defines.control_behavior.logistic_container.exclusive_mode, circuit_condition_enabled: boolean, circuit_condition: CircuitCondition}
  ---@alias LogisticFilter {value: SignalFilter, min: int32, max: ItemCountType, minimum_delivery_count: ItemCountType, import_from: SpaceLocationID}
  ---@alias LogisticFilterIndex uint16
  ---@alias LogisticGroup {members: LuaLogisticSection[], filters: LogisticFilter[]}
  ---@alias LogisticSection {index: uint8, filters: BlueprintLogisticFilter[], group: string, multiplier: float, active: boolean}
  ---@alias LogisticSections {sections: LogisticSection[], trash_not_requested: boolean}
  ---@alias LogisticsNetworkSupplyCounts {storage: uint32, passive__provider: uint32, buffer: uint32, active__provider: uint32}
  ...
  ---@alias LuaEventType LuaCustomEventPrototype | LuaCustomInputPrototype | defines.events | string
  ...
  ---@alias MapLocation {position: MapLocation, direction: defines.direction}
  ...
  ---@alias MineableProperties {minable: boolean, mining_time: double, transfer_entity_health_to_products: boolean, mining_particle: string, products: Product[], fluid_amount: double, required_fluid: string, mining_trigger: TriggerItem[]}
  ---@alias MiningDrillBlueprintControlBehavior {circuit_read_resources: boolean, circuit_resource_read_mode: defines.control_behavior.mining_drill.resource_read_mode, circuit_enabled: boolean, circuit_condition: CircuitCondition, connect_to_logistic_network: boolean, logistic_condition: CircuitCondition}
  ---@alias ModChangeData {old_version: string, new_version: string}
  ---@alias ModSetting {value: int32 | double | boolean | string | Color}
  ...
  ---@alias NeighbourConnectable {affected_by_direction: boolean, neighbour_search_distance: float, connections: NeighbourConnectableConnectionDefinition[]}
  ...
  ---@alias NthTickEventData {tick: uint32, nth_tick: uint32}
  ...
  ---@alias PerceivedPerformance {minimum: double, maximum: double, performance_to_activity_rate: double}
  ---@alias PipeConnection {flow_direction: FluidFlowDirection, connection_type: PipeConnectionType, position: MapPosition, target_position: MapPosition, target: LuaFluidBox, target_fluidbox_index: uint32, target_pipe_connection_index: uint32}
  ---@alias PipeConnectionDefinition {connection_type: PipeConnectionType, positions: MapPosition[], max_underground_distance: uint32, flow_direction: FluidFlowDirection, direction: defines.direction, connection_category: string[], linked_connection_id: uint32}
  ...
  ---@alias PlaceAsTileResult {result: LuaTilePrototype, condition_size: uint32, condition: CollisionMask, invert: boolean, tile_condition: LuaTilePrototype[]}
  ---@alias PlatformSchedule {current: uint32, records: ScheduleRecord[]}
  ---@alias PlaySoundSpecification {path: SoundPath, position: MapPosition, volume_modifier: double, override_sound_type: SoundType}
  ---@alias PlayerIdentification uint32 | string | LuaPlayer
  ...
  ---@alias ProgrammableSpeakerCircuitParameters {signal_value_is_pitch: boolean, stop_playing_sounds: boolean, instrument_id: uint32, note_id: uint32}
  ---@alias ProgrammableSpeakerInstrument {name: string, notes: string[]}
  ---@alias ProgrammableSpeakerParameters {playback_volume: float, playback_mode: ProgrammableSpeakerPlaybackMode, allow_polyphony: boolean, volume_controlled_by_signal: boolean, volume_signal_id: SignalID}
  ...
  ---@alias RocketSiloBlueprintControlBehavior {read_items_mode: defines.control_behavior.rocket_silo.read_mode}
  ...
  ---@alias ScheduleRecord {station: string, rail: LuaEntity, rail_direction: defines.rail_direction, wait_conditions: WaitCondition[], temporary: boolean, created_by_interrupt: boolean, allows_unloading: boolean}
  ---@alias ScheduleRecordPosition {schedule_index: uint32, interrupt_index: uint32}
  ---@alias ScriptArea {area: BoundingBox, name: string, color: Color, id: uint32}
  ---@alias ScriptPosition {position: MapPosition, name: string, color: Color, id: uint32}
  ...
  ---@alias SegmentEngineSpecification {segments: SegmentSpecification[], max_body_nodes: uint32}
  ---@alias SegmentSpecification {segment: LuaEntityPrototype, distance_from_head: double}
  ---@alias SegmentedUnitAIState {type: defines.segmented_unit_ai_state}
  ...
  ---@alias Signal {signal: SignalID, count: int32}
  ...
  ---@alias SlotFilter {index: uint32, name: string}
  ...
  ---@alias SpaceLocationAsteroidSpawnDefinition {type: string, asteroid: string, probability: double, speed: double, angle_when_stopped: float}
  ...
  ---@alias SpiderEngineSpecification {legs: SpiderLegSpecification[], walking_group_overlap: float}
  ---@alias SpiderLegSpecification {leg: string, mount_position: Vector, ground_position: Vector, leg_hit_the_ground_trigger: TriggerEffectItem[], leg_hit_the_ground_when_attacking_trigger: TriggerEffectItem[], walking_group: uint8}
  ...
  ---@alias SpoilToTriggerResult {trigger: TriggerItem[], items_per_trigger: uint32}
  ...
  ---@alias SurfaceIdentification uint32 | string | LuaSurface
  ...
  ---@alias TerritorySettings {units: string[], territory_index_expression: string, territory_variation_expression: string, minimum_territory_size: uint32}
  ---@alias TextAlign "left" | "right" | "center"
  ---@alias ThrusterPerformancePoint {fluid_volume: double, fluid_usage: double, effectivity: double}
  ...
  ---@alias TilePosition {x: int32, y: int32} | (tuple<int32, int32>)
  ...
  ---@alias TileSearchFilters {area: BoundingBox, position: MapPosition, radius: double, name: TileID | TileID[], limit: uint32, has_hidden_tile: boolean, has_double_hidden_tile: boolean, has_tile_ghost: boolean, to_be_deconstructed: boolean, collision_mask: CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>), force: ForceSet, invert: boolean}
  ---@alias TrainFilter {train_id: uint32, surface: SurfaceIdentification, force: ForceID, stock: EntityID | EntityID[], min_stocks: uint32, max_stocks: uint32, is_moving: boolean, has_passenger: boolean, is_manual: boolean, group: string}
  ---@alias TrainPathAllGoalsResult {amount_accessible: uint32, accessible: boolean[], penalties: double[], steps_count: uint32}
  ---@alias TrainPathFinderGoal TrainStopGoal | RailEndGoal | LuaRailEnd | LuaEntity
  ---@alias TrainPathFinderOneGoalResult {found_path: boolean, goal_index: uint32, start_index: uint32, penalty: double, is_front: boolean, total_length: double, path: LuaEntity[], steps_count: uint32}
  ---@alias TrainPathRequestType "path" | "any-goal-accessible" | "all-goals-accessible" | "all-goals-penalties"
  ---@alias TrainSchedule {current: uint32, records: ScheduleRecord[]}
  ...
  ---@alias TransportBeltBlueprintControlBehavior {circuit_read_hand_contents: boolean, circuit_contents_read_mode: defines.control_behavior.transport_belt.content_read_mode, circuit_enabled: boolean, circuit_condition: CircuitCondition, connect_to_logistic_network: boolean, logistic_condition: CircuitCondition}
  ...
  ---@alias TriggerEffectWithCooldown {distance_cooldown: double, initial_distance_cooldown: double, time_cooldown: MapTick, initial_time_cooldown: MapTick, effect: TriggerEffectItem[]}
  ---@alias TriggerItem {type: "direct" | "area" | "line" | "cluster", action_delivery: TriggerDelivery[], entity_flags: EntityPrototypeFlags, ignore_collision_condition: boolean, collision_mask: CollisionMask, trigger_target_mask: TriggerTargetMask, force: ForceCondition, repeat_count: uint32, probability: float}
  ---@alias TriggerModifierData {damage_modifier: float, damage_addition: float, radius_modifier: float}
  ...
  ---@alias UnitGroupMapSettings {min_group_gathering_time: uint32, max_group_gathering_time: uint32, max_wait_time_for_late_members: uint32, min_group_radius: double, max_group_radius: double, max_member_speedup_when_behind: double, max_member_slowdown_when_ahead: double, max_group_slowdown_factor: double, max_group_member_fallback_factor: double, member_disown_distance: double, tick_tolerance_when_member_arrives: uint32, max_gathering_unit_groups: uint32, max_unit_group_size: uint32}
  ---@alias UnitSpawnDefinition {unit: string, spawn_points: SpawnPointDefinition[]}
  ---@alias UpgradeMapperDestination {type: "item" | "entity", name: string, quality: string, module_limit: uint16, module_slots: BlueprintItemIDAndQualityIDPair[]}
  ...
  ---@alias WaitCondition {type: WaitConditionType, compare_type: "and" | "or", ticks: uint32, condition: CircuitCondition | BlueprintItemIDAndQualityIDPair, planet: string, station: string, damage: uint32}
  ...
  ---@alias WorkerRobotOrder {type: defines.robot_order_type, target: LuaEntity, item_to_place: ItemWithQualityCount, secondary_target: LuaEntity, cliff_explosive_id: LuaItemPrototype, target_item: ItemIDAndQualityIDPair, target_count: ItemCountType}
  ---@alias ZoomLimits {closest: ZoomSpecification, furthest: ZoomSpecification, furthest_game_view: ZoomSpecification}
  ---@alias ZoomSpecification {zoom: double, distance: double, max_distance: double}
  ---@alias double number
  ---@alias float number
  ---@alias int16 number
  ---@alias int32 number
...
---@class LuaAISettings: any @Collection of settings for overriding default ai behavior.
  ...
  ---@field join_attacks boolean @If enabled, the unit will join attack groups.
  ...
  ---@field size_in_group float @The number of "slots" that the unit takes up in a unit group. Must be greater than 0. If this value is changed after the unit has been added to a group, the exact behavior is undefined.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaAISettings = {}

---@class LuaAccumulatorControlBehavior: any @Control behavior for accumulators.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaAchievementPrototype: any @Prototype of a achievement.
  ...
  ---@field amount uint32 @ nilable
  ---@field armor LuaItemPrototype @ nilable
  ---@field count uint32 @ nilable
  ...
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field within uint32 @ nilable
LuaAchievementPrototype = {}

---@class LuaActiveTriggerPrototype: any @Prototype of an Active Trigger.
  ---@field fork_chance double @The chance that a new fork will spawn after each jump [0,1]. default = 0.
  ---@field jump_delay_ticks uint32 @The tick delay between each jump. 0 = all jumps instantaneous. default = 0.
  ---@field max_forks uint32 @maximum number of forks allowed to spawn for the entire chain. default = infinity.
  ---@field max_forks_per_jump uint32 @The maximum number of forks that can spawn from a single jump. default = 1.
  ---@field max_jumps uint32 @The max number of jumps per trigger. default = 5.
...
---@class LuaAgriculturalTowerControlBehavior: any @Control behavior for agricultural tower
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaAirbornePollutantPrototype: any @Airborne pollutant prototype.
...
---@class LuaAmmoCategoryPrototype: any @Prototype of a ammo category.
  ...
  ---@field factoriopedia_alternative LuaAmmoCategoryPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaAmmoCategoryPrototype = {}

---@class LuaArithmeticCombinatorControlBehavior: any @Control behavior for arithmetic combinators.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field parameters ArithmeticCombinatorParameters @ nilable; This arithmetic combinator's parameters. Writing `nil` clears the combinator's parameters.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaArithmeticCombinatorControlBehavior = {}

---@class LuaArtilleryTurretControlBehavior: any @Control behavior for artillery turrets.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaAssemblingMachineControlBehavior: any @Control behavior for assembling machines.
  ...
  ---@field include_fuel boolean @`true` if the read contents should include fuel (content of energy source)
  ---@field include_in_crafting boolean @`true` if the read contents should include items in crafting.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaAssemblingMachineControlBehavior = {}

---@class LuaAsteroidChunkPrototype: any @Prototype of an asteroid chunk.
  ---@field dying_trigger_effect TriggerEffectItem[] @ nilable
  ---@field factoriopedia_alternative LuaAsteroidChunkPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
...
---@class LuaAsteroidCollectorControlBehavior: any @Control behavior for asteroid collectors.
  ---@field include_hands boolean @`true` if read contents should include content of hands (items that were captured but are not yet in the asteroid collector's main inventory).
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@return defines.events @The newly generated event ID. This will be a new value that does not correspond to any named entry in defines.events.
function LuaBootstrap.generate_event_name() end

--- Gets the filters for the given event.
---@param event LuaEventType @ID of the event to get.
---@return EventFilter @The filters or `nil` if none are defined.
function LuaBootstrap.get_event_filter(event) end

--- Find the event handler for an event.
---@param event LuaEventType @The event identifier to get a handler for.
...
function LuaBootstrap.get_event_id(event) end
...
---@overload fun(event: LuaEventType | LuaEventType[], handler: (fun(p0: EventData)) | nil)
...
---@param tick uint32 | uint32[] | nil @The nth-tick(s) to invoke the handler on. Passing `nil` as the only parameter will unregister all nth-tick handlers.
...
---@param player_index uint32 @The player doing the chatting.
---@param message string @The chat message to send.
function LuaBootstrap.raise_console_chat(player_index, message) end
...
---@param player_index uint32 @The player who did the purchasing.
---@param market LuaEntity @The market entity.
---@param offer_index uint32 @The index of the offer purchased.
---@param count uint32 @The amount of offers purchased.
function LuaBootstrap.raise_market_item_purchased(player_index, market, offer_index, count) end

---@param item_stack LuaItemStack @The item that has been crafted.
---@param player_index uint32 @The player doing the crafting.
---@param recipe RecipeID @The recipe used to craft this item.
function LuaBootstrap.raise_player_crafted_item(item_stack, player_index, recipe) end

---@param player_index uint32 @The player transferred from or to.
...
---@param is_split boolean @Whether the transfer was a split action (half stack).
function LuaBootstrap.raise_player_fast_transferred(player_index, entity, from_player, is_split) end
...
---@param segmented_unit LuaSegmentedUnit @The segmented unit that was destroyed.
function LuaBootstrap.raise_script_destroy_segmented_unit(segmented_unit) end
...
---@param surface_index uint32 @The surface whose tiles have been changed.
---@param tiles Tile[] @The tiles that have been changed.
function LuaBootstrap.raise_script_set_tiles(surface_index, tiles) end

---@param entity LuaEntity @The entity that was teleported.
---@param old_surface_index uint8 @The entity's surface before the teleportation.
---@param old_position MapPosition @The entity's position before the teleportation.
function LuaBootstrap.raise_script_teleported(entity, old_surface_index, old_position) end
...
--- ```
---@param event LuaEventType @ID of the event to filter.
---@param filters EventFilter|nil @The filters or `nil` to clear them.
---@overload fun(event: LuaEventType)
...
---@class LuaBurnerPrototype: any @Prototype of a burner energy source.
  ---@field burnt_inventory_size uint32
  ...
  ---@field fuel_inventory_size uint32
  ---@field initial_fuel LuaItemPrototype @ nilable
...
---@class LuaBurnerUsagePrototype: any @Description of burner usage.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaBurnerUsagePrototype = {}

---@class LuaCargoHatch: any @A cargo hatch.
  ---@field busy boolean
...
---@return LuaEntity
function LuaCargoHatch.create_cargo_pod() end

---@class LuaCargoLandingPadControlBehavior: any @Control behavior for cargo landing pad.
...
---@class LuaCircuitNetwork: any @A circuit network associated with a given entity, connector, and wire type.
  ---@field connected_circuit_count uint32 @The number of circuits connected to this network.
  ---@field entity LuaEntity @The entity this circuit network reference is associated with.
  ---@field network_id uint32 @The circuit networks ID.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaCollisionLayerPrototype: any @Prototype of a collision layer.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaCollisionLayerPrototype = {}

---@class LuaCombinatorControlBehavior: any
...
---@class LuaCommandable: any @AI object which can be ordered commands. This can represent a UnitGroup (a set of multiple commandables) or can be a single Unit or SpiderUnit.
  ...
  ---@field is_script_driven boolean @Whether this unit group is controlled by a script or by the game engine. This can be changed using [LuaCommandable::set_autonomous](runtime:LuaCommandable::set_autonomous). Units created by [LuaSurface::create_unit_group](runtime:LuaSurface::create_unit_group) are considered script-driven.
  ...
  ---@field unique_id uint32 @Unique identifier of this commandable.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaCommandable = {}
...
---@class LuaConstantCombinatorControlBehavior: any @Control behavior for constant combinators.
  ...
  ---@field sections_count uint32 @Amount of logistic sections this constant combinator has.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@param section_index uint32 @Index of the section.
...
---@class LuaContainerControlBehavior: any @Control behavior for container entities.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaControl: any @This is an abstract base class containing the common functionality between [LuaPlayer](runtime:LuaPlayer) and entities (see [LuaEntity](runtime:LuaEntity)). When accessing player-related functions through a [LuaEntity](runtime:LuaEntity), it must refer to a character entity.
  ---@field build_distance uint32 @The build distance of this character or max uint when not a character or player connected to a character.
  ---@field cargo_pod LuaEntity @ nilable; The cargo pod the player is currently sitting in or the cargo pod attached to this rocket silo.
  ...
  ---@field character_build_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ...
  ---@field character_inventory_slots_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ---@field character_item_drop_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ---@field character_item_pickup_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ---@field character_loot_pickup_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ---@field character_maximum_following_robot_count_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ...
  ---@field character_reach_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ---@field character_resource_reach_distance_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ...
  ---@field character_trash_slot_count_bonus uint32 @When called on a [LuaPlayer](runtime:LuaPlayer), it must be associated with a character (see [LuaPlayer::character](runtime:LuaPlayer::character)).
  ...
  ---@field crafting_queue_size uint32 @Size of the crafting queue.
  ...
  ---@field drop_item_distance uint32 @The item drop distance of this character or max uint when not a character or player connected to a character.
  ---@field flight_height double @The current flight height for this player or character entity. When called on an entity, only valid if this entity is a character.
  ...
  ---@field force_index uint32 @Unique [index](runtime:LuaForce::index) (ID) associated with the force of this entity.
  ---@field hub LuaEntity @ nilable; The space platform hub the player is currently sitting in.
  ---@field in_combat boolean @Whether this character entity is in combat.
  ---@field is_flying boolean @If this player or character entity is flying. When called on an entity, only valid if this entity is a character.
  ...
  ---@field reach_distance uint32 @The reach distance of this character or max uint when not a character or player connected to a character.
  ---@field render_position MapPosition @The current render position of the entity.
  ...
  ---@field surface_index uint32 @Unique [index](runtime:LuaSurface::index) (ID) associated with the surface this entity is currently on.
  ---@field vehicle LuaEntity @ nilable; The vehicle the player is currently sitting in.
  ---@field walking_state {walking: boolean, direction: defines.direction} @Current walking state of the player, or the spider-vehicle the character is driving.
LuaControl = {}

--- Begins crafting the given count of the given recipe.
---@param count uint32 @The count to craft.
---@param recipe RecipeID @The recipe to craft.
...
---@overload fun(count: uint32, recipe: RecipeID): uint32
---@return uint32 @The count that was actually started crafting.
...
---@param name EntityID @Name of the entity that would be built.
---@param position MapPosition @Where the entity would be placed.
---@param direction defines.direction|nil @Direction the entity would be facing. Defaults to `north`.
---@overload fun(name: EntityID, position: MapPosition): boolean
---@return boolean
function LuaControl.can_place_entity(name, position, direction) end
...
---@param index uint32 @The crafting queue index.
---@param count uint32 @The count to cancel crafting.
function LuaControl.cancel_crafting(index, count) end
...
function LuaControl.close_factoriopedia_gui() end
...
---@return uint32 @The count that can be crafted.
...
---@param item ItemFilter|nil @The item to count. If not specified, count all items.
---@overload fun(): uint32
---@return uint32
...
---@return uint32 @The number of items that were actually inserted.
...
---@param prototype FactoriopediaID|nil
---@overload fun()
function LuaControl.open_factoriopedia_gui(prototype) end
...
---@return uint32 @The number of items that were actually removed.
...
---@param driving boolean @True for enter-vehicle, false for leave.
---@param force boolean|nil @If true, the player will be ejected and left at the position of the car if normal "leave" is not possible.
---@overload fun(driving: boolean)
function LuaControl.set_driving(driving, force) end

--- Create an arrow which points at this entity. This is used in the tutorial. For examples, see `control.lua` in the campaign missions.
---@param margin uint32
---@param type GuiArrowType @Where to point to. This field determines what other fields are mandatory.
function LuaControl.set_gui_arrow(margin, type) end
...
---@param build_check_type defines.build_check_type|nil @The build check type done when teleporting to the destination. Defaults to `script`. This is ignored when teleporting between surfaces.
---@overload fun(position: MapPosition, surface: SurfaceIdentification|nil, raise_teleported: boolean|nil, snap_to_grid: boolean|nil): boolean
...
function LuaControl.teleport(position, surface, raise_teleported, snap_to_grid, build_check_type) end
...
---@class LuaCustomChartTag: any @A custom tag that shows on the map view.
  ...
  ---@field icon SignalID @ nilable; This tag's icon, if it has one. Writing `nil` removes it.
  ---@field last_user LuaPlayer  | PlayerIdentification @ nilable; The player who last edited this tag.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field position MapPosition @The position of this tag.
  ---@field surface LuaSurface @The surface this tag belongs to.
  ---@field tag_number uint32 @The unique ID for this tag on this force.
  ---@field text string
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaCustomChartTag = {}
...
---@class LuaCustomEventPrototype: any @Prototype of a custom event.
  ---@field event_id defines.events @Event identifier associated with this custom event.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class LuaCustomInputPrototype: any @Prototype of a custom input.
  ...
  ---@field event_id defines.events @Event identifier associated with this custom input.
...
---@class LuaDeciderCombinatorControlBehavior: any @Control behavior for decider combinators.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field parameters DeciderCombinatorParameters @ nilable; This decider combinator's parameters. Writing `nil` clears the combinator's parameters.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaDeciderCombinatorControlBehavior = {}

--- Adds a new condition.
---@param condition DeciderCombinatorCondition @New condition to insert.
---@param index uint32|nil @Index to insert new condition at. If not specified, appends to the end.
...
---@param index uint32|nil @Index to insert new output at. If not specified, appends to the end.
...
---@param index uint32 @Index of condition to get.
...
---@param index uint32 @Index of output to get.
...
---@param index uint32 @Index of output to modify.
...
---@class LuaDecorativePrototype: any @Prototype of an optimized decorative.
  ...
  ---@field target_count uint32
  ---@field trigger_effect TriggerEffectItem[] @ nilable
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaDecorativePrototype = {}

---@class LuaDisplayPanelControlBehavior: any @Control behavior for display panels.
...
---@param index uint32 @Message index.
...
---@param index int32 @Message index. Use `-1` to append new element.
---@param message DisplayPanelMessageDefinition | nil @The message definition for the specified index. Specify `nil` to remove the message.
...
---@class LuaEntity: any @The primary interface for interacting with entities through the Lua API. Entities are everything that exists on the map except for tiles (see [LuaTile](runtime:LuaTile)). Most functions on LuaEntity also work when the entity is contained in a ghost.
  ...
  ---@field amount uint32 @Count of resource units contained.
  ...
  ---@field attached_cargo_pod LuaEntity @ nilable; The cargo pod attached to this rocket silo rocket if any.
  ...
  ---@field beacons_count uint32 @ nilable; Number of beacons affecting this effect receiver. Can only be used when the entity has an effect receiver (AssemblingMachine, Furnace, Lab, MiningDrills)
  ...
  ---@field belt_shape "straight" | "left" | "right" @Gives what is the current shape of a transport-belt.
  ---@field belt_to_ground_type BeltConnectionType @Whether this underground belt goes into or out of the ground.
  ...
  ---@field cargo_bay_connection_owner LuaEntity @ nilable; The space platform hub or cargo landing pad this cargo bay is connected to if any.
  ---@field cargo_hatches LuaCargoHatch[] @The cargo hatches owned by this entity if any.
  ---@field cargo_pod_destination CargoDestination @The destination of this cargo pod entity. Use [force_finish_ascending](runtime:LuaEntity::force_finish_ascending) if you want it to only descend from orbit.
  ---@field cargo_pod_origin LuaEntity @ nilable; The origin of this cargo pod entity. (Must be a silo, hub or pad)
  ---@field cargo_pod_state "awaiting_launch" | "ascending" | "surface_transition" | "descending" | "parking" @The state of this cargo pod entity.
  ...
  ---@field character_corpse_player_index uint32 @The player index associated with this character corpse. The index is not guaranteed to be valid so it should always be checked first if a player with that index actually exists.
  ---@field character_corpse_tick_of_death uint32 @The tick this character corpse died at.
  ---@field cliff_orientation CliffOrientation @The orientation of this cliff.
  ---@field color Color @ nilable; The color of this character, rolling stock, corpse, character corpse, train stop, simple-entity-with-owner, car, spider-vehicle, or lamp. `nil` if this entity doesn't use custom colors. Car color is overridden by the color of the current driver/passenger, if there is one.
  ...
  ---@field commandable LuaCommandable @ nilable; Returns a LuaCommandable for this entity or nil if entity is not commandable. Units and SpiderUnits are commandable.
  ...
  ---@field copy_color_from_train_stop boolean @If this rolling stock has 'copy color from train stop' enabled.
  ...
  ---@field crane_end_position_3d Vector3D @Returns current position in 3D for the end of the crane of this entity.
  ...
  ---@field created_by_corpse LuaEntity @ nilable; The corpse that caused this entity ghost to be created, if any.
  ...
  ---@field disabled_by_control_behavior boolean @If the updatable entity is disabled by control behavior. Always returns `false` if this entity is not considered [updatable](runtime:LuaEntity::is_updatable).
  ---@field disabled_by_recipe boolean @If the assembling machine is disabled by recipe, e.g. due to [AssemblingMachinePrototype::disabled_when_recipe_not_researched](prototype:AssemblingMachinePrototype::disabled_when_recipe_not_researched). Always returns `false` if this entity is not considered [updatable](runtime:LuaEntity::is_updatable).
  ---@field disabled_by_script boolean @If the updatable entity is disabled by script. Note: Some entities (Corpse, FireFlame, Roboport, RollingStock, dying entities) need to remain active and will ignore writes. If this entity is not considered [updatable](runtime:LuaEntity::is_updatable) then this always returns `false` and writes will be ignored.
  ---@field display_panel_always_show boolean
  ---@field display_panel_icon SignalID @ nilable; Icon visible on the display panel. Can be written only when it is not set by control behavior.
  ---@field display_panel_show_in_chart boolean
  ---@field display_panel_text LocalisedString @Text visible on the display panel. Can be written only when it is not set by control behavior.
  ...
  ---@field effectivity_modifier float @Multiplies the acceleration the car can create for one unit of energy. Defaults to `1`.
  ...
  ---@field electric_network_id uint32 @ nilable; Returns the id of the electric network that this entity is connected to, if any.
  ...
  ---@field filter_slot_count uint32 @The number of filter slots this inserter, loader, mining drill, asteroid collector or logistic storage container has. 0 if not one of those entities.
  ---@field fluidbox LuaFluidBox @Fluidboxes of this entity.
  ---@field fluids_count uint32 @Returns count of fluid storages. This includes fluid storages provided by fluidboxes but also covers other fluid storages like fluid turret's internal buffer and fluid wagon's fluid since they are not fluidbox and cannot be exposed through [LuaFluidBox](runtime:LuaFluidBox).
  ...
  ---@field frozen boolean @Whether the freezable entity is currently frozen. Always returns `false` if this entity is not considered [freezable](runtime:LuaEntity::is_freezable).
  ...
  ---@field ghost_unit_number uint64 @ nilable; The [unit_number](runtime:LuaEntity::unit_number) of the entity contained in this ghost. It is the same as the unit number of the [EntityWithOwnerPrototype](prototype:EntityWithOwnerPrototype) that was destroyed to create this ghost. If it was created by other means, or if the inner entity does not support unit numbers, this property is `nil`.
  ...
  ---@field heat_neighbours LuaEntity[] @The entities connected to this entities heat buffer.
  ...
  ---@field highlight_box_blink_interval uint32 @The blink interval of this highlight box entity. `0` indicates no blink.
  ...
  ---@field initial_amount uint32 @ nilable; Count of initial resource units contained. `nil` if this is not an infinite resource. If this is not an infinite resource, writing will produce an error.
  ...
  ---@field inserter_spoil_priority SpoilPriority @The spoil priority for this inserter.
  ---@field inserter_stack_size_override uint32 @Sets the stack size limit on this inserter. Set to `0` to reset.
  ---@field inserter_target_pickup_count uint32 @Returns the current target pickup count of the inserter. This considers the circuit network, manual override and the inserter stack size limit based on technology.
  ...
  ---@field is_freezable boolean @Whether the entity is freezable and considered a FreezableEntity.
  ...
  ---@field is_updatable boolean @Whether the entity is updatable and considered an UpdatableEntity.
  ---@field item_request_proxy LuaEntity @ nilable; The first found item request proxy targeting this entity.
  ---@field item_requests ItemWithQualityCounts @Items this ghost will request when revived or items this item request proxy is requesting.
  ---@field kills uint32 @The number of units killed by this turret, artillery turret, or artillery wagon.
  ---@field last_user LuaPlayer  | PlayerIdentification @ nilable; The last player that changed any setting on this entity. This includes building the entity, changing its color, or configuring its circuit network. `nil` if the last user is not part of the save anymore.
  ---@field link_id uint32 @The link ID this linked container is using.
  ---@field linked_belt_neighbour LuaEntity @ nilable; Neighbour to which this linked belt is connected to, if any. May return entity ghost which contains linked belt to which connection is made.
  ---@field linked_belt_type BeltConnectionType @Type of linked belt. Changing type will also flip direction so the belt is out of the same side. Can only be changed when linked belt is disconnected (has no neighbour set).
  ---@field loader_belt_stack_size_override uint8 @The belt stack size override for this loader. Set to `0` to disable. Writing this value requires [LoaderPrototype::adjustable_belt_stack_size](prototype:LoaderPrototype::adjustable_belt_stack_size) to be `true`.
  ...
  ---@field loader_filter_mode PrototypeFilterMode @ nilable; The filter mode for this loader. `nil` if this loader does not support filters.
  ---@field loader_type BeltConnectionType @Whether this loader gets items from or puts item into a container.
  ...
  ---@field neighbours (table<string, LuaEntity[]>) | LuaEntity[][] | LuaEntity @ nilable; A list of neighbours for certain types of entities. Applies to underground belts, walls, gates, reactors, heat pipes, cliffs, and pipe-connectable entities.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ...
  ---@field orientation RealOrientation @The smooth orientation of this entity. For turrets this is the orientation of the weapon.
  ---@field owned_plants LuaEntity[] @Plants registered by this agricultural tower. One plant can be registered in multiple agricultural towers.
  ---@field parameters ProgrammableSpeakerParameters
  ---@field pickup_from_left_lane boolean @For inserters taking items from transport belt connectables, this determines whether the inserter is allowed to take items from the left lane.
  ---@field pickup_from_right_lane boolean @For inserters taking items from transport belt connectables, this determines whether the inserter is allowed to take items from the right lane.
  ...
  ---@field priority_targets LuaEntityPrototype[] @The priority targets for this turret (if any).
  ...
  ---@field products_finished uint32 @The number of products this machine finished crafting in its lifetime.
  ...
  ---@field proxy_target_entity LuaEntity @ nilable; Entity of which inventory is exposed by this ProxyContainer
  ---@field proxy_target_inventory defines.inventory @Inventory index of the inventory that is exposed by this ProxyContainer
  ---@field pump_rail_target LuaEntity @ nilable; The rail target of this pump, if any.
  ---@field pumped_last_tick double @The amount of fluid moved by this offshore pump or normal pump in the last tick.
  ...
  ---@field render_player LuaPlayer  | PlayerIdentification @ nilable; The player that this `simple-entity-with-owner`, `simple-entity-with-force`, or `highlight-box` is visible to. `nil` when this entity is rendered for all players.
  ...
  ---@field rocket LuaEntity @ nilable; The rocket silo rocket this cargo pod is attached to, or rocket silo rocket attached to this rocket silo - if any.
  ---@field rocket_parts uint32 @Number of rocket parts in the silo.
  ...
  ---@field segmented_unit LuaSegmentedUnit @ nilable; The segmented unit object that the segment entity is a part of.
  ---@field selected_gun_index uint32 @ nilable; Index of the currently selected weapon slot of this character, car, or spidertron. `nil` if this entity doesn't have guns.
  ...
  ---@field storage_filter ItemIDAndQualityIDPair  | ItemWithQualityID @ nilable; The storage filter for this logistic storage container. Useable only on logistic containers with the `"storage"` [logistic_mode](runtime:LuaEntityPrototype::logistic_mode).
  ...
  ---@field tags Tags @ nilable; The tags associated with this entity ghost. `nil` if this is not an entity ghost or when the ghost has no tags.
  ...
  ---@field tick_of_last_attack uint32 @The last tick this character entity was attacked.
  ---@field tick_of_last_damage uint32 @The last tick this character entity was damaged.
  ---@field tile_height uint32 @Specifies the tiling size of the entity, is used to decide, if the center should be in the center of the tile (odd tile size dimension) or on the tile border (even tile size dimension). Uses the current direction of the entity.
  ---@field tile_width uint32 @Specifies the tiling size of the entity, is used to decide, if the center should be in the center of the tile (odd tile size dimension) or on the tile border (even tile size dimension). Uses the current direction of the entity.
  ---@field time_to_live uint64 @The ticks left before a combat robot, highlight box, smoke, or sticker entity is destroyed.
  ---@field time_to_next_effect uint32 @The ticks until the next trigger effect of this smoke-with-trigger.
  ---@field timeout uint32 @The timeout that's left on this landmine in ticks. It describes the time between the landmine being placed and it being armed.
  ...
  ---@field trains_count uint32 @Amount of trains related to this particular train stop. Includes train stopped at this train stop (until it finds a path to next target) and trains having this train stop as goal or waypoint. Train may be included multiple times when braking distance covers this train stop multiple times. Value may be read even when train stop has no control behavior.
  ---@field trains_in_block uint32 @The number of trains in this rail block for this rail entity.
  ---@field trains_limit uint32 @Amount of trains above which no new trains will be sent to this train stop. Writing nil will disable the limit (will set a maximum possible value). When a train stop has a control behavior with wire connected and set_trains_limit enabled, this value will be overwritten by it.
  ---@field transitional_request_target LuaSpacePlatform @ nilable; The space platform in orbit this rocket silo is automatically requesting items for.
  ...
  ---@field unit_number uint64 @ nilable; A unique number identifying this entity for the lifetime of the save. These are allocated sequentially, and not re-used (until overflow). Only entities inheriting from [EntityWithOwnerPrototype](prototype:EntityWithOwnerPrototype), as well as [ItemRequestProxyPrototype](prototype:ItemRequestProxyPrototype) and [EntityGhostPrototype](prototype:EntityGhostPrototype) are assigned a unit number. Returns `nil` otherwise.
  ...
  ---@field use_transitional_requests boolean @When true, the rocket silo will automatically request items for space platforms in orbit. Setting the value will have no effect when the silo doesn't support logistics.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field valve_threshold_override float @ nilable; The threshold override of this valve, or `nil` if an override is not defined. If no override is defined, the threshold is taken from [LuaEntityPrototype::valve_threshold](runtime:LuaEntityPrototype::valve_threshold).
...
---@return LuaEntity, LuaEntity @The first upgraded entity - `nil` if this entity is not marked for upgrade.; The second upgraded entity - `nil` if this entity is not marked for upgrade.
function LuaEntity.apply_upgrade() end
...
---@return boolean
function LuaEntity.can_set_inventory_filter(inventory_index, index, filter) end
...
---@overload fun(position: MapPosition, surface: LuaSurface|nil, force: ForceID|nil): LuaEntity
---@overload fun(position: MapPosition, surface: LuaSurface|nil): LuaEntity
---@overload fun(position: MapPosition): LuaEntity
---@return LuaEntity @The cloned entity or `nil` if this entity can't be cloned/can't be cloned to the given location.
function LuaEntity.clone(position, surface, force, create_build_effect_smoke) end
...
---@overload fun(entity: LuaEntity): ItemWithQualityCounts
---@return ItemWithQualityCounts @Any items removed from this entity as a result of copying the settings.
...
---@param cargo_hatch LuaCargoHatch|nil @The hatch to create the pod at. A random (available) one is picked if not provided.
---@overload fun(): LuaEntity
---@return LuaEntity
function LuaEntity.create_cargo_pod(cargo_hatch) end
...
---@param raise_destroy boolean|nil @If `true`, [script_raised_destroy](runtime:script_raised_destroy) will be called. Defaults to `false`.
---@param player PlayerIdentification|nil @The player whose undo queue this action should be added to.
---@param undo_index uint32|nil @The index of the undo item to add this action to. An index of `0` creates a new undo item for it. Defaults to putting it into the appropriate undo item automatically if not specified.
---@overload fun(do_cliff_correction: boolean|nil, raise_destroy: boolean|nil, player: PlayerIdentification|nil): boolean
---@overload fun(do_cliff_correction: boolean|nil, raise_destroy: boolean|nil): boolean
---@overload fun(do_cliff_correction: boolean|nil): boolean
---@overload fun(): boolean
---@return boolean @Returns `false` if the entity was valid and destruction failed, `true` in all other cases.
function LuaEntity.destroy(do_cliff_correction, raise_destroy, player, undo_index) end
...
---@return LuaEntity[]
function LuaEntity.get_cargo_bays() end
...
function LuaEntity.get_connected_rail(rail_direction, rail_connection_direction) end
...
---@param index uint32 @Fluid storage index. Valid values are from 1 up to [LuaEntity::fluids_count](runtime:LuaEntity::fluids_count).
...
function LuaEntity.get_inventory_filter(inventory_index, index) end
...
---@param inventory_index defines.inventory
---@return uint16
function LuaEntity.get_inventory_size_override(inventory_index) end
...
---@return uint32, float @Index of the transport line that is closest to the provided map position.; Position along the transport line where item should be dropped.
...
---@param index uint32 @Index of the transport line. Transport lines are 1-indexed.
...
---@param index defines.logistic_member_index|nil @If provided, this method only returns the `LuaLogisticPoint` specified by this index, or `nil` if it doesn't exist.
...
function LuaEntity.get_logistic_sections() end
...
---@return Vector
function LuaEntity.get_movement() end
...
---@overload fun(signal: SignalID, wire_connector_id: defines.wire_connector_id): int32
---@return int32 @The current value of the signal.
...
---@param index uint32 @Index of the requested transport line. Transport lines are 1-indexed.
...
---@param inventory_index defines.inventory
---@return boolean
function LuaEntity.is_inventory_filtered(inventory_index) end
...
---@param destination CargoDestination|nil
---@param character LuaEntity|nil @If provided, must be of `character` type.
---@overload fun(destination: CargoDestination|nil): boolean
---@overload fun(): boolean
---@return boolean @`true` if the rocket was successfully launched. Return value of `false` means the silo is not ready for launch.
function LuaEntity.launch_rocket(destination, character) end
...
---@param inventory LuaInventory|nil @If provided the item(s) will be transferred into this inventory. If provided, this must be an inventory created with [LuaGameScript::create_inventory](runtime:LuaGameScript::create_inventory) or be a basic inventory owned by some entity.
...
---@param raise_destroyed boolean|nil @If true, [script_raised_destroy](runtime:script_raised_destroy) will be raised. Defaults to `true`.
...
---@overload fun(inventory: LuaInventory|nil, force: boolean|nil, raise_destroyed: boolean|nil): boolean
---@overload fun(inventory: LuaInventory|nil, force: boolean|nil): boolean
---@overload fun(inventory: LuaInventory|nil): boolean
---@overload fun(): boolean
---@return boolean @Whether mining succeeded.
function LuaEntity.mine(inventory, force, raise_destroyed, ignore_minable) end
...
---@param undo_index uint32|nil @The index of the undo item to add this action to. An index of `0` creates a new undo item for it. An index of `1` adds the action to the latest undo action on the stack. Defaults to putting it into the appropriate undo item automatically if one is not specified.
...
function LuaEntity.order_deconstruction(force, player, undo_index) end

--- Sets the entity to be upgraded by construction robots.
---@param target EntityWithQualityID @The prototype of the entity to upgrade to.
---@param force ForceID @The force whose robots are supposed to do the upgrade.
---@param player PlayerIdentification|nil @The player whose undo queue this action should be added to.
---@param undo_index uint32|nil @The index of the undo item to add this action to. An index of `0` creates a new undo item for it. Defaults to putting it into the appropriate undo item automatically if not specified.
---@overload fun(target: EntityWithQualityID, force: ForceID, player: PlayerIdentification|nil): boolean
---@overload fun(target: EntityWithQualityID, force: ForceID): boolean
---@return boolean @Whether the entity was marked for upgrade.
function LuaEntity.order_upgrade(target, force, player, undo_index) end

--- Plays a note with the given instrument and note.
---@param instrument uint32
---@param note uint32
---@param stop_playing_sounds boolean|nil
---@overload fun(instrument: uint32, note: uint32): boolean
---@return boolean @Whether the request is valid. The sound may or may not be played depending on polyphony settings.
function LuaEntity.play_note(instrument, note, stop_playing_sounds) end
...
function LuaEntity.register_tree(tree) end
...
---@overload fun(name: string, amount: double, minimum_temperature: double|nil, maximum_temperature: double|nil): double
---@overload fun(name: string, amount: double, minimum_temperature: double|nil): double
---@overload fun(name: string, amount: double): double
---@return double @Amount of fluid actually removed.
function LuaEntity.remove_fluid(name, amount, minimum_temperature, maximum_temperature, temperature) end
...
---@param extra_time uint32|nil @Extra ticks to stay open.
---@overload fun(force: ForceID)
...
---@param raise_revive boolean|nil @If true, and an entity ghost; [script_raised_revive](runtime:script_raised_revive) will be called. Else if true, and a tile ghost; [script_raised_set_tiles](runtime:script_raised_set_tiles) will be called.
---@param overflow LuaInventory|nil @Items that would be deleted will be transferred to this inventory. Must be a script inventory or inventory of other entity. Inventory references obtained from proxy container are not allowed.
---@overload fun(raise_revive: boolean|nil): table<string, uint32>, LuaEntity, LuaEntity
---@overload fun(): table<string, uint32>, LuaEntity, LuaEntity
---@return table<string, uint32>, LuaEntity, LuaEntity @Any items the new real entity collided with or `nil` if the ghost could not be revived.; The revived entity if an entity ghost was successfully revived.; The item request proxy if one was created.
function LuaEntity.revive(raise_revive, overflow) end

--- Rotates this entity as if the player rotated it.
---@param reverse boolean|nil @If `true`, rotate the entity in the counter-clockwise direction.
---@param by_player PlayerIdentification|nil
---@overload fun(reverse: boolean|nil): boolean
---@overload fun(): boolean
---@return boolean @Whether the rotation was successful.
function LuaEntity.rotate(reverse, by_player) end
...
---@param filter (ItemFilter | ItemWithQualityID | EntityID | AsteroidChunkID)|nil @The item or entity to filter, or `nil` to clear the filter.
---@overload fun(index: uint32)
...
---@overload fun(index: uint32): Fluid
...
---@param inventory_index defines.inventory
---@param bar uint32|nil @The new limit. Omitting this parameter or passing `nil` will clear the limit.
---@overload fun(inventory_index: defines.inventory)
function LuaEntity.set_inventory_bar(inventory_index, bar) end
...
function LuaEntity.set_inventory_filter(inventory_index, index, filter) end
...
---@param overflow LuaInventory|nil @Items that would be deleted due to change of inventory size will be transferred to this inventory. Must be a script inventory or inventory of other entity. Inventory references obtained from proxy container are not allowed.
---@overload fun(inventory_index: defines.inventory, size_override: uint16 | nil)
function LuaEntity.set_inventory_size_override(inventory_index, size_override, overflow) end
...
function LuaEntity.set_movement(direction, speed) end
...
---@overload fun(recipe: RecipeID|nil): ItemWithQualityCounts
---@overload fun(): ItemWithQualityCounts
---@return ItemWithQualityCounts @Any items removed from this entity as a result of setting the recipe.
...
---@param raise_revive boolean|nil @If true, and an entity ghost; [script_raised_revive](runtime:script_raised_revive) will be called. Else if true, and a tile ghost; [script_raised_set_tiles](runtime:script_raised_set_tiles) will be called.
---@param overflow LuaInventory|nil @Items that would be deleted will be transferred to this inventory. Must be a script inventory or inventory of other entity. Inventory references obtained from proxy container are not allowed.
---@overload fun(raise_revive: boolean|nil): ItemWithQualityCounts, LuaEntity, LuaEntity
---@overload fun(): ItemWithQualityCounts, LuaEntity, LuaEntity
---@return ItemWithQualityCounts, LuaEntity, LuaEntity @Any items the new real entity collided with or `nil` if the ghost could not be revived.; The revived entity if an entity ghost was successfully revived.; The item request proxy if one was created.
function LuaEntity.silent_revive(raise_revive, overflow) end
...
---@class LuaEntityPrototype: any @Prototype of an entity.
  ...
  ---@field accepted_seeds string[] @ nilable
  ---@field activation_buffer_ratio FluidAmount @ nilable
  ...
  ---@field agricultural_tower_radius double @ nilable
  ...
  ---@field arm_angular_speed_cap_base float @ nilable
  ---@field arm_angular_speed_cap_quality_scaling float @ nilable
  ---@field arm_color_gradient Color[] @ nilable
  ---@field arm_count_base uint32 @ nilable
  ---@field arm_count_quality_scaling uint32 @ nilable
  ---@field arm_energy_usage double @ nilable
  ---@field arm_inventory_size_quality_increase uint32 @ nilable
  ---@field arm_slow_energy_usage double @ nilable
  ---@field arm_speed_base float @ nilable
  ---@field arm_speed_quality_scaling float @ nilable
  ---@field attack_parameters AttackParameters @ nilable; The attack parameters for this entity, if any.
  ---@field attack_reaction AttackReactionItem[] @ nilable
  ---@field attack_result TriggerItem[] @ nilable; The attack result of this entity, if any.
  ---@field attacking_speed double @ nilable
  ---@field attractor_hit_effect TriggerItem[] @ nilable
  ---@field auto_setup_collision_box boolean
  ---@field automated_ammo_count uint32 @ nilable; The amount of ammo that inserters automatically insert into this ammo-turret or artillery-turret.
  ...
  ---@field build_distance uint32 @ nilable
  ---@field building_grid_bit_shift uint32 @The log2 of [grid size](prototype:EntityPrototype::build_grid_size) of the building.
  ...
  ---@field captured_spawner_entity LuaEntityPrototype @ nilable
  ...
  ---@field chunk_exploration_radius double @ nilable; The chunk exploration radius of this vehicle prototype.
  ---@field cliff_explosive_prototype string @ nilable; The item prototype name used to destroy this cliff.
  ---@field collection_box_offset float @ nilable
  ---@field collision_box BoundingBox @The bounding box used for collision checking.
  ...
  ---@field combat_robot_friction double @ nilable
  ...
  ---@field crane_energy_usage double @ nilable; The crane energy usage of this agricultural tower prototype.
  ...
  ---@field damage double @ nilable; When lightning strikes something that is not a lightning attractor, this damage is applied to the target.
  ---@field damage_hit_tint Color @ nilable
  ---@field damaged_trigger_effect TriggerEffectItem[] @ nilable
  ...
  ---@field deposit_radius float @ nilable
  ---@field destroy_action TriggerItem[] @ nilable
  ---@field destroy_non_fuel_fluid boolean @ nilable; Whether this generator prototype destroys non-fuel fluids.
  ---@field distraction_cooldown uint32 @ nilable; The distraction cooldown of this unit prototype.
  ...
  ---@field drop_item_distance uint32 @ nilable
  ---@field dying_explosion ExplosionDefinition[] @ nilable
  ...
  ---@field energy double @ nilable; When lightning hits a lightning attractor this amount of energy is transferred to the lightning attractor.
  ...
  ---@field factoriopedia_alternative LuaEntityPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field fast_replaceable_group string @ nilable; The group of mutually fast-replaceable entities, if any.
  ---@field filter_count uint32 @ nilable; The filter count of this inserter, loader, mining drill or logistic chest. For logistic containers, `nil` means no limit.
  ...
  ---@field flow_scaling boolean @ nilable
  ---@field fluid_buffer_input_flow FluidAmount @ nilable
  ---@field fluid_buffer_size FluidAmount @ nilable
  ...
  ---@field fluid_source_offset Vector @ nilable
  ---@field fluid_usage_per_tick double @ nilable; The fluid usage of this generator prototype. This property is deprecated in favor of [LuaEntityPrototype::get_fluid_usage_per_tick](runtime:LuaEntityPrototype::get_fluid_usage_per_tick) and should not be used.
  ...
  ---@field follows_player boolean @ nilable
  ...
  ---@field growth_area_radius double @ nilable
  ---@field growth_grid_tile_size uint32 @ nilable
  ---@field growth_ticks uint32 @ nilable
  ...
  ---@field head_collection_radius float @ nilable
  ...
  ---@field heating_energy double @The energy required to keep this entity from freezing. Zero energy means it doesn't freeze.
  ---@field height double @ nilable; The height of this spider vehicle prototype.
  ---@field held_items_display_count uint8 @ nilable
  ---@field held_items_offset float @ nilable
  ---@field held_items_spread float @ nilable
  ---@field hide_resistances boolean @ nilable
  ---@field icon_draw_specification IconDrawSpecification @The definition of where and how the alt-mode icons of this entity should be drawn.
  ---@field icons_positioning IconSequencePositioning[] @ nilable; The icon positioning for inventories of this entity, if defined.
  ...
  ---@field infinite_depletion_resource_amount uint32 @ nilable; Every time this infinite resource 'ticks' down, it is reduced by this amount. Meaningless if this isn't an infinite resource.
  ---@field infinite_resource boolean @ nilable; Whether this resource is infinite.
  ---@field ingredient_count uint32 @ nilable; The max number of ingredients this crafting machine prototype supports.
  ...
  ---@field inserter_stack_size_bonus uint32 @ nilable; The built-in stack size bonus of this inserter prototype.
  ---@field instruments ProgrammableSpeakerInstrument[] @ nilable; The instruments for this programmable speaker.
  ---@field inventory_properties InventoryWithCustomStackSizeSpecification @ nilable; Properties of custom inventory. Only provided if inventory_type is `"with_custom_stack_size"`.
  ---@field inventory_size_quality_increase uint32 @ nilable
  ---@field inventory_type "normal" | "with_bar" | "with_filters" | "with_filters_and_bar" | "with_weight_limit" | "with_custom_stack_size" @ nilable; The inventory type this container or linked container uses.
  ---@field inventory_weight_limit Weight @ nilable; Weight limit of the inventory if inventory_type is `"with_weight_limit"`.
  ---@field investigating_speed double @ nilable
  ...
  ---@field items_to_place_this ItemToPlace[] @ nilable; Items that when placed will produce this entity, if any. Construction bots will choose the first item in the list to build this entity.
  ...
  ---@field launch_to_space_platforms boolean @ nilable
  ...
  ---@field loader_adjustable_belt_stack_size boolean @ nilable; True if this loader supports a runtime-adjustable belt stack size.
  ---@field loader_max_belt_stack_size uint8 @ nilable; The max belt stack size for this loader.
  ---@field loader_respect_insert_limits boolean @ nilable
  ---@field loader_wait_for_full_stack boolean @ nilable; True if this loader will not drop items for which total amount is less than a full belt stack.
  ...
  ---@field logistic_parameters {spawn_and_station_height: float, spawn_and_station_shadow_height_offset: float, stationing_render_layer_swap_height: float, charge_approach_distance: float, logistic_radius: float, construction_radius: float, charging_station_count: uint32, charging_distance: float, charging_station_shift: Vector, charging_energy: double, charging_threshold_distance: float, robot_vertical_acceleration: float, stationing_offset: Vector, robot_limit: uint32, logistics_connection_distance: float, robots_shrink_when_entering_and_exiting: boolean} @ nilable; The logistic parameters for this roboport.
  ...
  ---@field max_count_of_owned_defensive_units double @ nilable; Count of defensive enemies this spawner can sustain.
  ...
  ---@field max_defensive_friends_around_to_spawn double @ nilable; How many defensive friendly units are required within the spawning_radius of this spawner for it to stop producing more units.
  ...
  ---@field max_item_product_count uint32 @ nilable; The max number of item products this crafting machine prototype supports.
  ---@field max_payload_size uint32 @ nilable; The cargo carrying capacity of this logistics or construction robot.
  ---@field max_payload_size_after_bonus uint32 @ nilable; The maximum possible cargo carrying capacity of this logistics or construction robot. Bonuses from technologies/forces can't increase the carrying capacity beyond this number.
  ---@field max_performance ThrusterPerformancePoint @ nilable
  ---@field max_polyphony uint32 @ nilable; The maximum polyphony for this programmable speaker.
  ---@field max_power_output double @ nilable; The default maximum power output of this generator prototype. This property is deprecated in favor of [LuaEntityPrototype::get_max_power_output](runtime:LuaEntityPrototype::get_max_power_output) and should not be used.
  ...
  ---@field min_performance ThrusterPerformancePoint @ nilable
  ---@field min_pursue_time uint32 @ nilable; The minimum pursue time of this unit prototype.
  ...
  ---@field minimal_arm_swing_segment_retraction uint32 @ nilable
  ---@field minimum_resource_amount uint32 @ nilable; Minimum amount of this resource.
  ...
  ---@field module_inventory_size uint32 @ nilable; The module inventory size. `nil` if this entity doesn't support modules.
  ...
  ---@field neighbour_connectable NeighbourConnectable @ nilable
  ---@field next_upgrade LuaEntityPrototype @ nilable; The next upgrade for this entity, if any.
  ---@field normal_resource_amount uint32 @ nilable; The normal amount for this resource.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field overkill_fraction float @ nilable
  ---@field passive_energy_usage double @ nilable
  ---@field patrolling_speed double @ nilable
  ---@field patrolling_turn_radius double @ nilable
  ---@field per_lane_filters boolean @ nilable
  ---@field perceived_performance PerceivedPerformance @ nilable
  ...
  ---@field pumping_speed double @ nilable; The pumping speed of this offshore pump or normal pump. This property is deprecated in favor of [LuaEntityPrototype::get_pumping_speed](runtime:LuaEntityPrototype::get_pumping_speed) and should not be used.
  ---@field quality_affects_mining_radius boolean @ nilable
  ---@field quality_affects_module_slots boolean @ nilable
  ---@field radar_range uint32 @ nilable; The radar range of this unit prototype.
  ---@field radius double @The radius of this entity prototype. The radius is defined as half the distance between the top left corner and bottom right corner of the collision box.
  ---@field radius_visualisation_specification RadiusVisualisationSpecification @ nilable
  ---@field random_corpse_variation boolean @ nilable
  ---@field range_from_player double @ nilable
  ---@field reach_distance uint32 @ nilable
  ...
  ---@field respawn_time uint32 @ nilable
  ...
  ---@field revenge_attack_parameters AttackParameters @ nilable; The revenge attack parameters for this entity, if any. These attack parameters are used in addition to [LuaEntityPrototype::attack_parameters](runtime:LuaEntityPrototype::attack_parameters) if the entity is attacking a target that has previously dealt damage to the entity.
  ...
  ---@field rocket_parts_required uint32 @ nilable; The rocket parts required for this rocket silo prototype.
  ---@field rocket_rising_delay uint8 @ nilable; The rocket rising delay for this rocket silo prototype.
  ---@field rotation_snap_angle double @ nilable; The rotation snap angle of this car prototype.
  ...
  ---@field science_pack_drain_rate_percent uint8 @How much science pack durability is required to research one science point.
  ...
  ---@field segment_engine SegmentEngineSpecification @ nilable
  ...
  ---@field selection_priority uint32 @The selection priority of this entity - a value between `0` and `255`.
  ...
  ---@field spider_engine SpiderEngineSpecification @ nilable
  ---@field sticker_box BoundingBox @The bounding box used to attach sticker type entities.
  ---@field strike_effect TriggerItem[] @ nilable
  ---@field support_range float @ nilable
  ...
  ---@field target_temperature float @ nilable; The target temperature of this boiler or fusion reactor prototype. If `nil` on a fusion reactor, the target temperature is the default temperature of the output fluid.
  ---@field terrain_friction_modifier float @ nilable; The terrain friction modifier for this vehicle.
  ---@field territory_radius uint32 @ nilable
  ---@field tether_size float @ nilable
  ---@field ticks_per_scan uint32 @ nilable
  ---@field ticks_to_keep_aiming_direction uint32 @ nilable
  ---@field ticks_to_keep_gun uint32 @ nilable
  ---@field ticks_to_stay_in_combat uint32 @ nilable
  ---@field tile_buildability_rules TileBuildabilityRule[] @ nilable; The tile buildability rules of this entity prototype.
  ---@field tile_height uint32 @Specifies the tiling size of the entity, is used to decide, if the center should be in the center of the tile (odd tile size dimension) or on the tile border (even tile size dimension)
  ---@field tile_width uint32 @Specifies the tiling size of the entity, is used to decide, if the center should be in the center of the tile (odd tile size dimension) or on the tile border (even tile size dimension)
  ---@field time_to_live uint32 @The time to live for this prototype or `0` if prototype doesn't have time_to_live or time_before_removed.
  ---@field timeout uint32 @ nilable; The time it takes this land mine to arm.
  ...
  ---@field turn_radius double @ nilable
  ---@field turn_smoothing double @ nilable
  ---@field turret_range uint32 @ nilable; The range of this turret.
  ---@field turret_rotation_speed float @ nilable; The turret rotation speed of this car prototype.
  ---@field two_direction_only boolean @ nilable
  ---@field unpowered_arm_speed_scale float @ nilable
  ---@field update_effects TriggerEffectWithCooldown[] @ nilable; The trigger effects to run every tick when on cooldown.
  ---@field update_effects_while_enraged TriggerEffectWithCooldown[] @ nilable; The trigger effects to run every tick when on cooldown while the owning [LuaSegmentedUnit](runtime:LuaSegmentedUnit) is enraged.
  ---@field use_exact_mode boolean @ nilable; Whether this logistic container prototype uses exact mode
  ---@field uses_force_mining_productivity_bonus boolean @ nilable; If this drill uses force productivity bonus
  ---@field uses_inserter_stack_size_bonus boolean @ nilable
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field valve_mode ValveMode @ nilable; The mode of operation of this valve.
  ---@field valve_threshold float @ nilable; The default threshold of this valve.
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_attraction_range_elongation(quality) end
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_energy_distribution_efficiency(quality) end
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_fluid_capacity(quality) end

--- The fluid usage of this generator, fusion generator or fusion reactor prototype.
---@param quality QualityID|nil
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_fluid_usage_per_tick(quality) end
...
---@param quality QualityID|nil @Defaults to `"normal"`.
---@overload fun(index: defines.inventory): uint32
---@return uint32
function LuaEntityPrototype.get_inventory_size(index, quality) end
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_max_power_output(quality) end
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_mining_drill_radius(quality) end

--- The pumping speed of this offshore pump or normal pump.
---@param quality QualityID|nil
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_pumping_speed(quality) end
...
---@overload fun(): double
---@return double
function LuaEntityPrototype.get_valve_flow_rate(quality) end
...
---@class LuaEquipment: any @An item in a [LuaEquipmentGrid](runtime:LuaEquipmentGrid), for example a fusion reactor placed in one's power armor. An equipment reference becomes invalid once the equipment is removed or the equipment grid it resides in is destroyed.
  ...
  ---@field inventory_bonus uint32 @Inventory size bonus.
  ---@field max_energy double @Maximum amount of energy that can be stored in this equipment.
  ---@field max_shield double @Maximum shield value. `0` if this equipment doesn't have a shield.
  ---@field max_solar_power double @Maximum energy per tick crated by this equipment on the current surface. Actual generated energy varies depending on the daylight levels.
  ...
  ---@field shape {width: uint32, height: uint32} @Shape of this equipment.
  ---@field shield double @Current shield value of the equipment. Can't be set higher than [LuaEquipment::max_shield](runtime:LuaEquipment::max_shield). Trying to write this value on non-shield equipment will throw an error.
...
---@class LuaEquipmentGrid: any @An equipment grid is for example the inside of a power armor.
  ...
  ---@field height uint32 @Height of the equipment grid.
  ---@field inhibit_movement_bonus boolean @Whether this grid's equipment movement bonus is active.
  ---@field inventory_bonus uint32 @The total amount of inventory bonus this equipment grid gives.
  ---@field itemstack_owner LuaItemStack @ nilable; The item stack that this equipment grid is owned by.
  ---@field max_shield float @The maximum amount of shield hitpoints this equipment grid has across all shield equipment.
  ---@field max_solar_energy double @Maximum energy per tick that can be created by all solar panels in the equipment grid on the current surface. Actual generated energy varies depending on the daylight levels.
  ---@field movement_bonus double @The total amount of movement bonus this equipment grid gives. Returns `0` if [LuaEquipmentGrid::inhibit_movement_bonus](runtime:LuaEquipmentGrid::inhibit_movement_bonus) is `true`.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ...
  ---@field shield float @The amount of shield hitpoints this equipment grid currently has across all shield equipment.
  ---@field unique_id uint32 @Unique identifier of this equipment grid.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field width uint32 @Width of the equipment grid.
LuaEquipmentGrid = {}
...
---@param equipment EquipmentWithQualityID|nil @The equipment to count. If not specified, count all equipment.
---@overload fun(): uint32
---@return uint32
...
---@param name EquipmentID @Equipment prototype name
---@param quality QualityID|nil @The quality, `nil` for any or if not provided `normal` is used.
---@param position EquipmentPosition|nil @Grid position to put the equipment in.
---@param by_player PlayerIdentification|nil @If provided the action is done 'as' this player and [on_player_placed_equipment](runtime:on_player_placed_equipment) is triggered.
---@param ghost boolean|nil @If true, place the equipment as a ghost.
---@overload fun(name: EquipmentID, quality: QualityID|nil, position: EquipmentPosition|nil, by_player: PlayerIdentification|nil): LuaEquipment
---@overload fun(name: EquipmentID, quality: QualityID|nil, position: EquipmentPosition|nil): LuaEquipment
---@overload fun(name: EquipmentID, quality: QualityID|nil): LuaEquipment
---@overload fun(name: EquipmentID): LuaEquipment
---@return LuaEquipment @The newly-added equipment, or `nil` if the equipment could not be added.
function LuaEquipmentGrid.put(name, quality, position, by_player, ghost) end
...
---@param by_player PlayerIdentification|nil @If provided the action is done 'as' this player and [on_player_removed_equipment](runtime:on_player_removed_equipment) is triggered.
---@overload fun(position: EquipmentPosition|nil, equipment: LuaEquipment|nil): ItemWithQualityCount
---@overload fun(position: EquipmentPosition|nil): ItemWithQualityCount
---@overload fun(): ItemWithQualityCount
---@return ItemWithQualityCount @The removed equipment, or `nil` if no equipment was removed.
function LuaEquipmentGrid.take(position, equipment, by_player) end

--- Remove all equipment from the grid.
---@param by_player PlayerIdentification|nil @If provided, the action is done 'as' this player and [on_player_removed_equipment](runtime:on_player_removed_equipment) is triggered.
---@overload fun(): ItemWithQualityCounts
---@return ItemWithQualityCounts @List of the equipment that has been removed.
...
---@class LuaEquipmentPrototype: any @Prototype of a modular equipment.
  ...
  ---@field logistic_parameters {spawn_and_station_height: float, spawn_and_station_shadow_height_offset: float, stationing_render_layer_swap_height: float, charge_approach_distance: float, logistic_radius: float, construction_radius: float, charging_station_count: uint32, charging_distance: float, charging_station_shift: Vector, charging_energy: double, charging_threshold_distance: float, robot_vertical_acceleration: float, stationing_offset: Vector, robot_limit: uint32, logistics_connection_distance: float, robots_shrink_when_entering_and_exiting: boolean} @ nilable; The logistic parameters for this roboport equipment.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field shape {width: uint32, height: uint32, points: EquipmentPoint[]} @Shape of this equipment prototype.
  ---@field solar_panel_performance_at_day double
  ---@field solar_panel_performance_at_night double
  ---@field solar_panel_solar_coefficient_property LuaSurfacePropertyPrototype
...
---@overload fun(): uint32
---@return uint32
function LuaEquipmentPrototype.get_inventory_bonus(quality) end
...
---@param name FlowStatisticsID @The prototype ID.
---@param category string @The statistics category to read from. Valid choices are `"input"`, `"output"` and `"storage"`.
---@param precision_index defines.flow_precision_index @The precision to read.
...
---@overload fun(name: FlowStatisticsID, category: string, precision_index: defines.flow_precision_index, sample_index: uint16|nil): double
---@overload fun(name: FlowStatisticsID, category: string, precision_index: defines.flow_precision_index): double
---@return double
function LuaFlowStatistics.get_flow_count(name, category, precision_index, sample_index, count) end

--- Gets the total input count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@return uint64 | double
function LuaFlowStatistics.get_input_count(id) end

--- Gets the total output count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@return uint64 | double
function LuaFlowStatistics.get_output_count(id) end

--- Gets the total storage count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@return uint64 | double
function LuaFlowStatistics.get_storage_count(id) end

--- Adds a value to this flow statistics.
---@param id FlowStatisticsID @The prototype ID.
---@param count float @The count: positive or negative determines if the value goes in the input or output statistics.
function LuaFlowStatistics.on_flow(id, count) end

--- Sets the total input count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@param count uint64 | double @The new count. The type depends on the instance of the statistics.
function LuaFlowStatistics.set_input_count(id, count) end

--- Sets the total output count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@param count uint64 | double @The new count. The type depends on the instance of the statistics.
function LuaFlowStatistics.set_output_count(id, count) end

--- Sets the total storage count for a given prototype.
---@param id FlowStatisticsID @The prototype ID.
---@param count uint64 | double @The new count. The type depends on the instance of the statistics.
function LuaFlowStatistics.set_storage_count(id, count) end
...
---@param this_linked_connection_id uint32
---@param other_entity LuaEntity
---@param other_linked_connection_id uint32
...
---@overload fun(index: uint32): table<string, FluidAmount>
---@return table<string, FluidAmount> @The removed fluid.
...
---@param index uint32 @The index of the filter to get.
...
---@param index uint32
---@return table<string, uint32> @The counts, indexed by fluid name.
...
---@param index uint32
---@return BoundingBox
function LuaFluidBox.get_fluid_segment_extent_bounding_box(index) end
...
---@param this_linked_connection_id uint32
---@return LuaEntity, uint32 @Other entity to which a linked connection was made; linked_connection_id on other entity
...
---@param index uint32 @The index of the filter to set.
...
---@class LuaFluidBoxPrototype: any @A prototype of a fluidbox owned by some [LuaEntityPrototype](runtime:LuaEntityPrototype).
  ...
  ---@field index uint32 @The index of this fluidbox prototype in the owning entity.
  ...
  ---@field production_type ProductionType @The production type.
  ---@field render_layer RenderLayer @The render layer.
  ---@field secondary_draw_orders int32[] @The secondary draw orders for the 4 possible connection directions.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field volume double
...
---@class LuaFluidPrototype: any @Prototype of a fluid.
  ...
  ---@field factoriopedia_alternative LuaFluidPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
...
---@class LuaForce: any @`LuaForce` encapsulates data local to each "force" or "faction" of the game. Default forces are player, enemy and neutral. Players and mods can create additional forces (up to 64 total).
  ...
  ---@field belt_stack_size_bonus uint32 @Belt stack size bonus.
  ---@field bulk_inserter_capacity_bonus uint32 @Number of items that can be transferred by bulk inserters. When writing to this value, it must be >= 0 and <= 254.
  ---@field character_build_distance_bonus uint32
  ---@field character_health_bonus double
  ---@field character_inventory_slots_bonus uint32 @The number of additional inventory slots the character main inventory has.
  ---@field character_item_drop_distance_bonus uint32
  ...
  ---@field character_reach_distance_bonus uint32
  ...
  ---@field cliff_deconstruction_enabled boolean @When true, cliffs will be marked for deconstruction when trying to force-build things that collide.
  ...
  ---@field deconstruction_time_to_live uint32 @The time, in ticks, before a deconstruction order is removed.
  ...
  ---@field index uint32 @This force's index in [LuaGameScript::forces](runtime:LuaGameScript::forces) (unique ID). It is assigned when a force is created, and remains so until it is [merged](runtime:on_forces_merged) (ie. deleted). Indexes of merged forces can be reused.
  ---@field inserter_stack_size_bonus double @The inserter stack size bonus for non stack inserters
  ---@field items_launched table<string, ItemCountType> @All of the items that have been launched in rockets.
  ...
  ---@field max_failed_attempts_per_tick_per_construction_queue uint32
  ---@field max_successful_attempts_per_tick_per_construction_queue uint32
  ---@field maximum_following_robot_count uint32 @Maximum number of follower robots.
  ---@field mining_drill_productivity_bonus double
  ---@field mining_with_fluid boolean
  ---@field name string @Name of the force.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field platforms table<uint32, LuaSpacePlatform> @The space platforms that belong to this force mapped by their index value. This will include platforms that are pending deletion.
  ...
  ---@field rockets_launched uint32 @The number of rockets launched.
  ...
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field vehicle_logistics boolean @When true, cars/tanks that support logistics will be able to use them.
...
---@param name string
---@param type defines.logistic_group_type|nil @Defaults to `defines.logistic_group_type.with_trash`.
---@overload fun(name: string)
function LuaForce.create_logistic_group(name, type) end

--- Creates a new space platform on this force.
---@param name string|nil @The platform name. If not provided, a random name will be used.
---@param planet SpaceLocationID @The planet that the platform will orbit.
---@param starter_pack ItemWithQualityID @The starter pack required to build the platform.
---@return LuaSpacePlatform
function LuaForce.create_space_platform(name, planet, starter_pack) end

--- Deletes the given logistic group if it exists.
---@param name string
---@param type defines.logistic_group_type|nil @Defaults to `defines.logistic_group_type.with_trash`.
---@overload fun(name: string)
function LuaForce.delete_logistic_group(name, type) end
...
---@return string @The raw pixel data.
function LuaForce.get_chunk_chart(surface, chunk_position) end
...
---@return uint32 @Number of entities of given prototype belonging to this force.
...
---@return uint32 @The count of the item that has been launched.
...
---@param name string
---@param type defines.logistic_group_type|nil @Defaults to `defines.logistic_group_type.with_trash`.
---@overload fun(name: string): LogisticGroup
---@return LogisticGroup
function LuaForce.get_logistic_group(name, type) end

--- Gets the names of the current logistic groups.
---@param type defines.logistic_group_type|nil @Defaults to `defines.logistic_group_type.with_trash`.
---@overload fun(): string[]
---@return string[]
function LuaForce.get_logistic_groups(type) end
...
---@param surface SurfaceIdentification
---@param chunk_position ChunkPosition @Position of the chunk.
---@return boolean
function LuaForce.is_chunk_charted(surface, chunk_position) end

--- Has a chunk been requested for charting?
---@param surface SurfaceIdentification
---@param chunk_position ChunkPosition @Position of the chunk.
---@return boolean
function LuaForce.is_chunk_requested_for_charting(surface, chunk_position) end

--- Is the given chunk currently charted and visible (not covered by fog of war) on the map.
---@param surface SurfaceIdentification
---@param chunk_position ChunkPosition
---@return boolean
function LuaForce.is_chunk_visible(surface, chunk_position) end
...
function LuaForce.play_sound(sound_specification) end
...
---@param technology TechnologyID
function LuaForce.script_trigger_research(technology) end
...
---@param count uint32 @The count to set
...
---@param chunk_position ChunkPosition @The chunk position to unchart.
---@param surface SurfaceIdentification @Surface to unchart on.
function LuaForce.unchart_chunk(chunk_position, surface) end
...
---@class LuaFurnaceControlBehavior: any @Control behavior for furnaces.
  ---@field circuit_read_contents boolean @`true` if the furnace reads its ingredients contents, product contents and materials in crafting.
  ---@field circuit_read_ingredients boolean @`true` if the furnace outputs ingredients of current recipe as a signals to circuit network.
  ---@field circuit_read_recipe_finished boolean @`true` if the the furnace sends a signal when the recipe finishes.
  ---@field circuit_read_working boolean @`true` if the the furnace sends a signal when it is working.
  ---@field circuit_recipe_finished_signal SignalID @ nilable; The signal sent when the furnace finishes a recipe.
  ---@field circuit_working_signal SignalID @ nilable; The signal sent when the furnace is working.
  ---@field include_fuel boolean @`true` if the read contents should include fuel (content of energy source)
  ---@field include_in_crafting boolean @`true` if the read contents should include items in crafting.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class LuaGameScript: any @Main toplevel type, provides access to most of the API though its members. An instance of LuaGameScript is available as the global object named `game`.
  ...
  ---@field difficulty_settings DifficultySettings @The currently active set of difficulty settings. Even though this property is marked as read-only, the members of the dictionary that is returned can be modified mid-game.
  ...
  ---@field forces table<uint32 | string, LuaForce> @Get a table of all the forces that currently exist. This sparse table allows you to find forces by indexing it with either their `name` or `index`. Iterating this table with `pairs()` will provide the `name`s as the keys. Iterating with `ipairs()` will not work at all.
  ...
  ---@field tick MapTick @Current map tick.
  ---@field tick_paused boolean @If the tick has been paused. This means that entity update has been paused.
  ---@field ticks_played MapTick @The number of ticks since this game was created using either "new game" or "new game from scenario". Notably, this number progresses even when the game is [tick_paused](runtime:LuaGameScript::tick_paused). This differs from [LuaGameScript::tick](runtime:LuaGameScript::tick) in that creating a game from a scenario always starts with this value at `0`, even if the scenario has its own level data where the `tick` has progressed past `0`.
  ---@field ticks_to_run uint32 @The number of ticks to be run while the tick is paused. When [LuaGameScript::tick_paused](runtime:LuaGameScript::tick_paused) is true, ticks_to_run behaves the following way: While this is > 0, the entity update is running normally and this value is decremented every tick. When this reaches 0, the game will pause again.
...
---@param player uint32 | string @The player index or name.
---@return LuaPlayer
...
---@param surface uint32 | string @The surface index or name.
---@return LuaSurface
function LuaGameScript.get_surface(surface) end

--- Returns vehicles in game.
---@param unit_number uint32|nil
---@param force ForceID|nil
---@param surface SurfaceIdentification|nil
---@param type (EntityID | EntityID[])|nil
---@param is_moving boolean|nil
---@param has_passenger boolean|nil
---@overload fun(unit_number: uint32|nil, force: ForceID|nil, surface: SurfaceIdentification|nil, type: (EntityID | EntityID[])|nil, is_moving: boolean|nil): LuaEntity[]
---@overload fun(unit_number: uint32|nil, force: ForceID|nil, surface: SurfaceIdentification|nil, type: (EntityID | EntityID[])|nil): LuaEntity[]
---@overload fun(unit_number: uint32|nil, force: ForceID|nil, surface: SurfaceIdentification|nil): LuaEntity[]
---@overload fun(unit_number: uint32|nil, force: ForceID|nil): LuaEntity[]
---@overload fun(unit_number: uint32|nil): LuaEntity[]
---@overload fun(): LuaEntity[]
---@return LuaEntity[]
function LuaGameScript.get_vehicles(unit_number, force, surface, type, is_moving, has_passenger) end
...
---@param sound_specification PlaySoundSpecification @The sound to play.
function LuaGameScript.play_sound(sound_specification) end
...
---@param game_finished boolean|nil
---@param player_won boolean|nil
---@param next_level string|nil
---@param can_continue boolean|nil
---@overload fun(game_finished: boolean|nil, player_won: boolean|nil, next_level: string|nil)
---@overload fun(game_finished: boolean|nil, player_won: boolean|nil)
---@overload fun(game_finished: boolean|nil)
---@overload fun()
function LuaGameScript.set_game_state(game_finished, player_won, next_level, can_continue) end

--- Set losing ending information for the current scenario.
---@param title LocalisedString
---@param message LocalisedString|nil
---@param bullet_points LocalisedString[]|nil
---@param final_message LocalisedString|nil
---@param image_path string|nil
---@overload fun(title: LocalisedString, message: LocalisedString|nil, bullet_points: LocalisedString[]|nil, final_message: LocalisedString|nil)
---@overload fun(title: LocalisedString, message: LocalisedString|nil, bullet_points: LocalisedString[]|nil)
---@overload fun(title: LocalisedString, message: LocalisedString|nil)
---@overload fun(title: LocalisedString)
function LuaGameScript.set_lose_ending_info(title, message, bullet_points, final_message, image_path) end
...
---@overload fun(title: LocalisedString, message: LocalisedString|nil)
---@overload fun(title: LocalisedString)
function LuaGameScript.set_win_ending_info(title, message, bullet_points, final_message, image_path) end
...
---@overload fun(text: LocalisedString, image: string|nil, point_to: GuiArrowSpecification|nil, style: string|nil)
---@overload fun(text: LocalisedString, image: string|nil, point_to: GuiArrowSpecification|nil)
---@overload fun(text: LocalisedString, image: string|nil)
---@overload fun(text: LocalisedString)
function LuaGameScript.show_message_dialog(text, image, point_to, style, wrapper_frame_style) end
...
---@param resolution TilePosition|nil @The maximum allowed resolution is 16384x16384 (8192x8192 when `anti_alias` is `true`), but the maximum recommended resolution is 4096x4096 (resp. 2048x2048). The `x` value of the position is used as the width, the `y` value as the height.
...
---@param hide_clouds boolean|nil @If `true` cloud shadows on ground won't be rendered. Defaults to `false`.
---@param hide_fog boolean|nil @If `true` fog effect and foreground space dust effect won't be rendered. Defaults to `false`.
---@param quality int32|nil @The `.jpg` render quality as a percentage (from 0% to 100% inclusive), if used. A lower value means a more compressed image. Defaults to `80`.
...
---@param water_tick uint32|nil @Overrides the tick of water animation, if animated water is enabled.
...
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil, hide_fog: boolean|nil, quality: int32|nil, allow_in_replay: boolean|nil, daytime: double|nil, water_tick: uint32|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil, hide_fog: boolean|nil, quality: int32|nil, allow_in_replay: boolean|nil, daytime: double|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil, hide_fog: boolean|nil, quality: int32|nil, allow_in_replay: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil, hide_fog: boolean|nil, quality: int32|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil, hide_fog: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil, hide_clouds: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil, anti_alias: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil, show_cursor_building_preview: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil, show_entity_info: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil, show_gui: boolean|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil, path: string|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil, zoom: double|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil, resolution: TilePosition|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil, position: MapPosition|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil, surface: SurfaceIdentification|nil)
---@overload fun(player: PlayerIdentification|nil, by_player: PlayerIdentification|nil)
---@overload fun(player: PlayerIdentification|nil)
---@overload fun()
function LuaGameScript.take_screenshot(player, by_player, surface, position, resolution, zoom, path, show_gui, show_entity_info, show_cursor_building_preview, anti_alias, hide_clouds, hide_fog, quality, allow_in_replay, daytime, water_tick, force_render) end
...
---@param player PlayerIdentification @The screenshot will be taken for this player.
---@param selected_technology TechnologyID|nil @The technology to highlight.
...
---@param quality int32|nil @The `.jpg` render quality as a percentage (from 0% to 100% inclusive), if used. A lower value means a more compressed image. Defaults to `80`.
---@overload fun(path: string|nil, player: PlayerIdentification, selected_technology: TechnologyID|nil, skip_disabled: boolean|nil)
---@overload fun(path: string|nil, player: PlayerIdentification, selected_technology: TechnologyID|nil)
---@overload fun(path: string|nil, player: PlayerIdentification)
function LuaGameScript.take_technology_screenshot(path, player, selected_technology, skip_disabled, quality) end
...
---@class LuaGenericOnOffControlBehavior: any @An abstract base class for behaviors that support switching the entity on or off based on some condition.
  ---@field circuit_condition CircuitConditionDefinition @ nilable; The circuit condition. Writing `nil` clears the circuit condition.
  ...
  ---@field logistic_condition CircuitConditionDefinition @ nilable; The logistic condition. Writing `nil` clears the logistic condition.
...
---@class LuaGuiElement: any @An element of a custom GUI. This type is used to represent [any kind](runtime:GuiElementType) of a GUI element - labels, buttons and frames are all instances of this type. Just like [LuaEntity](runtime:LuaEntity), different kinds of elements support different attributes; attempting to access an attribute on an element that doesn't support it (for instance, trying to access the `column_count` of a `textfield`) will result in a runtime error. For information on all supported GUI elements, see [GuiElementType](runtime:GuiElementType). Each GUI element allows access to its children by having them as attributes. Thus, one can use the `parent.child` syntax to refer to children. Lua also supports the `parent["child"]` syntax to refer to the same element. This can be used in cases where the child has a name that isn't a valid Lua identifier.
  ...
  ---@field column_count uint32 @The number of columns in this table.
  ...
  ---@field elem_value string | SignalID | PrototypeWithQuality @ nilable; The elem value of this choose-elem-button, if any. The `"signal"` type operates with [SignalID](runtime:SignalID). The `"with-quality"` types operate with [PrototypeWithQuality](runtime:PrototypeWithQuality). The remaining types use strings.
  ...
  ---@field icon_selector boolean @Whether this textfield or text-box was created with an icon selector.
  ...
  ---@field index uint32 @The index of this GUI element (unique amongst the GUI elements of a LuaPlayer).
  ...
  ---@field minimap_player_index uint32 @The player index this minimap is using.
  ...
  ---@field player_index uint32 @Index into [LuaGameScript::players](runtime:LuaGameScript::players) specifying the player who owns this element.
  ---@field position MapPosition @The position this camera or minimap is focused on, if any.
  ---@field quality LuaQualityPrototype  | QualityID @ nilable; The quality to be shown in the bottom left corner of this sprite-button, or `nil` to show nothing.
  ...
  ---@field selected_index uint32 @The selected index for this dropdown or listbox. Returns `0` if none is selected.
  ---@field selected_tab_index uint32 @ nilable; The selected tab index for this tabbed pane, if any.
  ...
  ---@field surface_index uint32 @The surface index this camera or minimap is using.
...
---@param type GuiElementType @The kind of element to add, which potentially has its own attributes as listed below.
...
---@param elem_tooltip ElemID|nil @Elem tooltip of the child element. Will be displayed above `tooltip`.
...
---@param locked boolean|nil @Whether the child element is locked. Defaults to `false`.
---@param ignored_by_interaction boolean|nil @Whether the child element is ignored by interaction. Defaults to `false`.
---@param style string|nil @The name of the style prototype to apply to the new element.
---@param tags Tags|nil @[Tags](runtime:Tags) associated with the child element.
---@param index uint32|nil @Location in its parent that the child element should slot into. By default, the child will be appended onto the end.
---@param anchor GuiAnchor|nil @Where to position the child element when in the `relative` element.
---@param game_controller_interaction defines.game_controller_interaction|nil @How the element should interact with game controllers. Defaults to [defines.game_controller_interaction.normal](runtime:defines.game_controller_interaction.normal).
---@param raise_hover_events boolean|nil @Whether this element will raise [on_gui_hover](runtime:on_gui_hover) and [on_gui_leave](runtime:on_gui_leave). Defaults to `false`.
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil, style: string|nil, tags: Tags|nil, index: uint32|nil, anchor: GuiAnchor|nil, game_controller_interaction: defines.game_controller_interaction|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil, style: string|nil, tags: Tags|nil, index: uint32|nil, anchor: GuiAnchor|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil, style: string|nil, tags: Tags|nil, index: uint32|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil, style: string|nil, tags: Tags|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil, style: string|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil, ignored_by_interaction: boolean|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil, locked: boolean|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil, visible: boolean|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil, enabled: boolean|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil, elem_tooltip: ElemID|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil, tooltip: LocalisedString|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil, caption: LocalisedString|nil): LuaGuiElement
---@overload fun(type: GuiElementType, name: string|nil): LuaGuiElement
---@overload fun(type: GuiElementType): LuaGuiElement
---@return LuaGuiElement @The GUI element that was added.
function LuaGuiElement.add(type, name, caption, tooltip, elem_tooltip, enabled, visible, locked, ignored_by_interaction, style, tags, index, anchor, game_controller_interaction, raise_hover_events) end

--- Inserts a string at the end or at the given index of this dropdown or listbox.
---@param string LocalisedString @The text to insert.
---@param index uint32|nil @The index at which to insert the item.
...
---@param start_index int32 @The index of the first character to select
---@param end_index int32 @The index of the last character to select
...
---@param index uint32 @The index whose text to replace.
...
---@param index_1 uint32 @The index of the first child.
---@param index_2 uint32 @The index of the second child.
...
---@class LuaHelpers: any @Provides various helper and utility functions. It is accessible through the global object named `helpers` in all stages (settings, prototype and runtime).
  ---@field game_version string @Current version of game
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
LuaHelpers = {}
...
function LuaHelpers.compare_versions(first, second) end
...
function LuaHelpers.multilingual_to_lower(input) end
...
--- Not available in settings and prototype stages.
---@param for_player uint32|nil @If given, packets will only be read from this `player_index`. Providing `0` will only read from the server if present.
---@overload fun()
function LuaHelpers.recv_udp(for_player) end
...
---@param for_player uint32|nil @If given, the packet will only be sent from this `player_index`. Providing `0` will only send from the server if present. `for_player` cannot be used in settings and prototype stages.
---@overload fun(port: uint16, data: LocalisedString)
function LuaHelpers.send_udp(port, data, for_player) end
...
---@param for_player uint32|nil @If given, the file will only be written for this `player_index`. Providing `0` will only write to the server's output if present. `for_player` cannot be used in settings and prototype stages.
...
---@class LuaInserterControlBehavior: any @Control behavior for inserters.
...
---@class LuaInventory: any @A storage of item stacks.
  ...
  ---@field max_weight Weight @ nilable; Gives a maximum weight of items that can be inserted into this inventory.
  ---@field mod_owner string @ nilable; The mod that owns this inventory, if any.
  ---@field name string @ nilable; Name of this inventory, if any. Names match keys of [defines.inventory](runtime:defines.inventory).
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field player_owner LuaPlayer @ nilable; The player that owns this inventory, if any.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field weight Weight @Gives a total weight of all items currently in this inventory.
LuaInventory = {}
...
---@overload fun(include_filtered: boolean|nil): uint32
---@overload fun(): uint32
---@return uint32
...
---@overload fun(): LuaItemStack, uint32
---@return LuaItemStack, uint32 @The first empty stack, or `nil` if there aren't any empty stacks.; The stack index of the matching stack, if any is found.
...
---@return LuaItemStack, uint32 @The first matching stack, or `nil` if none match.; The stack index of the matching stack, if any is found.
...
---@return ItemWithQualityCounts @List of all items in the inventory.
...
---@param item ItemID|nil
---@overload fun(): table<string, uint32>
---@return table<string, uint32>
function LuaInventory.get_item_quality_counts(item) end
...
---@class LuaItem: any @A reference to an item with data. In contrast to LuaItemStack, this is binding to a specific item data even if it would move between entities or inventories.
...
---@class LuaItemCommon: any @Common methods related to usage of item with data. It is useful when LuaItemStack contains item with data or in general with LuaItem as it can only point at an item with data.
  ---@field active_index uint32 @ nilable; The active blueprint index for this blueprint book. `nil` if this blueprint book is empty.
  ...
  ---@field ammo uint32 @Number of bullets left in the magazine.
  ---@field blueprint_absolute_snapping boolean @If absolute snapping is enabled on this blueprint item.
  ---@field blueprint_description string @The description for this blueprint or blueprint book
  ...
  ---@field cost_to_build ItemWithQualityCounts @List of raw materials required to build this blueprint.
  ...
  ---@field entity_auto_target_with_gunner boolean @If this is an item with entity data, get the stored auto target with gunner state.
  ---@field entity_auto_target_without_gunner boolean @If this is an item with entity data, get the stored auto target without gunner state.
  ---@field entity_color Color @ nilable; If this is an item with entity data, get the stored entity color.
  ---@field entity_driver_is_gunner boolean @If this is an item with entity data, get the stored driver is gunner state.
  ---@field entity_enable_logistics_while_moving boolean @If this is an item with entity data, get the stored enable logistics while moving state.
  ---@field entity_filter_count uint32 @The number of entity filters this deconstruction item supports.
  ...
  ---@field entity_filters ItemFilter[] @The entity filters for this deconstruction item. The attribute is a sparse array with the keys representing the index of the filter. All prototypes in this array must not have the `"not-deconstructable"` flag set and are either a `cliff` or marked as `minable`.
  ---@field entity_label string @ nilable; If this is an item with entity data, get the stored entity label.
  ---@field entity_logistic_sections LogisticSections @If this is an item with entity data, get the stored logistic filters.
  ---@field entity_logistics_enabled boolean @If this is an item with entity data, get the stored vehicle logistics enabled state.
  ---@field entity_request_from_buffers boolean @If this is an item with entity data, get the stored request from buffer state.
  ...
  ---@field item_number uint64 @ nilable; The unique identifier for this item, if any. Note that this ID stays the same no matter where the item is moved to.
  ...
  ---@field mapper_count uint32 @The current count of mappers in the upgrade item.
  ...
  ---@field tags Tags
  ---@field tile_filter_count uint32 @The number of tile filters this deconstruction item supports.
...
---@param force ForceID @Force to use for the building
---@param position MapPosition @The position to build at
---@param direction defines.direction|nil @The direction to use when building
---@param build_mode defines.build_mode|nil @If `normal`, blueprint will not be built if any one thing can't be built. If `forced`, anything that can be built is built and obstructing nature entities will be deconstructed. If `superforced`, all obstructions will be deconstructed and the blueprint will be built.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped.
---@param by_player PlayerIdentification|nil @The player to use if any. If provided [defines.events.on_built_entity](runtime:defines.events.on_built_entity) will also be fired on successful entity creation.
---@param raise_built boolean|nil @If true; [defines.events.script_raised_built](runtime:defines.events.script_raised_built) will be fired on successful entity creation. Note: this is ignored if by_player is provided.
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition, direction: defines.direction|nil, build_mode: defines.build_mode|nil, skip_fog_of_war: boolean|nil, by_player: PlayerIdentification|nil): LuaEntity[]
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition, direction: defines.direction|nil, build_mode: defines.build_mode|nil, skip_fog_of_war: boolean|nil): LuaEntity[]
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition, direction: defines.direction|nil, build_mode: defines.build_mode|nil): LuaEntity[]
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition, direction: defines.direction|nil): LuaEntity[]
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition): LuaEntity[]
---@return LuaEntity[] @Array of created ghosts
function LuaItemCommon.build_blueprint(surface, force, position, direction, build_mode, skip_fog_of_war, by_player, raise_built) end

--- Cancel deconstruct the given area with this deconstruction item.
---@param surface SurfaceIdentification @Surface to cancel deconstruct on
---@param force ForceID @Force to use for canceling deconstruction
---@param area BoundingBox @The area to deconstruct
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@param by_player PlayerIdentification|nil @The player to use if any.
---@param super_forced boolean|nil @If the cancel deconstruction is super-forced. Defaults to `false`.
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil, by_player: PlayerIdentification|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox)
function LuaItemCommon.cancel_deconstruct_area(surface, force, area, skip_fog_of_war, by_player, super_forced) end
...
---@param force ForceID @Force to use for the creation
---@param area BoundingBox @The bounding box
---@param always_include_tiles boolean|nil @When true, blueprintable tiles are always included in the blueprint. When false they're only included if no entities exist in the setup area. Defaults to false.
...
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, always_include_tiles: boolean|nil, include_entities: boolean|nil, include_modules: boolean|nil, include_station_names: boolean|nil, include_trains: boolean|nil): table<uint32, LuaEntity>
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, always_include_tiles: boolean|nil, include_entities: boolean|nil, include_modules: boolean|nil, include_station_names: boolean|nil): table<uint32, LuaEntity>
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, always_include_tiles: boolean|nil, include_entities: boolean|nil, include_modules: boolean|nil): table<uint32, LuaEntity>
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, always_include_tiles: boolean|nil, include_entities: boolean|nil): table<uint32, LuaEntity>
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, always_include_tiles: boolean|nil): table<uint32, LuaEntity>
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox): table<uint32, LuaEntity>
---@return table<uint32, LuaEntity> @The blueprint entity index to source entity mapping.
function LuaItemCommon.create_blueprint(surface, force, area, always_include_tiles, include_entities, include_modules, include_station_names, include_trains, include_fuel) end

--- Deconstruct the given area with this deconstruction item.
---@param surface SurfaceIdentification @Surface to deconstruct on
---@param force ForceID @Force to use for the deconstruction
---@param area BoundingBox @The area to deconstruct
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@param by_player PlayerIdentification|nil @The player to use if any.
---@param super_forced boolean|nil @If the deconstruction is super-forced. Defaults to `false`.
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil, by_player: PlayerIdentification|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox)
function LuaItemCommon.deconstruct_area(surface, force, area, skip_fog_of_war, by_player, super_forced) end
...
---@param index uint32 @The entity index.
...
---@param index uint32 @The index of the mapper to read.
---@param type "from" | "to"
...
---@param index uint32
---@param filter ItemFilter | nil @Writing `nil` removes the filter.
...
---@param index uint32 @The index of the mapper to set.
---@param type "from" | "to"
---@param mapper UpgradeMapperSource | UpgradeMapperDestination | nil @The mapper to set. Set `nil` to clear the mapper.
...
---@class LuaItemPrototype: any @Prototype of an item. For example, an item prototype can be obtained from [LuaPrototypes::item](runtime:LuaPrototypes::item) by its name: `prototypes.item["iron-plate"]`.
  ...
  ---@field create_electric_network boolean @ nilable
  ...
  ---@field entity_filter_slots uint32 @ nilable; The number of entity filters this deconstruction item has.
  ---@field equipment_grid LuaEquipmentGridPrototype @ nilable; The prototype of this armor's equipment grid, if any.
  ---@field factoriopedia_alternative LuaItemPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field factoriopedia_durability_description_key string @ nilable; The durability message key used when displaying the durability of this tool in Factoriopedia.
  ---@field filter_mode PrototypeFilterMode @ nilable; The filter mode used by this item with inventory.
  ...
  ---@field initial_items ItemProduct[] @ nilable
  ---@field inventory_size uint32 @ nilable; The main inventory size for item-with-inventory-prototype.
  ...
  ---@field send_to_orbit_mode "not-sendable" | "manual" | "automated" @How this item interacts when being sent to orbit.
  ...
  ---@field stack_size uint32 @Maximum stack size of the item specified by this prototype.
  ...
  ---@field surface LuaSurfacePrototype @ nilable
  ---@field tier uint32 @ nilable; Tier of the module inside its category. Used when upgrading modules: Ctrl + click modules into an entity and it will replace lower tier modules with higher tier modules if they have the same category.
  ---@field tile_filter_slots uint32 @ nilable; The number of tile filters this deconstruction item has.
  ---@field tiles SpacePlatformTileDefinition[] @ nilable
  ---@field trigger TriggerItem @ nilable
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field weight Weight @Weight of this item. More information on how item weight is determined can be found on its [auxiliary page](runtime:item-weight).
LuaItemPrototype = {}
...
---@param quality QualityID|nil
---@overload fun(): ModuleEffects
---@return ModuleEffects
function LuaItemPrototype.get_module_effects(quality) end
...
---@class LuaItemStack: any @A reference to an item and count owned by some external entity. In most instances this is a simple reference as in: it points at a specific slot in an inventory and not the item in the slot. In the instance this references an item on a [LuaTransportLine](runtime:LuaTransportLine) the reference is only guaranteed to stay valid (and refer to the same item) as long as nothing changes the transport line.
  ...
  ---@field spoil_tick MapTick @The tick this item spoils, or `0` if it does not spoil. When writing, setting to anything < the current game tick will spoil the item instantly.
  ---@field type string @Type of the item prototype.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@return int32 @0 if the import succeeded with no errors. -1 if the import succeeded with errors. 1 if the import failed.
...
---@param amount uint32|nil
---@overload fun(stack: ItemStackIdentification): boolean
---@return boolean @`true` if the full stack (or requested amount) was transferred.
function LuaItemStack.transfer_stack(stack, amount) end
...
---@class LuaLampControlBehavior: any @Control behavior for lamps.
...
---@class LuaLoaderControlBehavior: any @Control behavior for loaders.
...
---@class LuaLogisticCell: any @Logistic cell of a particular [LuaEntity](runtime:LuaEntity). A "Logistic Cell" is the given name for settings and properties used by what would normally be seen as a "Roboport". A logistic cell however doesn't have to be attached to the roboport entity (the character has one for the personal roboport).
  ...
  ---@field charging_robot_count uint32 @Number of robots currently charging.
  ...
  ---@field mobile boolean @`true` if this is a mobile cell. The logistic cell created by roboport equipment considered is mobile.
  ---@field neighbours LuaLogisticCell[] @Neighbouring cells.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field owner LuaEntity @This cell's owner.
  ---@field stationed_construction_robot_count uint32 @Number of stationed construction robots in this cell.
  ---@field stationed_logistic_robot_count uint32 @Number of stationed logistic robots in this cell.
  ---@field to_charge_robot_count uint32 @Number of robots waiting to charge.
...
---@class LuaLogisticContainerControlBehavior: any @Control behavior for logistic chests.
...
---@class LuaLogisticNetwork: any @A single logistic network of a given force on a given surface.
  ...
  ---@field all_construction_robots uint32 @The total number of construction robots in the network (idle and active + in roboports).
  ---@field all_logistic_robots uint32 @The total number of logistic robots in the network (idle and active + in roboports).
  ---@field available_construction_robots uint32 @Number of construction robots available for a job.
  ---@field available_logistic_robots uint32 @Number of logistic robots available for a job.
  ...
  ---@field custom_name string @ nilable; The custom logistic network name set by the player or by script, if any.
  ...
  ---@field network_id uint32 @The unique logistic network ID.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ...
  ---@field robot_limit uint32 @Maximum number of robots the network can work with. Currently only used for the personal roboport.
...
---@param count uint32|nil @Count to check. Defaults to 1.
---@param include_buffers boolean|nil @Should buffers be considered? Defaults to false.
---@overload fun(item: ItemWithQualityID, count: uint32|nil): boolean
...
---@param member ("storage" | "providers")|nil @Logistic members to check. If not given, gives item counts for the entire network.
---@overload fun(): ItemWithQualityCounts
---@return ItemWithQualityCounts @List of all items in the network.
function LuaLogisticNetwork.get_contents(member) end
...
---@overload fun(item: ItemWithQualityID|nil): int32
---@overload fun(): int32
---@return int32
...
---@overload fun(item: ItemStackIdentification): uint32
---@return uint32 @Number of items actually inserted.
...
---@overload fun(item: ItemStackIdentification): uint32
---@return uint32 @Number of items removed.
function LuaLogisticNetwork.remove_item(item, members) end

--- Find a logistic point to drop the specific item stack.
---@param stack ItemStackIdentification @Name of the item to drop off.
---@param members ("storage" | "storage-empty" | "storage-empty-slot" | "requester")|nil @When given, it will find from only the specific type of member. If not specified, selects with normal priorities.
---@overload fun(stack: ItemStackIdentification): LuaLogisticPoint
---@return LuaLogisticPoint @`nil` if no point was found.
function LuaLogisticNetwork.select_drop_point(stack, members) end

--- Find the 'best' logistic point with this item ID and from the given position or from given chest type.
---@param name ItemWithQualityID @Name of the item to pick up.
...
---@param members ("active-provider" | "passive-provider" | "buffer" | "storage")|nil @When given, it will find from only the specific type of member. If not specified, selects with normal priorities. Not considered if position is specified.
---@overload fun(name: ItemWithQualityID, position: MapPosition|nil, include_buffers: boolean|nil): LuaLogisticPoint
---@overload fun(name: ItemWithQualityID, position: MapPosition|nil): LuaLogisticPoint
---@overload fun(name: ItemWithQualityID): LuaLogisticPoint
---@return LuaLogisticPoint @`nil` if no point was found.
function LuaLogisticNetwork.select_pickup_point(name, position, include_buffers, members) end
...
---@class LuaLogisticPoint: any @Logistic point of a particular [LuaEntity](runtime:LuaEntity). A "Logistic point" is the name given for settings and properties used by requester, provider, and storage points in a given logistic network. These "points" don't have to be a logistic container but often are. One other entity that can own several points is the "character" character type entity.
  ...
  ---@field logistic_member_index uint32 @The Logistic member index of this logistic point.
  ...
  ---@field sections_count uint32 @Amount of logistic sections this logistic point has.
  ---@field targeted_items_deliver ItemWithQualityCounts @Items targeted to be dropped off into this logistic point by robots.
  ---@field targeted_items_pickup ItemWithQualityCounts @Items targeted to be picked up from this logistic point by robots.
...
---@class LuaLogisticSection: any @Logistic section of a particular [LuaLogisticPoint](runtime:LuaLogisticPoint) or [LuaConstantCombinatorControlBehavior](runtime:LuaConstantCombinatorControlBehavior).
  ...
  ---@field filters_count uint32 @Amount of filters this section has
  ...
  ---@field index uint32 @The section index of this section.
...
---@return LogisticFilterIndex @The existing index for the given filter or nil if the filter was successfully set.
function LuaLogisticSection.set_slot(slot_index, filter) end

---@class LuaLogisticSections: any @Logistic sections of an entity.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field sections LuaLogisticSection[] @All logistic sections of this entity.
  ---@field sections_count uint32 @Amount of logistic sections this entity has.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaLogisticSections = {}
...
---@overload fun(): LuaLogisticSection
---@return LuaLogisticSection @Logistic section if added.
function LuaLogisticSections.add_section(group) end

--- Gets section on the selected index, if it exists.
---@param section_index uint32 @Index of the section.
---@return LuaLogisticSection
function LuaLogisticSections.get_section(section_index) end

--- Removes the given logistic section if possible. Removal may fail if the section index is out of range or the section is not [manual](runtime:LuaLogisticSection::is_manual).
---@param section_index uint32 @Index of the section.
---@return boolean @Whether section was removed.
function LuaLogisticSections.remove_section(section_index) end

---@class LuaMiningDrillControlBehavior: any @Control behavior for mining drills.
...
---@class LuaModData: any @Arbitrary data provided by mods.
  ---@field data table<string, AnyBasic> @Provides full data of this prototype.
...
---@param key string
---@return AnyBasic
function LuaModData.get(key) end
...
---@class LuaModSettingPrototype: any @Prototype of a mod setting.
  ...
  ---@field allowed_values string[] | int32[] | double[] @ nilable; The allowed values for this setting. `nil` if this setting doesn't use the a fixed set of values.
  ---@field auto_trim boolean @ nilable; Whether this string setting auto-trims values. `nil` if not a string setting
  ---@field default_value boolean | double | int32 | string | Color @The default value of this setting.
  ---@field maximum_value double | int32 @ nilable; The maximum value for this setting. `nil` if this setting type doesn't support a maximum.
  ---@field minimum_value double | int32 @ nilable; The minimum value for this setting. `nil` if this setting type doesn't support a minimum.
...
---@class LuaNamedNoiseFunction: any @Prototype of a named noise function.
...
---@class LuaParticlePrototype: any @Prototype of an optimized particle.
  ...
  ---@field fade_out_time uint32
  ---@field life_time uint32
...
---@class LuaPermissionGroup: any @A permission group that defines what players in this group are allowed to do.
  ---@field group_id uint32 @The group ID
...
---@class LuaPlanet: any @The runtime values of a planet
  ...
  ---@field surface LuaSurface @ nilable; The surface for this planet if one currently exists. Planets do not default generate their surface. [LuaPlanet::create_surface](runtime:LuaPlanet::create_surface) can be used to force the surface to exist. [LuaPlanet::associate_surface](runtime:LuaPlanet::associate_surface) can be used to create an association with an existing surface.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaPlanet = {}
...
---@param force ForceID
---@return LuaSpacePlatform[]
function LuaPlanet.get_space_platforms(force) end
...
---@class LuaPlayer: any @A player in the game. Pay attention that a player may or may not have a character, which is the [LuaEntity](runtime:LuaEntity) of the little guy running around the world doing things.
  ...
  ---@field afk_time uint32 @How many ticks since the last action of this player.
  ...
  ---@field last_online uint32 @At what tick this player was last online.
  ...
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field online_time uint32 @How many ticks did this player spend playing this save (all sessions combined).
  ...
  ---@field physical_controller_type defines.controllers @The player's "physical" controller. When a player is in the remote controller, this specifies the controller they will return to. When the player is not in the remote controller, this is equivalent to [LuaPlayer::controller_type](runtime:LuaPlayer::controller_type).
  ---@field physical_position MapPosition @The current position of this player's physical controller.
  ---@field physical_surface LuaSurface @The surface this player's physical controller is on.
  ---@field physical_surface_index uint32 @Unique ID associated with the surface this player's physical controller is currently on.
  ---@field physical_vehicle LuaEntity @ nilable; The current vehicle of this player's physical controller.
  ...
  ---@field render_mode defines.render_mode @The render mode of the player, like map or zoom to world.
  ...
  ---@field ticks_to_respawn uint32 @ nilable; The number of ticks until this player will respawn. `nil` if this player is not waiting to respawn. Set to `nil` to immediately respawn the player. Set to any positive value to trigger the respawn state for this player.
  ---@field undo_redo_stack LuaUndoRedoStack @The undo and redo stack for this player.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field zoom double @The current player controller's zoom level. Must be positive. The baseline zoom level is 1. Values greater than 1 will zoom in closer to the world and values between 0 and 1 will zoom out away from the world. Writing values outside the current zoom limits is always valid, but read values will always be clamped to the range defined by [LuaPlayer::zoom_limits](runtime:LuaPlayer::zoom_limits).
  ---@field zoom_limits ZoomLimits @The player's current controller's zoom limits. Reading this field creates a copy, so modifying the returned table's fields directly will not alter the player's zoom limits. To change the zoom limits for the player's current controller, set the entire field to the desired [ZoomLimits](runtime:ZoomLimits) table. Zoom limits are defined and remembered per controller type. If you set the zoom limits of the character controller, then every time the player uses the character controller, it will remember and use the zoom limits previously set. However, other controller types will not use the character controller zoom limits; each controller type must have its zoom limits defined separately. To set the zoom limits of ANY controller type, not just the currently active one, use [LuaPlayer::set_zoom_limits](runtime:LuaPlayer::set_zoom_limits).
LuaPlayer = {}
...
---@param preview_distance uint16|nil @Defaults to `16`.
---@param always_visible boolean|nil @Defaults to `true`.
---@param entity LuaEntity|nil @The entity to pin.
---@param player PlayerIdentification|nil @The player to pin.
---@param surface SurfaceIdentification|nil @The surface to create the pin on.
---@param position MapPosition|nil @Where to create the pin. Required when surface is defined.
---@overload fun(label: string|nil, preview_distance: uint16|nil, always_visible: boolean|nil, entity: LuaEntity|nil, player: PlayerIdentification|nil, surface: SurfaceIdentification|nil)
---@overload fun(label: string|nil, preview_distance: uint16|nil, always_visible: boolean|nil, entity: LuaEntity|nil, player: PlayerIdentification|nil)
---@overload fun(label: string|nil, preview_distance: uint16|nil, always_visible: boolean|nil, entity: LuaEntity|nil)
---@overload fun(label: string|nil, preview_distance: uint16|nil, always_visible: boolean|nil)
---@overload fun(label: string|nil, preview_distance: uint16|nil)
---@overload fun(label: string|nil)
---@overload fun()
function LuaPlayer.add_pin(label, preview_distance, always_visible, entity, player, surface, position) end
...
---@param position MapPosition @Where the entity would be placed
---@param direction defines.direction|nil @Direction the entity would be placed
---@param mirror boolean|nil @Whether to mirror the entity
---@param flip_horizontal boolean|nil @Whether to flip the blueprint horizontally. Defaults to `false`.
---@param flip_vertical boolean|nil @Whether to flip the blueprint vertically. Defaults to `false`.
---@param build_mode defines.build_mode|nil @Which build mode should be used instead of normal build. Defaults to `defines.build_mode.normal`.
---@param terrain_building_size uint32|nil @The size for building terrain if building terrain. Defaults to `2`.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@overload fun(position: MapPosition, direction: defines.direction|nil, mirror: boolean|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil, build_mode: defines.build_mode|nil, terrain_building_size: uint32|nil)
---@overload fun(position: MapPosition, direction: defines.direction|nil, mirror: boolean|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil, build_mode: defines.build_mode|nil)
---@overload fun(position: MapPosition, direction: defines.direction|nil, mirror: boolean|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil)
---@overload fun(position: MapPosition, direction: defines.direction|nil, mirror: boolean|nil, flip_horizontal: boolean|nil)
---@overload fun(position: MapPosition, direction: defines.direction|nil, mirror: boolean|nil)
---@overload fun(position: MapPosition, direction: defines.direction|nil)
---@overload fun(position: MapPosition)
function LuaPlayer.build_from_cursor(position, direction, mirror, flip_horizontal, flip_vertical, build_mode, terrain_building_size, skip_fog_of_war) end
...
---@param terrain_building_size uint32|nil @The size for building terrain if building terrain. Defaults to `2`.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@overload fun(position: MapPosition, direction: defines.direction|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil, build_mode: defines.build_mode|nil, terrain_building_size: uint32|nil): boolean
---@overload fun(position: MapPosition, direction: defines.direction|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil, build_mode: defines.build_mode|nil): boolean
---@overload fun(position: MapPosition, direction: defines.direction|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil): boolean
---@overload fun(position: MapPosition, direction: defines.direction|nil, flip_horizontal: boolean|nil): boolean
---@overload fun(position: MapPosition, direction: defines.direction|nil): boolean
---@overload fun(position: MapPosition): boolean
---@return boolean
function LuaPlayer.can_build_from_cursor(position, direction, flip_horizontal, flip_vertical, build_mode, terrain_building_size, skip_fog_of_war) end
...
function LuaPlayer.clear_recipe_notification(recipe) end
...
---@overload fun(address: string, name: LocalisedString|nil, description: LocalisedString|nil)
---@overload fun(address: string, name: LocalisedString|nil)
---@overload fun(address: string)
function LuaPlayer.connect_to_server(address, name, description, password) end
...
---@param surface SurfaceIdentification|nil @The surface which this text will be shown on. Defaults to player surface.
...
---@param time_to_live uint32|nil @The amount of ticks that the flying text will be shown for. Defaults to `80`.
---@param speed double|nil @The speed at which the text rises upwards in tiles/second. Can't be a negative value.
---@overload fun(text: LocalisedString, position: MapPosition|nil, surface: SurfaceIdentification|nil, create_at_cursor: boolean|nil, color: Color|nil, time_to_live: uint32|nil)
---@overload fun(text: LocalisedString, position: MapPosition|nil, surface: SurfaceIdentification|nil, create_at_cursor: boolean|nil, color: Color|nil)
---@overload fun(text: LocalisedString, position: MapPosition|nil, surface: SurfaceIdentification|nil, create_at_cursor: boolean|nil)
---@overload fun(text: LocalisedString, position: MapPosition|nil, surface: SurfaceIdentification|nil)
---@overload fun(text: LocalisedString, position: MapPosition|nil)
---@overload fun(text: LocalisedString)
function LuaPlayer.create_local_flying_text(text, position, surface, create_at_cursor, color, time_to_live, speed) end
...
function LuaPlayer.exit_remote_view() end
...
---@param type defines.alert_type|nil
---@param surface SurfaceIdentification|nil
---@overload fun(entity: LuaEntity|nil, prototype: LuaEntityPrototype|nil, position: MapPosition|nil, type: defines.alert_type|nil): table<uint32, table<defines.alert_type, Alert[]>>
---@overload fun(entity: LuaEntity|nil, prototype: LuaEntityPrototype|nil, position: MapPosition|nil): table<uint32, table<defines.alert_type, Alert[]>>
---@overload fun(entity: LuaEntity|nil, prototype: LuaEntityPrototype|nil): table<uint32, table<defines.alert_type, Alert[]>>
---@overload fun(entity: LuaEntity|nil): table<uint32, table<defines.alert_type, Alert[]>>
---@overload fun(): table<uint32, table<defines.alert_type, Alert[]>>
---@return table<uint32, table<defines.alert_type, Alert[]>> @A mapping of surface index to an array of arrays of [alerts](runtime:Alert) indexed by the [alert type](runtime:defines.alert_type).
function LuaPlayer.get_alerts(entity, prototype, position, type, surface) end
...
function LuaPlayer.get_recipe_notifications() end
...
---@overload fun(id: PipetteID, quality: QualityID|nil): boolean
---@overload fun(id: PipetteID): boolean
---@return boolean @Whether the smart pipette found something to put into the cursor.
function LuaPlayer.pipette(id, quality, allow_ghost) end
...
---@param sound_specification PlaySoundSpecification @The sound to play.
function LuaPlayer.play_sound(sound_specification) end
...
---@param message LocalisedString|nil
---@overload fun(entity: LuaEntity|nil, prototype: EntityID|nil, position: MapPosition|nil, type: defines.alert_type|nil, surface: SurfaceIdentification|nil, icon: SignalID|nil)
---@overload fun(entity: LuaEntity|nil, prototype: EntityID|nil, position: MapPosition|nil, type: defines.alert_type|nil, surface: SurfaceIdentification|nil)
---@overload fun(entity: LuaEntity|nil, prototype: EntityID|nil, position: MapPosition|nil, type: defines.alert_type|nil)
---@overload fun(entity: LuaEntity|nil, prototype: EntityID|nil, position: MapPosition|nil)
---@overload fun(entity: LuaEntity|nil, prototype: EntityID|nil)
---@overload fun(entity: LuaEntity|nil)
---@overload fun()
function LuaPlayer.remove_alert(entity, prototype, position, type, surface, icon, message) end
...
---@param character LuaEntity|nil @Entity to control. Mandatory when `type` is [defines.controllers.character](runtime:defines.controllers.character), ignored otherwise.
---@param waypoints CutsceneWaypoint[]|nil @List of waypoints for the cutscene controller. This parameter is mandatory when `type` is [defines.controllers.cutscene](runtime:defines.controllers.cutscene).
---@param start_position MapPosition|nil @If specified and `type` is [defines.controllers.cutscene](runtime:defines.controllers.cutscene), the cutscene will start at this position. If not given the start position will be the player position.
---@param start_zoom double|nil @If specified and `type` is [defines.controllers.cutscene](runtime:defines.controllers.cutscene), the cutscene will start at this zoom level. If not given the start zoom will be the player's zoom.
---@param final_transition_time uint32|nil @If specified and `type` is [defines.controllers.cutscene](runtime:defines.controllers.cutscene), it is the time in ticks it will take for the camera to pan from the final waypoint back to the starting position. If not given the camera will not pan back to the start position/zoom.
---@param chart_mode_cutoff double|nil @If specified and `type` is [defines.controllers.cutscene](runtime:defines.controllers.cutscene), the game will switch to chart-mode (map zoomed out) rendering when the zoom level is less than this value.
---@param position MapPosition|nil @If specified and `type` is [defines.controllers.remote](runtime:defines.controllers.remote), the position the remote controller will be centered on.
---@param surface SurfaceIdentification|nil @If specified and `type` is [defines.controllers.remote](runtime:defines.controllers.remote), the surface the remote controller will be put on.
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil, start_position: MapPosition|nil, start_zoom: double|nil, final_transition_time: uint32|nil, chart_mode_cutoff: double|nil, position: MapPosition|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil, start_position: MapPosition|nil, start_zoom: double|nil, final_transition_time: uint32|nil, chart_mode_cutoff: double|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil, start_position: MapPosition|nil, start_zoom: double|nil, final_transition_time: uint32|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil, start_position: MapPosition|nil, start_zoom: double|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil, start_position: MapPosition|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil, waypoints: CutsceneWaypoint[]|nil)
---@overload fun(type: defines.controllers, character: LuaEntity|nil)
---@overload fun(type: defines.controllers)
function LuaPlayer.set_controller(type, character, waypoints, start_position, start_zoom, final_transition_time, chart_mode_cutoff, position, surface) end
...
---@param zoom_limits ZoomLimits @The new zoom limits. See [LuaPlayer::zoom_limits](runtime:LuaPlayer::zoom_limits) for usage information.
function LuaPlayer.set_zoom_limits(controller_type, zoom_limits) end
...
function LuaPlayer.swap_characters(player) end
...
---@class LuaProcessionLayerInheritanceGroupPrototype: any @Prototype of a procession inheritance group which synchronizes offsets between procession steps.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaProcessionLayerInheritanceGroupPrototype = {}

---@class LuaProcessionPrototype: any @Prototype of a procession.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class LuaProgrammableSpeakerControlBehavior: any @Control behavior for programmable speakers.
...
---@class LuaPrototypeBase: any @Base for all prototype classes.
  ---@field custom_tooltip_fields CustomTooltipField[] @ nilable; Extra description items in the tooltip and Factoriopedia.
...
---@class LuaPrototypes: any @Provides read-only access to prototypes. It is accessible through the global object named `prototypes`.
  ...
  ---@field mod_data table<string, LuaModData> @A dictionary containing every LuaModData indexed by `name`.
  ...
  ---@field utility_constants table<string, AnyBasic> @All utility constants. See [UtilityConstants](prototype:UtilityConstants) for possible values.
...
---@class LuaProxyContainerControlBehavior: any @Control behavior for proxy container.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field read_contents boolean @`true` if this proxy container is sending inventory contents to a circuit network
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaProxyContainerControlBehavior = {}

---@class LuaPumpControlBehavior: any @Control behavior for pumps.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaQualityPrototype: any @Prototype of a quality.
  ...
  ---@field color Color @The color of the prototype
  ...
  ---@field level uint32 @Level basically specifies the stat-increasing value of this quality level.
...
---@class LuaRadarControlBehavior: any @Control behavior for radars
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class LuaRailPath: any @A rail path.
  ---@field current uint32 @The current rail index.
  ---@field is_front boolean @If the path goes from the front of the train
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field rails table<uint32, LuaEntity> @Array of the rails that this path travels over.
  ---@field size uint32 @The total number of rails in this path.
  ---@field total_distance double @The total path distance.
  ---@field travelled_distance double @The total distance traveled.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaRailPath = {}

---@class LuaRailSignalBaseControlBehavior: any @Control behavior for rail signals and rail chain signals.
  ---@field blue_signal SignalID @ nilable
...
---@class LuaRandomGenerator: any @A deterministic random generator independent from the core games random generator that can be seeded and re-seeded at will. This random generator can be saved and loaded and will maintain its state. Note this is entirely different from calling [math.random](libraries.html)() and you should be sure you actually want to use this over calling `math.random()`. If you aren't sure if you need to use this over calling `math.random()` then you probably don't need to use this.
  ---@overload fun(lower: int32|nil, upper: int32|nil): double
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaRandomGenerator = {}
...
---@class LuaReactorControlBehavior: any @Control behavior for Reactor
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaRecipe: any @A crafting recipe. Recipes belong to forces (see [LuaForce](runtime:LuaForce)) because some recipes are unlocked by research, and researches are per-force.
  ---@field additional_categories string[] @Additional categories of this recipe.
...
---@return boolean @`true` if recipe has this category.
function LuaRecipe.has_category(category) end
...
---@class LuaRecipePrototype: any @A crafting recipe prototype.
  ---@field additional_categories string[] @Additional categories of the recipe.
  ...
  ---@field alternative_unlock_methods LuaTechnologyPrototype[] @ nilable; Additional technologies listed under "Unlocked by" on a recipe's Factoriopedia page.
  ...
  ---@field energy double @Energy required to execute this recipe. This directly affects the crafting time: Recipe's energy is exactly its crafting time in seconds, when crafted in an assembling machine with crafting speed exactly equal to one.
  ---@field factoriopedia_alternative LuaRecipePrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ...
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field overload_multiplier uint32 @Used to determine how many extra items are put into an assembling machine before it's considered "full enough".
  ---@field preserve_products_in_machine_output boolean
  ---@field products Product[] @The results/products of this recipe.
  ---@field request_paste_multiplier uint32 @The multiplier used when this recipe is copied from an assembling machine to a requester chest. For each item in the recipe the item count * this value is set in the requester chest.
...
---@param category RecipeCategoryID
---@return boolean @`true` if recipe has this category.
function LuaRecipePrototype.has_category(category) end
...
---@class LuaRecord: any @A reference to a record in the blueprint library. Records in the "my blueprints" shelf are read-only, but records in the "game blueprints" shelf are read/write.
  ...
  ---@field contents table<ItemStackIndex, LuaRecord> @The contents of this BlueprintBookRecord. This is sparse array - it may have gaps, so using `#` will not be reliable. Use [LuaRecord::contents_size](runtime:LuaRecord::contents_size) or `pairs()` to iterate this table.
  ---@field contents_size ItemStackIndex @The highest populated index in the contents of this BlueprintBookRecord.
  ---@field cost_to_build ItemWithQualityCounts @List of raw materials required to build this blueprint.
  ---@field default_icons BlueprintSignalIcon[] @The default icons for a blueprint blueprint.
  ---@field entity_filter_count uint32 @The number of entity filters this deconstruction planner supports.
  ...
  ---@field entity_filters ItemFilter[] @The entity filters for this deconstruction planner. The attribute is a sparse array with the keys representing the index of the filter. All prototypes in this array must not have the `"not-deconstructable"` flag set and are either a `cliff` or marked as `minable`.
  ---@field is_blueprint_preview boolean @Is this blueprint record a preview? A preview record must be synced by the player before entity and tile data can be read. This property is deprecated in favor of [LuaRecord::is_preview](runtime:LuaRecord::is_preview) and should not be used.
  ---@field is_preview boolean @Checks if this record is in a preview state.
  ---@field mapper_count uint32 @The current count of mappers in the upgrade item.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field preview_icons BlueprintSignalIcon[] @The preview icons for this record.
  ---@field tile_filter_count uint32 @The number of tile filters this deconstruction planner supports.
...
---@overload fun(surface: SurfaceIdentification, force: ForceID, position: MapPosition): LuaEntity[]
---@return LuaEntity[] @Array of created ghosts
function LuaRecord.build_blueprint(surface, force, position, direction, build_mode, skip_fog_of_war, by_player, raise_built) end
...
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox)
function LuaRecord.cancel_deconstruct_area(surface, force, area, skip_fog_of_war, by_player, super_forced) end
...
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox): table<uint32, LuaEntity>
---@return table<uint32, LuaEntity> @The blueprint entity index to source entity mapping.
function LuaRecord.create_blueprint(surface, force, area, always_include_tiles, include_entities, include_modules, include_station_names, include_trains, include_fuel) end
...
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox, skip_fog_of_war: boolean|nil)
---@overload fun(surface: SurfaceIdentification, force: ForceID, area: BoundingBox)
function LuaRecord.deconstruct_area(surface, force, area, skip_fog_of_war, by_player, super_forced) end

--- Exports this record to a string.
---@return string
function LuaRecord.export_record() end
...
---@param player PlayerIdentification
---@return uint32
function LuaRecord.get_active_index(player) end
...
---@param player PlayerIdentification
---@return LuaRecord
function LuaRecord.get_selected_record(player) end
...
---@class LuaRenderObject: any @Reference to a single [LuaRendering](runtime:LuaRendering) object.
  ...
  ---@field blink_interval uint16 @Blink interval of this object based on the internal "update tick". When zero, blinking is disabled. For other values, the object will be visible the given number of ticks and then invisible for the same duration. Objects with the same blink interval will blink synchronously. Blink interval of game alerts is 30. For example, when the interval is 60, the object is visible for 60 ticks and hidden for the next 60.
  ---@field color Color @Color or tint of the object.
  ---@field dash_length double @Dash length of this line.
  ---@field dash_offset double @Starting offset to apply to dashes of this line. Cannot be greater than dash_length + gap_length.
  ---@field draw_on_ground boolean @If this object is being drawn on the ground, under most entities and sprites. In [render_mode](runtime:LuaRenderObject::render_mode) == "chart", this value is unused.
  ...
  ---@field render_mode ScriptRenderMode @Whether the object is rendered in game world or on the chart (map view). When it is changed, the object is pushed to front of its new group.
  ...
  ---@field time_to_live uint32 @Time to live of this object. This will be 0 if the object does not expire.
...
--- Create an animation.
---@param animation string @Name of an [AnimationPrototype](prototype:AnimationPrototype).
...
---@param render_layer RenderLayer|nil @Render layer of the animation. Defaults to `"arrow"`.
...
---@param orientation_target ScriptRenderTarget|nil @If given, the animation rotates so that it faces this target. Note that `orientation` is still applied to the animation.
---@param use_target_orientation boolean|nil @Only used if `orientation_target` is a LuaEntity.
...
---@param target ScriptRenderTarget @Center of the animation.
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
---@param forces ForceSet|nil @The forces that this object is rendered to. Passing `nil` or an empty table will render it to all forces.
...
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(animation: string, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, animation_speed: double|nil, animation_offset: double|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_animation(animation, orientation, x_scale, y_scale, tint, render_layer, animation_speed, animation_offset, orientation_target, use_target_orientation, oriented_offset, target, surface, time_to_live, blink_interval, forces, players, visible, only_in_alt_mode, render_mode) end
...
---@param players PlayerIdentification[]|nil @The players that this object is rendered to. Passing `nil` or an empty table will render it to all players.
---@param visible boolean|nil @If this is rendered to anyone at all. Defaults to true.
---@param draw_on_ground boolean|nil @If this should be drawn below sprites and entities. Defaults to false.
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(color: Color, max_radius: double, min_radius: double, start_angle: float, angle: float, target: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_arc(color, max_radius, min_radius, start_angle, angle, target, surface, time_to_live, blink_interval, forces, players, visible, draw_on_ground, only_in_alt_mode, render_mode) end

--- Create a circle.
---@param color Color
---@param radius double @In tiles.
---@param width float|nil @Width of the outline, used only if filled = false. Value is in pixels (32 per tile). Defaults to 1.
---@param filled boolean|nil @If the circle should be filled. Defaults to false.
---@param target ScriptRenderTarget
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(color: Color, radius: double, width: float|nil, filled: boolean|nil, target: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_circle(color, radius, width, filled, target, surface, time_to_live, blink_interval, forces, players, visible, draw_on_ground, only_in_alt_mode, render_mode) end
...
---@param target ScriptRenderTarget @Center of the light.
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
---@param forces ForceSet|nil @The forces that this object is rendered to. Passing `nil` or an empty table will render it to all forces.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, scale: float|nil, intensity: float|nil, minimum_darkness: float|nil, oriented: boolean|nil, color: Color|nil, target: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_light(sprite, orientation, scale, intensity, minimum_darkness, oriented, color, target, surface, time_to_live, blink_interval, forces, players, visible, only_in_alt_mode, render_mode) end
...
---@param dash_offset double|nil @Starting offset to apply to dashes. Cannot be greater than dash_length + gap_length. Default is 0.
---@param from ScriptRenderTarget
---@param to ScriptRenderTarget
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
---@param forces ForceSet|nil @The forces that this object is rendered to. Passing `nil` or an empty table will render it to all forces.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(color: Color, width: float, gap_length: double|nil, dash_length: double|nil, dash_offset: double|nil, from: ScriptRenderTarget, to: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_line(color, width, gap_length, dash_length, dash_offset, from, to, surface, time_to_live, blink_interval, forces, players, visible, draw_on_ground, only_in_alt_mode, render_mode) end

--- Create a triangle mesh defined by a triangle strip.
---@param color Color
---@param vertices ScriptRenderTarget[]
---@param target ScriptRenderTarget|nil @Acts like an offset applied to all vertices that are not set to an entity.
---@param orientation RealOrientation|nil @The orientation applied to all vertices. Default is 0.
---@param orientation_target ScriptRenderTarget|nil @If given, the vertices (that are not set to an entity) rotate so that it faces this target. Note that `orientation` is still applied.
---@param use_target_orientation boolean|nil @Only used if `orientation_target` is a LuaEntity.
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(color: Color, vertices: ScriptRenderTarget[], target: ScriptRenderTarget|nil, orientation: RealOrientation|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_polygon(color, vertices, target, orientation, orientation_target, use_target_orientation, surface, time_to_live, blink_interval, forces, players, visible, draw_on_ground, only_in_alt_mode, render_mode) end

--- Create a rectangle.
---@param color Color
---@param width float|nil @Width of the outline, used only if filled = false. Value is in pixels (32 per tile). Defaults to 1.
---@param filled boolean|nil @If the rectangle should be filled. Defaults to false.
---@param left_top ScriptRenderTarget
---@param right_bottom ScriptRenderTarget
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(color: Color, width: float|nil, filled: boolean|nil, left_top: ScriptRenderTarget, right_bottom: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_rectangle(color, width, filled, left_top, right_bottom, surface, time_to_live, blink_interval, forces, players, visible, draw_on_ground, only_in_alt_mode, render_mode) end
...
---@param tint Color|nil
---@param render_layer RenderLayer|nil @Render layer of the sprite. Defaults to `"arrow"`.
---@param orientation_target ScriptRenderTarget|nil @If given, the sprite rotates so that it faces this target. Note that `orientation` is still applied to the sprite.
---@param use_target_orientation boolean|nil @Only used if `orientation_target` is a LuaEntity.
...
---@param target ScriptRenderTarget @Center of the sprite.
---@param surface SurfaceIdentification
---@param time_to_live uint32|nil @In ticks. Defaults to living forever.
---@param blink_interval uint16|nil @In ticks. Defaults to 0 (no blinking). Game alerts use 30.
---@param forces ForceSet|nil @The forces that this object is rendered to. Passing `nil` or an empty table will render it to all forces.
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
...
---@overload fun(sprite: SpritePath, orientation: RealOrientation|nil, x_scale: double|nil, y_scale: double|nil, tint: Color|nil, render_layer: RenderLayer|nil, orientation_target: ScriptRenderTarget|nil, use_target_orientation: boolean|nil, oriented_offset: Vector|nil, target: ScriptRenderTarget, surface: SurfaceIdentification): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_sprite(sprite, orientation, x_scale, y_scale, tint, render_layer, orientation_target, use_target_orientation, oriented_offset, target, surface, time_to_live, blink_interval, forces, players, visible, only_in_alt_mode, render_mode) end
...
---@param players PlayerIdentification[]|nil @The players that this object is rendered to. Passing `nil` or an empty table will render it to all players.
---@param visible boolean|nil @If this is rendered to anyone at all. Defaults to true.
---@param draw_on_ground boolean|nil @If this should be drawn below sprites and entities. Rich text does not support this option. Defaults to false.
---@param orientation RealOrientation|nil @The orientation of the text. Default is 0.
---@param alignment TextAlign|nil @Defaults to "left".
---@param vertical_alignment VerticalTextAlign|nil @Defaults to "top".
...
---@param only_in_alt_mode boolean|nil @If this should only be rendered in alt mode. Defaults to false.
---@param render_mode ScriptRenderMode|nil @Mode which this object should render in. Defaults to "game".
---@param use_rich_text boolean|nil @If rich text rendering is enabled. Defaults to false.
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil, alignment: TextAlign|nil, vertical_alignment: VerticalTextAlign|nil, scale_with_zoom: boolean|nil, only_in_alt_mode: boolean|nil, render_mode: ScriptRenderMode|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil, alignment: TextAlign|nil, vertical_alignment: VerticalTextAlign|nil, scale_with_zoom: boolean|nil, only_in_alt_mode: boolean|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil, alignment: TextAlign|nil, vertical_alignment: VerticalTextAlign|nil, scale_with_zoom: boolean|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil, alignment: TextAlign|nil, vertical_alignment: VerticalTextAlign|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil, alignment: TextAlign|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil, orientation: RealOrientation|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil, draw_on_ground: boolean|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil, visible: boolean|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil, players: PlayerIdentification[]|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil, forces: ForceSet|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil, blink_interval: uint16|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil, time_to_live: uint32|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil, font: string|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color, scale: double|nil): LuaRenderObject
---@overload fun(text: LocalisedString, surface: SurfaceIdentification, target: ScriptRenderTarget, color: Color): LuaRenderObject
---@return LuaRenderObject
function LuaRendering.draw_text(text, surface, target, color, scale, font, time_to_live, blink_interval, forces, players, visible, draw_on_ground, orientation, alignment, vertical_alignment, scale_with_zoom, only_in_alt_mode, render_mode, use_rich_text) end
...
---@class LuaRoboportControlBehavior: any @Control behavior for roboports.
...
---@class LuaRocketSiloControlBehavior: any @Control behavior for rocket silos.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaSchedule: any @The schedule of a particular [LuaTrain](runtime:LuaTrain) or [LuaSpacePlatform](runtime:LuaSpacePlatform).
  ---@field current uint32 @The schedule index of the current destination.
  ---@field group string @ nilable; The group this schedule is part of, if any.
  ---@field interrupt_count uint32
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field owner LuaTrain | LuaSpacePlatform @ nilable; The owner of this schedule.
  ---@field tick_of_last_activity MapTick @The time when the train or space platform was last considered active for the inactivity condition. Note: when writing, value must not be larger than LuaGameScript::tick
  ---@field tick_of_last_schedule_change MapTick
  ---@field ticks_in_station MapTick @How long this train or space platform has been in the current station.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaSchedule = {}

--- Activates the interrupt at the given index, if the index is valid.
---@param index uint32
function LuaSchedule.activate_interrupt(index) end
...
function LuaSchedule.add_interrupt(interrupt) end
...
function LuaSchedule.add_record(data) end
...
function LuaSchedule.add_wait_condition(record_position, condition_index, type) end

--- Changes the interrupt at the given index to the provided values. Note, the names must match.
---@param index uint32
---@param interrupt ScheduleInterrupt
function LuaSchedule.change_interrupt(index, interrupt) end

--- Changes the wait condition on the given record to the new values.
---@param record_position ScheduleRecordPosition
---@param condition_index uint32
---@param wait_condition WaitCondition
function LuaSchedule.change_wait_condition(record_position, condition_index, wait_condition) end

--- Removes all interrupts.
function LuaSchedule.clear_interrupts() end

---@param interrupt_index uint32|nil @If provided, clears the records for this interrupt.
---@overload fun()
function LuaSchedule.clear_records(interrupt_index) end
...
function LuaSchedule.copy_record(source_schedule, source_index, destination_index) end

---@param from uint32
---@param to uint32
function LuaSchedule.drag_interrupt(from, to) end

---@param from uint32
---@param to uint32
---@param interrupt_index uint32|nil @The interrupt to operate on, if any.
---@overload fun(from: uint32, to: uint32)
function LuaSchedule.drag_record(from, to, interrupt_index) end

---@param record_position ScheduleRecordPosition @The record to change.
---@param from uint32
---@param to uint32
function LuaSchedule.drag_wait_condition(record_position, from, to) end

--- Gets if the given interrupt can be triggered inside other interrupts.
---@param interrupt_index uint32
---@return boolean
function LuaSchedule.get_inside_interrupt(interrupt_index) end

---@param index uint32
---@return ScheduleInterrupt
function LuaSchedule.get_interrupt(index) end

---@return ScheduleInterrupt[]
function LuaSchedule.get_interrupts() end

---@param record_position ScheduleRecordPosition
---@return ScheduleRecord
function LuaSchedule.get_record(record_position) end

--- If the given index is invalid, `nil` is returned.
---@param interrupt_index uint32|nil @If provided, the record count in this interrupt is read.
---@overload fun(): uint32
---@return uint32
function LuaSchedule.get_record_count(interrupt_index) end

---@param interrupt_index uint32|nil @If provided, gets the records for this interrupt.
---@overload fun(): ScheduleRecord[]
---@return ScheduleRecord[]
function LuaSchedule.get_records(interrupt_index) end

--- Gets the wait condition at the given record position if one exists.
---@param record_position ScheduleRecordPosition
---@param condition_index uint32
---@return WaitCondition
function LuaSchedule.get_wait_condition(record_position, condition_index) end

--- The number of wait conditions in the given schedule record.
---@param record_position ScheduleRecordPosition
---@return uint32
function LuaSchedule.get_wait_condition_count(record_position) end

--- Gets the wait conditions at the given record position if they exist.
---@param record_position ScheduleRecordPosition
---@return WaitCondition[]
function LuaSchedule.get_wait_conditions(record_position) end
...
function LuaSchedule.go_to_station(schedule_index) end

--- Removes the interrupt at the given index, if the index is valid.
---@param index uint32
function LuaSchedule.remove_interrupt(index) end

--- Removes the record at the given record position, if the record position is valid.
---@param record_position ScheduleRecordPosition
function LuaSchedule.remove_record(record_position) end

--- Removes the given wait condition from the given record.
---@param record_position ScheduleRecordPosition
---@param condition_index uint32
function LuaSchedule.remove_wait_condition(record_position, condition_index) end

---@param old_name string @The interrupt to rename
---@param new_name string @The new name - if it already exists, does nothing.
function LuaSchedule.rename_interrupt(old_name, new_name) end

--- Sets if unloading is allowed at the given schedule record position. Only relevant for space platforms.
---@param record_position ScheduleRecordPosition
---@param allow boolean
function LuaSchedule.set_allow_unloading(record_position, allow) end

--- Sets if the given interrupt can be triggered inside other interrupts.
---@param interrupt_index uint32
---@param value boolean
function LuaSchedule.set_inside_interrupt(interrupt_index, value) end

---@param interrupts ScheduleInterrupt[]
function LuaSchedule.set_interrupts(interrupts) end

---@param records ScheduleRecord[]
---@param interrupt_index uint32|nil @If provided, the records will be set on this interrupt.
---@overload fun(records: ScheduleRecord[])
function LuaSchedule.set_records(records, interrupt_index) end
...
function LuaSchedule.set_stopped(stopped) end

--- Sets the comparison on the given wait condition.
---@param record_position ScheduleRecordPosition
---@param condition_index uint32
---@param mode string @`"and"`, or `"or"`
function LuaSchedule.set_wait_condition_mode(record_position, condition_index, mode) end

---@class LuaSegment: any @An individual segment of a [LuaSegmentedUnit](runtime:LuaSegmentedUnit). If the segment exists in a generated chunk, you can access the entity representation using [LuaSegment::entity](runtime:LuaSegment::entity).
  ---@field entity LuaEntity @ nilable; The actual entity representation of the segment if it exists. A segment's entity will be automatically destroyed if the segment moves into chunks that have not yet been fully generated or onto "out-of-map" tiles. Conversely, if a segment moves into a chunk that is fully generated and onto a non-"out-of-map" tile, then its entity will be created if it doesn't exist yet.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field orientation RealOrientation @ nilable; The relative orientation of the segment if one has been assigned. An orientation may not be assigned if the unit's number of body nodes is fewer than [LuaSegmentedUnit::max_body_nodes](runtime:LuaSegmentedUnit::max_body_nodes). If [LuaSegment::entity](runtime:LuaSegment::entity) is non-nil, this returns that entity's [LuaEntity::orientation](runtime:LuaEntity::orientation). If the entity is `nil`, then reading this field calculates the entity's would-be position if it existed. This can be expensive to compute, so avoid reading this field too often unless it is really necessary.
  ---@field position MapPosition @ nilable; The position of the segment if one has been assigned. A position may not be assigned if the unit's number of body nodes is fewer than [LuaSegmentedUnit::max_body_nodes](runtime:LuaSegmentedUnit::max_body_nodes). This position may be in an un-generated chunk. Use [LuaSurface::is_chunk_generated](runtime:LuaSurface::is_chunk_generated) to check before attempting to access the chunk. If [LuaSegment::entity](runtime:LuaSegment::entity) is non-nil, this returns that entity's [LuaEntity::position](runtime:LuaEntity::position). If the entity is `nil`, then reading this field calculates the entity's would-be position if it existed. This can be expensive to compute, so avoid reading this field too often unless it is really necessary.
  ---@field prototype LuaEntityPrototype @The prototype for the entity representation of the segment.
  ---@field unit LuaSegmentedUnit @The segmented unit that owns the segment.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaSegment = {}

---@class LuaSegmentedUnit: any @A surface-level object composed of one [SegmentedUnitPrototype](prototype:SegmentedUnitPrototype) followed by up to 63 [SegmentPrototype](prototype:SegmentPrototype)s. This object is not an entity, and can exist on chunks that do not exist. Instead, the individual segments that compose its body will be destroyed as the unit's body crosses into un-generated or void terrain, and will be re-created when the body crosses into generated, non-void terrain. Use [LuaSurface::get_segmented_units](runtime:LuaSurface::get_segmented_units) to iterate over all units on a surface, [LuaTerritory::get_segmented_units](runtime:LuaTerritory::get_segmented_units) to iterate over all units that guard a territory, or [LuaEntity::segmented_unit](runtime:LuaEntity::segmented_unit) to get the unit that controls any given segment entity.
  ---@field acceleration double @The rate at which [LuaSegmentedUnit::speed](runtime:LuaSegmentedUnit::speed) is changing over time, in tiles per tick per tick. This value represents unit's most recent change in speed. If its speed is not changing, the acceleration value will be 0. If it is gaining speed, the value will be positive. If it is losing speed, the value will be negative.
  ---@field activity_mode defines.segmented_unit_activity_mode @The current activity mode of the unit. Setting this field can cause the segmented unit to "wake up" or force it into a lower activity mode, but not permanently. Segmented units will generally try to update their activity mode so that they are fully active whenever they are potentially being observed by players, minimally active when relevant to gameplay but not likely observed, and asleep when not relevant to gameplay. Will never be lower than [LuaSegmentedUnit::minimum_activity_mode](runtime:LuaSegmentedUnit::minimum_activity_mode).
  ---@field force LuaForce  | ForceID @The force that the unit belongs to. Changing this also changes the force of all segment entities. Always returns a [LuaForce](runtime:LuaForce), but may be assigned to any [ForceID](runtime:ForceID) type.
  ---@field health float @The current health of the unit. Health is automatically clamped to be between `0` and [LuaSegmentedUnit::max_health](runtime:LuaSegmentedUnit::max_health).
  ---@field health_ratio float @The ratio of [LuaSegmentedUnit::health](runtime:LuaSegmentedUnit::health) to [LuaSegmentedUnit::max_health](runtime:LuaSegmentedUnit::max_health). Values are clamped between `0` (no health) and `1` (full health) inclusive.
  ---@field max_body_nodes uint32 @The maximum length of [LuaSegmentedUnit::get_body_nodes](runtime:LuaSegmentedUnit::get_body_nodes).
  ---@field max_health float @The maximum health of the unit.
  ---@field minimum_activity_mode defines.segmented_unit_activity_mode @The lowest-level activity mode that the unit is allowed to be in. Set this field to prevent the segmented unit from falling asleep or entering minimal mode. Set this field to `nil` or [asleep](runtime:defines.segmented_unit_activity_mode) to reset this to the default and allow the engine to use whatever activity mode is appropriate. Performance note: it is NOT recommended to force many segmented units to be fully active or minimally active simultaneously, as they can significantly impact performance depending on how they are configured. When using this feature, remember to reset this field to allow irrelevant units to go back to sleep.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field prototype LuaEntityPrototype @The prototype of the `segmented-unit` entity that defines the traits and behaviors of the unit.
  ---@field segments LuaSegment[] @The segments that compose the unit.
  ---@field speed double @The current instantaneous speed in tiles per map tick. Must always be greater than or equal to 0; segmented units are currently incapable of naturally moving in reverse. When setting this value, note that unless the unit's AI is similarly overridden by a script, the unit's speed will continuously accelerate or decelerate to match [LuaSegmentedUnit::target_speed](runtime:LuaSegmentedUnit::target_speed).
  ---@field surface LuaSurface @The surface on which the unit is located.
  ---@field target_speed double @The speed in tiles per tick that the unit is currently attempting to reach, as determined by its AI. Must always be greater than or equal to 0.
  ---@field territory LuaTerritory @ nilable; The territory that the unit is protecting.
  ---@field unit_number uint64 @A unique number identifying this unit for the lifetime of the save. These are allocated sequentially and not re-used (until overflow). These numbers are allocated from the same pool as [LuaEntity::unit_number](runtime:LuaEntity::unit_number), so segmented unit numbers are unique among all segmented units and all entities with owners.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaSegmentedUnit = {}

--- Clones this unit.
---@param position MapPosition @The destination position of the head segment. The rest of the body nodes will be copied relative to this.
---@param surface LuaSurface|nil @The destination surface. If different from this unit's surface, then the clone will not copy the original unit's territory.
---@param force ForceID|nil @The new unit's force.
---@param territory LuaTerritory|nil @The territory that the clone should guard. Must be on the same surface as the destination surface.
---@overload fun(position: MapPosition, surface: LuaSurface|nil, force: ForceID|nil): LuaSegmentedUnit
---@overload fun(position: MapPosition, surface: LuaSurface|nil): LuaSegmentedUnit
---@overload fun(position: MapPosition): LuaSegmentedUnit
---@return LuaSegmentedUnit @The cloned unit or `nil` if the unit cannot be cloned.
function LuaSegmentedUnit.clone(position, surface, force, territory) end

--- Damages the unit.
---@param damage float @The amount of damage to be done.
---@param force ForceID @The force that is doing the damage.
---@param type DamageTypeID|nil @The type of damage being done. Defaults to `"impact"`.
---@param source LuaEntity|nil @The entity that is directly dealing the damage. This is the projectile, flame, sticker, grenade, laster beam, etc. Must be on the same surface as the entity being damaged.
---@param cause LuaEntity|nil @The entity that originally triggered the events that led to this damage being dealt. This can be the player character, turret, unit, etc. that pulled the trigger. Does not need to be on the same surface as the segmented unit being damaged.
---@overload fun(damage: float, force: ForceID, type: DamageTypeID|nil, source: LuaEntity|nil): float
---@overload fun(damage: float, force: ForceID, type: DamageTypeID|nil): float
---@overload fun(damage: float, force: ForceID): float
---@return float @The total damage actually applied after resistances.
function LuaSegmentedUnit.damage(damage, force, type, source, cause) end

--- Destroys the segmented unit.
---@param raise_destroy boolean|nil @If `true`, [script_raised_destroy_segmented_unit](runtime:script_raised_destroy_segmented_unit) will be called. Defaults to `false`.
---@overload fun()
function LuaSegmentedUnit.destroy(raise_destroy) end
...
---@param force ForceID|nil @The force to attribute the kill to. Defaults to the `"neutral"` force.
---@param cause LuaEntity|nil @The cause to attribute the kill to.
---@param damage_type DamageTypeID|nil @The final damage type that caused the unit to die.
---@overload fun(force: ForceID|nil, cause: LuaEntity|nil)
---@overload fun(force: ForceID|nil)
---@overload fun()
function LuaSegmentedUnit.die(force, cause, damage_type) end
...
function LuaSegmentedUnit.get_ai_state() end
...
---@return MapPosition[]
function LuaSegmentedUnit.get_body_nodes() end
...
function LuaSegmentedUnit.move_forward(distance) end
...
function LuaSegmentedUnit.set_ai_state(state) end
...
function LuaSegmentedUnit.set_body_nodes(nodes) end

---@class LuaSelectorCombinatorControlBehavior: any @Control behavior for selector combinators.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaSettings: any @Object containing the three different types of mod settings: startup settings, global runtime settings and per-player runtime settings. An instance of LuaSettings is available through the global object named `settings`.
...
---@class LuaSimulation: any @Functions for use during simulations. This object cannot be saved, and cannot be used outside of a simulation. The simulation object instance can be obtained from [LuaGameScript::simulation](runtime:LuaGameScript::simulation).
  ...
  ---@field camera_player_cursor_position MapPosition @ nilable
  ---@field camera_position MapPosition @ nilable
  ---@field camera_surface_index uint32 @ nilable
  ---@field camera_zoom double
  ---@field gui_tooltip_interval double
  ---@field hide_cursor boolean
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field smart_belt_building boolean @ nilable
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaSimulation = {}

--- Activate the rail planner at the given position.
---@param position MapPosition|nil
---@param ghost_mode boolean|nil @Defaults to `false`.
---@param build_mode defines.build_mode|nil @Defaults to [normal](runtime:defines.build_mode.normal).
---@overload fun(position: MapPosition|nil, ghost_mode: boolean|nil)
---@overload fun(position: MapPosition|nil)
---@overload fun()
function LuaSimulation.activate_rail_planner(position, ghost_mode, build_mode) end

--- Send a control press event at the current cursor position.
---@param control string @The name of the control input to press.
---@param notify boolean @Whether to show flying text of the activated control.
function LuaSimulation.control_down(control, notify) end
...
---@param control string @The name of the control input to press and release.
---@param notify boolean @Whether to show flying text of the activated control.
function LuaSimulation.control_press(control, notify) end

--- Send a control release event at the current cursor position.
---@param control string @The name of the control input to release.
function LuaSimulation.control_up(control) end

---@param name string @The name of the new player.
---@return LuaPlayer @The created player.
function LuaSimulation.create_test_player(name) end

--- Deactivate the rail planner.
function LuaSimulation.deactivate_rail_planner() end

---@param inventory_index InventoryIndex
---@param slot_index ItemStackIndex @This index is 0-based, unlike other inventory indices.
---@param inventory ("character" | "entity")|nil @Defaults to `"character"`.
---@overload fun(inventory_index: InventoryIndex, slot_index: ItemStackIndex): MapPosition
---@return MapPosition @Position of the GUI slot on the screen, if successfully found.
function LuaSimulation.get_slot_position(inventory_index, slot_index, inventory) end

---@param type SimulationWidgetType
---@param data string|nil
---@param data2 string|nil
---@overload fun(type: SimulationWidgetType, data: string|nil): MapPosition
---@overload fun(type: SimulationWidgetType): MapPosition
---@return MapPosition @Center of the GUI widget on the screen, if successfully found.
function LuaSimulation.get_widget_position(type, data, data2) end
...
function LuaSimulation.mouse_click() end

--- Send a left mouse button-down event at its current position.
function LuaSimulation.mouse_down() end

--- Send a left mouse button-up event at its current position.
function LuaSimulation.mouse_up() end

--- Move the cursor towards the given position at the given speed.
---@param position MapPosition
---@param speed double|nil @Defaults to `0.2`.
---@overload fun(position: MapPosition): boolean
---@return boolean @Whether the cursor will reach the target position with this move.
function LuaSimulation.move_cursor(position, speed) end

--- Scroll the clipboard backwards by one entry.
function LuaSimulation.scroll_clipboard_backwards() end

--- Scroll the clipboard forwards by one entry.
function LuaSimulation.scroll_clipboard_forwards() end

--- Write text as if it was typed by a player. Overwrites existing text by selecting it first.
---@param text string|nil @The text to write. Does nothing if no text is provided.
---@overload fun()
function LuaSimulation.write(text) end

---@class LuaSpaceConnectionPrototype: any @Prototype of a space connection.
  ---@field asteroid_spawn_definitions SpaceConnectionAsteroidSpawnDefinition[] @ nilable
  ---@field factoriopedia_alternative LuaSpaceConnectionPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
...
---@class LuaSpaceLocationPrototype: any @Prototype of a space location, such as a planet.
  ...
  ---@field factoriopedia_alternative LuaSpaceLocationPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field map_gen_settings MapGenSettings @ nilable
  ---@field map_seed_offset uint32 @ nilable
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ...
  ---@field ticks_between_player_effects uint32 @ nilable
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class LuaSpacePlatform: any @A space platform.
  ...
  ---@field distance double @ nilable; The point on space connection this platform is at or `nil`. It is represented as a number in range `[0, 1]`, with 0 being [LuaSpaceConnectionPrototype::from](runtime:LuaSpaceConnectionPrototype::from) and 1 being [LuaSpaceConnectionPrototype::to](runtime:LuaSpaceConnectionPrototype::to).
  ---@field ejected_items EjectedItem[] @All items that have been thrown overboard.
  ---@field force LuaForce @The force of this space platform.
  ---@field hidden boolean @If this platform is hidden from the remote view surface list.
  ...
  ---@field index uint32 @The unique index of this space platform.
  ---@field last_visited_space_location LuaSpaceLocationPrototype @ nilable; The space location this space platform previously went through or stopped at.
  ---@field name string @The name of this space platform.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field paused boolean @When `true`, the platform has paused thrust and does not advance its schedule.
  ...
  ---@field scheduled_for_deletion uint32 @If this platform is scheduled for deletion. Returns how many ticks are left before the platform will be deleted. 0 if not scheduled for deletion.
  ---@field space_connection LuaSpaceConnectionPrototype @ nilable; The space connection this space platform is traveling through or `nil`. Write operation requires a valid space connection and it sets the distance to 0.5.
  ---@field space_location LuaSpaceLocationPrototype @ nilable; The space location this space platform is stopped at or `nil`. Write operation requires a valid space location and will cancel pending item requests.
  ---@field speed double
  ---@field starter_pack ItemIDAndQualityIDPair @ nilable; The starter pack used to create this space platform.
  ...
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
  ---@field weight Weight @The total weight of the platform.
LuaSpacePlatform = {}
...
---@return boolean
function LuaSpacePlatform.can_leave_current_location() end
...
function LuaSpacePlatform.clear_ejected_items() end
...
---@param damage float
---@param cause LuaEntity|nil
---@overload fun(position: TilePosition, damage: float)
function LuaSpacePlatform.damage_tile(position, damage, cause) end

--- Schedules this space platform for deletion.
---@param ticks uint32|nil @The number of ticks from now when this platform will be deleted.
---@overload fun()
...
---@param area BoundingBox|nil
---@param position MapPosition|nil
---@param name (AsteroidChunkID | AsteroidChunkID[])|nil
---@param limit uint32|nil
---@param invert boolean|nil @If the filters should be inverted.
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil, name: (AsteroidChunkID | AsteroidChunkID[])|nil, limit: uint32|nil): uint32
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil, name: (AsteroidChunkID | AsteroidChunkID[])|nil): uint32
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil): uint32
---@overload fun(area: BoundingBox|nil): uint32
---@overload fun(): uint32
---@return uint32 @The number of destroyed chunks.
function LuaSpacePlatform.destroy_asteroid_chunks(area, position, name, limit, invert) end
...
---@param position MapPosition
---@param movement Vector @When inserters drop items into space, the [InserterPrototype::insert_position](prototype:InserterPrototype::insert_position) rotated to the inserter direction is used.
function LuaSpacePlatform.eject_item(item, position, movement) end
...
---@param limit uint32|nil
---@param invert boolean|nil @If the filters should be inverted.
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil, name: (AsteroidChunkID | AsteroidChunkID[])|nil, limit: uint32|nil): AsteroidChunk[]
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil, name: (AsteroidChunkID | AsteroidChunkID[])|nil): AsteroidChunk[]
---@overload fun(area: BoundingBox|nil, position: MapPosition|nil): AsteroidChunk[]
---@overload fun(area: BoundingBox|nil): AsteroidChunk[]
---@overload fun(): AsteroidChunk[]
---@return AsteroidChunk[]
function LuaSpacePlatform.find_asteroid_chunks_filtered(area, position, name, limit, invert) end

---@return LuaSchedule
function LuaSpacePlatform.get_schedule() end
...
---@class LuaSpacePlatformHubControlBehavior: any @Control behavior for space platform hubs
...
---@class LuaSplitterControlBehavior: any @Control behavior for splitter.
...
---@class LuaStorageTankControlBehavior: any @Control behavior for storage tanks.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaStyle: any @Style of a GUI element. All of the attributes listed here may be `nil` if not available for a particular GUI element.
  ...
  ---@field bottom_cell_padding int32 @Space between the table cell contents bottom and border.
  ---@field bottom_margin int32
  ---@field bottom_padding int32
  ---@field cell_padding int32 @Space between the table cell contents and border. Sets top/right/bottom/left cell paddings to this value.
  ---@field clicked_font_color Color
  ---@field clicked_vertical_offset int32
  ---@field color Color
  ---@field column_alignments table<uint32, Alignment> @Array containing the alignment for every column of this table element. Even though this property is marked as read-only, the alignment can be changed by indexing the LuaCustomTable, like so:
  ...
  ---@field extra_margin_when_activated int32 | int32[] @Sets `extra_top/right/bottom/left_margin_when_activated` to this value. An array with two values sets top/bottom margin to the first value and left/right margin to the second value. An array with four values sets top, right, bottom, left margin respectively.
  ---@field extra_padding_when_activated int32 | int32[] @Sets `extra_top/right/bottom/left_padding_when_activated` to this value. An array with two values sets top/bottom padding to the first value and left/right padding to the second value. An array with four values sets top, right, bottom, left padding respectively.
  ...
  ---@field height int32 @Sets both minimal and maximal height to the given value.
  ---@field horizontal_align "left" | "center" | "right" @ nilable; Horizontal align of the inner content of the widget, if any.
  ---@field horizontal_spacing int32 @Horizontal space between individual cells.
  ...
  ---@field left_cell_padding int32 @Space between the table cell contents left and border.
  ---@field left_margin int32
  ---@field left_padding int32
  ---@field margin int32 | int32[] @Sets top/right/bottom/left margins to this value. An array with two values sets top/bottom margin to the first value and left/right margin to the second value. An array with four values sets top, right, bottom, left margin respectively.
  ---@field maximal_height int32 @Maximal height ensures, that the widget will never be bigger than than that size. It can't be stretched to be bigger.
  ---@field maximal_width int32 @Maximal width ensures, that the widget will never be bigger than than that size. It can't be stretched to be bigger.
  ---@field minimal_height int32 @Minimal height ensures, that the widget will never be smaller than than that size. It can't be squashed to be smaller.
  ---@field minimal_width int32 @Minimal width ensures, that the widget will never be smaller than than that size. It can't be squashed to be smaller.
  ---@field name string @Name of this style.
  ---@field natural_height int32 @Natural height specifies the height of the element tries to have, but it can still be squashed/stretched to have a smaller or bigger size.
  ---@field natural_width int32 @Natural width specifies the width of the element tries to have, but it can still be squashed/stretched to have a smaller or bigger size.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field padding int32 | int32[] @Sets top/right/bottom/left paddings to this value. An array with two values sets top/bottom padding to the first value and left/right padding to the second value. An array with four values sets top, right, bottom, left padding respectively.
  ---@field pie_progress_color Color
  ---@field rich_text_setting defines.rich_text_setting @How this GUI element handles rich text.
  ---@field right_cell_padding int32 @Space between the table cell contents right and border.
  ---@field right_margin int32
  ---@field right_padding int32
  ...
  ---@field size int32 | int32[] @Sets both width and height to the given value. Also accepts an array with two values, setting width to the first and height to the second one.
  ---@field stretch_image_to_widget_size boolean
  ---@field strikethrough_color Color
  ---@field top_cell_padding int32 @Space between the table cell contents top and border.
  ---@field top_margin int32
  ---@field top_padding int32
  ...
  ---@field vertical_spacing int32 @Vertical space between individual cells.
  ...
  ---@field width int32 @Sets both minimal and maximal width to the given value.
LuaStyle = {}
...
---@class LuaSurface: any @A "domain" of the world. Surfaces can only be created and deleted through the API. Surfaces are uniquely identified by their name. Every game contains at least the surface "nauvis".
  ...
  ---@field daytime_parameters {dusk: double, evening: double, morning: double, dawn: double} @Parameters of daytime. Equivalent as reading [dusk](runtime:LuaSurface::dusk), [evening](runtime:LuaSurface::evening), [morning](runtime:LuaSurface::morning) and [dawn](runtime:LuaSurface::dawn) at the same time. In order for a write to take place, a new table needs to be written in one go: changing individual members of the returned table has no effect as those are value copies.
  ...
  ---@field global_effect ModuleEffects @ nilable; Surface-wide effects applied to entities with effect receivers. `nil` if this surface is not using surface-wide effect source.
  ---@field global_electric_network_statistics LuaFlowStatistics @ nilable; The global electric network statistics for this surface.
  ---@field has_global_electric_network boolean @Whether this surface currently has a global electric network.
  ---@field ignore_surface_conditions boolean @If surface condition checks should not be performed on this surface.
  ---@field index uint32 @This surface's index in [LuaGameScript::surfaces](runtime:LuaGameScript::surfaces) (unique ID). It is assigned when a surface is created, and remains so until it is [deleted](runtime:on_surface_deleted). Indexes of deleted surfaces can be reused.
  ...
  ---@field pollution_statistics LuaFlowStatistics @The pollution statistics for this surface.
  ...
  ---@field ticks_per_day uint32 @The number of ticks per day for this surface.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@overload fun(position: MapPosition, unit_count: uint32)
...
---@param name EntityID @Name of the entity to check.
---@param position MapPosition @Where the entity would be placed.
---@param direction defines.direction|nil @Direction the entity would be placed. Defaults to `north`.
---@param force ForceID|nil @The force that would place the entity. Defaults to the `"neutral"` force.
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil): boolean
---@overload fun(name: EntityID, position: MapPosition): boolean
---@return boolean
function LuaSurface.can_fast_replace(name, position, direction, force) end

--- Check for collisions with terrain or other entities.
---@param name EntityID @Name of the entity prototype to check.
---@param position MapPosition @Where the entity would be placed.
---@param direction defines.direction|nil @Direction of the placed entity. Defaults to `north`.
---@param force ForceID|nil @The force that would place the entity. Defaults to the `"neutral"` force.
---@param build_check_type defines.build_check_type|nil @Which type of check should be carried out. Defaults to `ghost_revive`.
---@param forced boolean|nil @If `true`, entities that can be marked for deconstruction are ignored. Only used if `build_check_type` is either `manual_ghost`, `script_ghost` or `blueprint_ghost`. Defaults to `false`.
---@param inner_name string|nil @The prototype name of the entity contained in the ghost. Only used if `name` is `entity-ghost`.
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, force: ForceID|nil, build_check_type: defines.build_check_type|nil, forced: boolean|nil): boolean
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, force: ForceID|nil, build_check_type: defines.build_check_type|nil): boolean
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, force: ForceID|nil): boolean
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil): boolean
---@overload fun(name: EntityID, position: MapPosition): boolean
---@return boolean
function LuaSurface.can_place_entity(name, position, direction, force, build_check_type, forced, inner_name) end

--- Cancel a deconstruction order.
---@param area BoundingBox @The area to cancel deconstruction orders in.
---@param force ForceID @The force whose deconstruction orders to cancel.
---@param player PlayerIdentification|nil @The player to set the last_user to, if any. Also the player whose undo queue this action should be added to.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@param item LuaItemStack|nil @The deconstruction item to use if any.
---@param undo_index uint32|nil @The index of the undo item to add this action to. An index of `0` creates a new undo item for it. Defaults to putting it into the appropriate undo item automatically if not specified.
---@param super_forced boolean|nil @If the cancel deconstruction is super-forced. Defaults to `false`.
---@overload fun(area: BoundingBox, force: ForceID, player: PlayerIdentification|nil, skip_fog_of_war: boolean|nil, item: LuaItemStack|nil, undo_index: uint32|nil)
---@overload fun(area: BoundingBox, force: ForceID, player: PlayerIdentification|nil, skip_fog_of_war: boolean|nil, item: LuaItemStack|nil)
---@overload fun(area: BoundingBox, force: ForceID, player: PlayerIdentification|nil, skip_fog_of_war: boolean|nil)
---@overload fun(area: BoundingBox, force: ForceID, player: PlayerIdentification|nil)
---@overload fun(area: BoundingBox, force: ForceID)
function LuaSurface.cancel_deconstruct_area(area, force, player, skip_fog_of_war, item, undo_index, super_forced) end

--- Cancel a upgrade order.
---@param area BoundingBox @The area to cancel upgrade orders in.
---@param force ForceID @The force whose upgrade orders to cancel.
---@param player PlayerIdentification|nil @The player to set the last_user to if any.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped.
---@param item LuaItemStack @The upgrade item to use.
function LuaSurface.cancel_upgrade_area(area, force, player, skip_fog_of_war, item) end
...
function LuaSurface.clear_territory_for_chunks(chunk_positions) end
...
---@param destination_force ForceID|nil
...
---@param expand_map boolean|nil @If the destination surface should be expanded when destination_area is outside current bounds. Defaults to `false`.
---@param create_build_effect_smoke boolean|nil @If true, the building effect smoke will be shown around the new entities. Defaults to `false`.
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil, clear_destination_decoratives: boolean|nil, expand_map: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil, clear_destination_decoratives: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, clone_tiles: boolean|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox, destination_surface: SurfaceIdentification|nil)
---@overload fun(source_area: BoundingBox, destination_area: BoundingBox)
function LuaSurface.clone_area(source_area, destination_area, destination_surface, destination_force, clone_tiles, clone_entities, clone_decoratives, clear_destination_entities, clear_destination_decoratives, expand_map, create_build_effect_smoke) end
...
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil, clear_destination_decoratives: boolean|nil, expand_map: boolean|nil, manual_collision_mode: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil, clear_destination_decoratives: boolean|nil, expand_map: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil, clear_destination_decoratives: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil, clear_destination_entities: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil, clone_decoratives: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil, clone_entities: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil, clone_tiles: boolean|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil, destination_force: (LuaForce | string)|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[], destination_surface: SurfaceIdentification|nil)
---@overload fun(source_offset: TilePosition, destination_offset: TilePosition, source_positions: TilePosition[])
function LuaSurface.clone_brush(source_offset, destination_offset, source_positions, destination_surface, destination_force, clone_tiles, clone_entities, clone_decoratives, clear_destination_entities, clear_destination_decoratives, expand_map, manual_collision_mode, create_build_effect_smoke) end
...
---@param create_build_effect_smoke boolean|nil @If true, the building effect smoke will be shown around the new entities.
---@overload fun(entities: LuaEntity[], destination_offset: Vector, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil, snap_to_grid: boolean|nil)
---@overload fun(entities: LuaEntity[], destination_offset: Vector, destination_surface: SurfaceIdentification|nil, destination_force: ForceID|nil)
---@overload fun(entities: LuaEntity[], destination_offset: Vector, destination_surface: SurfaceIdentification|nil)
---@overload fun(entities: LuaEntity[], destination_offset: Vector)
function LuaSurface.clone_entities(entities, destination_offset, destination_surface, destination_force, snap_to_grid, create_build_effect_smoke) end
...
---@param string string @The blueprint string to import.
---@param position MapPosition @The position to place the blueprint at.
---@param force ForceID|nil @The force to place the blueprint for. Defaults to the player force.
---@param direction defines.direction|nil @The direction to place the blueprint in. Defaults to north.
---@param flip_horizontal boolean|nil @Whether to flip the blueprint horizontally. Defaults to `false`.
---@param flip_vertical boolean|nil @Whether to flip the blueprint vertically. Defaults to `false`.
---@param by_player PlayerIdentification|nil @The player that placed the blueprint. Defaults to `nil`.
---@overload fun(string: string, position: MapPosition, force: ForceID|nil, direction: defines.direction|nil, flip_horizontal: boolean|nil, flip_vertical: boolean|nil): int32
---@overload fun(string: string, position: MapPosition, force: ForceID|nil, direction: defines.direction|nil, flip_horizontal: boolean|nil): int32
---@overload fun(string: string, position: MapPosition, force: ForceID|nil, direction: defines.direction|nil): int32
---@overload fun(string: string, position: MapPosition, force: ForceID|nil): int32
---@overload fun(string: string, position: MapPosition): int32
---@return int32 @If the blueprint string was invalid, `1` is returned. Otherwise, `nil` is returned.
function LuaSurface.create_entities_from_blueprint_string(string, position, force, direction, flip_horizontal, flip_vertical, by_player) end

--- Create an entity on this surface.
---@param name EntityID @The entity prototype name to create.
---@param position MapPosition @Where to create the entity.
---@param direction defines.direction|nil @Desired orientation of the entity after creation.
---@param quality QualityID|nil @Quality of the entity to be created. Defaults to `normal`.
---@param force ForceID|nil @Force of the entity, default is enemy.
---@param target (LuaEntity | MapPosition)|nil @Entity with health for the new entity to target.
---@param source (LuaEntity | MapPosition)|nil @Source entity. Used for beams, projectiles, and highlight-boxes.
---@param cause (LuaEntity | ForceID)|nil @Cause entity / force. The entity or force that triggered the chain of events that led to this entity being created. Used for beams, projectiles, stickers, etc. so that the damage receiver can know which entity or force to retaliate against. Defaults to the value of `source`.
---@param snap_to_grid boolean|nil @If false the exact position given is used to instead of snapping to the normal entity grid. This only applies if the entity normally snaps to the grid.
---@param fast_replace boolean|nil @If true, building will attempt to simulate fast-replace building. Defaults to `false`.
---@param undo_index uint32|nil @The index of the undo item to add this action to. An index of `0` creates a new undo item for it. Defaults to putting it into the appropriate undo item automatically if not specified.
---@param player PlayerIdentification|nil @If given set the last_user to this player. If fast_replace is true simulate fast replace using this player. Also the player whose undo queue this action should be added to.
---@param character LuaEntity|nil @If fast_replace is true simulate fast replace using this character.
---@param spill boolean|nil @If false while fast_replace is true and player is nil any items from fast-replacing will be deleted instead of dropped on the ground. Defaults to `true`.
---@param raise_built boolean|nil @If true; [defines.events.script_raised_built](runtime:defines.events.script_raised_built) will be fired on successful entity creation. Defaults to `false`.
---@param create_build_effect_smoke boolean|nil @If false, the building effect smoke will not be shown around the new entity. Defaults to `true`.
---@param spawn_decorations boolean|nil @If true, entity types that have [spawn_decoration](runtime:LuaEntityPrototype::spawn_decorations) property will apply triggers defined in the property. Defaults to `false`.
...
---@param preserve_ghosts_and_corpses boolean|nil @If true, colliding ghosts and corpses will not be removed by the creation of some entity types. Defaults to `false`.
---@param register_plant boolean|nil @If true, plants created will register in any in-range agricultural towers.
---@param burner_fuel_inventory BlueprintInventoryWithFilters|nil @Used by entities with a burner energy source.
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil, spawn_decorations: boolean|nil, move_stuck_players: boolean|nil, item: LuaItemStack|nil, preserve_ghosts_and_corpses: boolean|nil, register_plant: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil, spawn_decorations: boolean|nil, move_stuck_players: boolean|nil, item: LuaItemStack|nil, preserve_ghosts_and_corpses: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil, spawn_decorations: boolean|nil, move_stuck_players: boolean|nil, item: LuaItemStack|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil, spawn_decorations: boolean|nil, move_stuck_players: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil, spawn_decorations: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil, create_build_effect_smoke: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil, raise_built: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil, spill: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil, character: LuaEntity|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil, player: PlayerIdentification|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil, undo_index: uint32|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil, fast_replace: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil, snap_to_grid: boolean|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil, cause: (LuaEntity | ForceID)|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil, source: (LuaEntity | MapPosition)|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil, target: (LuaEntity | MapPosition)|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil, force: ForceID|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil, quality: QualityID|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition, direction: defines.direction|nil): LuaEntity
---@overload fun(name: EntityID, position: MapPosition): LuaEntity
---@return LuaEntity @The created entity or `nil` if the creation failed.
function LuaSurface.create_entity(name, position, direction, quality, force, target, source, cause, snap_to_grid, fast_replace, undo_index, player, character, spill, raise_built, create_build_effect_smoke, spawn_decorations, move_stuck_players, item, preserve_ghosts_and_corpses, register_plant, burner_fuel_inventory) end
...
---@param name ParticleID @The particle name.
...
function LuaSurface.create_particle(name, position, movement, height, vertical_speed, frame_speed) end
...
---@param name EntityID @The segmented-unit prototype name to create. Must be of type `"segmented-unit"`.
---@param quality QualityID|nil @Quality of the entity to be created. Defaults to `normal`.
---@param force ForceID|nil @Force of the segmented unit. Defaults to `enemy`.
---@param territory LuaTerritory|nil @The territory that the segmented unit is assigned to. If `nil`, the segmented unit will patrol around its spawn location. Must be located on this same surface.
---@overload fun(name: EntityID, quality: QualityID|nil, force: ForceID|nil): LuaSegmentedUnit
---@overload fun(name: EntityID, quality: QualityID|nil): LuaSegmentedUnit
---@overload fun(name: EntityID): LuaSegmentedUnit
...
function LuaSurface.create_segmented_unit(name, quality, force, territory) end

--- Create a territory on the surface.
---@param chunks ChunkPosition[] @The chunks to assign to the new territory. Must contain at least one generated chunk. Any chunks already assigned to existing territories will be removed from those territories. Any territories left with no generated chunks will be deleted from the surface as a result.
---@param patrol_path MapPosition[]|nil @The path that patrolling units will follow. If `nil` or empty, one will be generated for the new territory based on `chunks`.
---@overload fun(chunks: ChunkPosition[]): LuaTerritory
---@return LuaTerritory @The created territory or `nil` if the creation failed or the territory was destroyed during creation.
function LuaSurface.create_territory(chunks, patrol_path) end

---@param name TrivialSmokeID @The smoke prototype name to create.
...
---@param force ForceID|nil @Force of the new unit group. Defaults to `"enemy"`.
---@overload fun(position: MapPosition): LuaCommandable
---@return LuaCommandable
function LuaSurface.create_unit_group(position, force) end

--- Place a deconstruction request.
---@param area BoundingBox @The area to mark for deconstruction.
---@param force ForceID @The force whose bots should perform the deconstruction.
---@param player PlayerIdentification|nil @The player to set the last_user to if any.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped. Defaults to `false`.
---@param item LuaItemStack|nil @The deconstruction item to use if any.
---@param super_forced boolean|nil @If the deconstruction is super-forced. Defaults to `false`.
...
---@overload fun(area: BoundingBox, force: ForceID, player: PlayerIdentification|nil)
---@overload fun(area: BoundingBox, force: ForceID)
function LuaSurface.deconstruct_area(area, force, player, skip_fog_of_war, item, super_forced) end
...
function LuaSurface.delete_chunk(chunk_position) end
...
---@param name (DecorativeID | DecorativeID[])|nil
---@param collision_mask (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil
...
---@param limit uint32|nil
---@param invert boolean|nil @If the filters should be inverted.
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil, exclude_soft: boolean|nil, limit: uint32|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil, exclude_soft: boolean|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil)
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil)
---@overload fun(area: BoundingBox|nil)
---@overload fun()
function LuaSurface.destroy_decoratives(area, position, name, collision_mask, from_layer, to_layer, exclude_soft, limit, invert) end
...
---@param name EntityID
---@param position MapPosition
function LuaSurface.execute_lightning(name, position) end
...
---@param limit uint32|nil
---@param invert boolean|nil @If the filters should be inverted.
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil, exclude_soft: boolean|nil, limit: uint32|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil, exclude_soft: boolean|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil, to_layer: string|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil, from_layer: string|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil, collision_mask: (CollisionLayerID | CollisionLayerID[] | (table<CollisionLayerID, true>))|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil, name: (DecorativeID | DecorativeID[])|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil, position: TilePosition|nil): DecorativeResult[]
---@overload fun(area: BoundingBox|nil): DecorativeResult[]
---@overload fun(): DecorativeResult[]
---@return DecorativeResult[]
function LuaSurface.find_decoratives_filtered(area, position, name, collision_mask, from_layer, to_layer, exclude_soft, limit, invert) end
...
---@param force ForceID|nil @The force the result will be an enemy of. Uses the player force if not specified.
---@overload fun(position: MapPosition, max_distance: double): LuaEntity
---@return LuaEntity @The nearest enemy military target or `nil` if no enemy could be found within the given area.
function LuaSurface.find_nearest_enemy(position, max_distance, force) end
...
function LuaSurface.find_nearest_enemy_entity_with_owner(position, max_distance, force) end
...
---@param force ForceID @Force performing the search.
---@param condition ForceCondition @Only forces which meet the condition will be included in the search.
---@return LuaEntity[]
function LuaSurface.find_units(area, force, condition) end
...
---@param tile TileID
---@return LuaTilePrototype
function LuaSurface.get_default_cover_tile(force, tile) end
...
---@return LuaEntity[]
function LuaSurface.get_entities_with_force(chunk_position, force) end
...
---@param key (string | uint32)|nil @The name or id of the area to get.
...
---@param key (string | uint32)|nil @The name or id of the position to get.
...
function LuaSurface.get_segmented_units() end
...
---@return LuaTerritory[]
function LuaSurface.get_territories() end
...
---@return LuaTerritory
function LuaSurface.get_territory_for_chunk(chunk_position) end
...
---@param prototype EntityID|nil @The entity prototype to attribute the pollution change to in statistics. If not defined, the pollution change will not show up in statistics.
---@overload fun(source: MapPosition, amount: double)
...
---@param collision_mask CollisionMask @The collision mask the `bounding_box` collides with.
...
---@param force ForceID @The force for which to generate the path, determining which gates can be opened for example.
...
---@param path_resolution_modifier int32|nil @Defines how coarse the pathfinder's grid is, where smaller values mean a coarser grid. Defaults to `0`, which equals a resolution of `1x1` tiles, centered on tile centers. Values range from `-8` to `8` inclusive, where each integer increment doubles/halves the resolution. So, a resolution of `-8` equals a grid of `256x256` tiles, and a resolution of `8` equals `1/256` of a tile.
---@param max_gap_size int32|nil @Defines the maximum allowed distance between path waypoints. 0 means that paths must be contiguous (as they are for biters). Values greater than 0 will produce paths with "gaps" that are suitable for spiders. Allowed values are from `0` to `31`. Defaults to `0`.
---@param max_attack_distance double|nil @Defines the maximum allowed distance between the last traversable path waypoint and an obstacle entity to be destroyed. Only used when finding a discontiguous path, i.e. when `max_gap_size` > 0. This field filters out paths that are blocked by obstacles that are outside the entity's attack range. Allowed values are `0` or greater. Defaults to `max_gap_size`.
---@param entity_to_ignore LuaEntity|nil @Makes the pathfinder ignore collisions with this entity if it is given.
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil, pathfind_flags: PathfinderFlags|nil, can_open_gates: boolean|nil, path_resolution_modifier: int32|nil, max_gap_size: int32|nil, max_attack_distance: double|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil, pathfind_flags: PathfinderFlags|nil, can_open_gates: boolean|nil, path_resolution_modifier: int32|nil, max_gap_size: int32|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil, pathfind_flags: PathfinderFlags|nil, can_open_gates: boolean|nil, path_resolution_modifier: int32|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil, pathfind_flags: PathfinderFlags|nil, can_open_gates: boolean|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil, pathfind_flags: PathfinderFlags|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID, radius: double|nil): uint32
---@overload fun(bounding_box: BoundingBox, collision_mask: CollisionMask, start: MapPosition, goal: MapPosition, force: ForceID): uint32
---@return uint32 @A unique handle to identify this call when [on_script_path_request_finished](runtime:on_script_path_request_finished) fires.
function LuaSurface.request_path(bounding_box, collision_mask, start, goal, force, radius, pathfind_flags, can_open_gates, path_resolution_modifier, max_gap_size, max_attack_distance, entity_to_ignore) end
...
---@param radius uint32|nil @The chunk radius from `position` to generate new chunks in. Defaults to `0`.
---@overload fun(position: MapPosition)
...
function LuaSurface.set_default_cover_tile(force, from_tile, to_tile) end
...
---@param command Command
---@param unit_count uint32 @Number of units to give the command to.
---@param force ForceID|nil @Force of the units this command is to be given to. If not specified, uses the enemy force.
---@param unit_search_distance uint32|nil @Radius to search for units. The search area is centered on the destination of the command. If not specified uses default value of 150.
---@overload fun(command: Command, unit_count: uint32, force: ForceID|nil): uint32
---@overload fun(command: Command, unit_count: uint32): uint32
---@return uint32 @Number of units actually sent. May be less than `count` if not enough units were available.
function LuaSurface.set_multi_command(command, unit_count, force, unit_search_distance) end
...
---@param inventory LuaInventory @Inventory to spill
---@param enable_looted boolean|nil @When true, each created item will be flagged with the [LuaEntity::to_be_looted](runtime:LuaEntity::to_be_looted) flag. Defaults to `false`.
---@param force ForceID|nil @When provided (and not `nil`) the items will be marked for deconstruction by this force.
---@param allow_belts boolean|nil @Whether items can be spilled onto belts. Defaults to `true`.
---@param max_radius double|nil @Max radius from the specified `position` to spill items.
---@param use_start_position_on_failure boolean|nil @Allow spilling items at `position` if no non-colliding position is found. Note: Setting to false might cause some items not to be spilled. Defaults to `true`.
---@param drop_full_stack boolean|nil @If item on ground should be made out of an entire provided stack. Defaults to `false`.
---@overload fun(position: MapPosition, inventory: LuaInventory, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil, max_radius: double|nil, use_start_position_on_failure: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, inventory: LuaInventory, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil, max_radius: double|nil): LuaEntity[]
---@overload fun(position: MapPosition, inventory: LuaInventory, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, inventory: LuaInventory, enable_looted: boolean|nil, force: ForceID|nil): LuaEntity[]
---@overload fun(position: MapPosition, inventory: LuaInventory, enable_looted: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, inventory: LuaInventory): LuaEntity[]
---@return LuaEntity[] @The created item-on-ground entities.
function LuaSurface.spill_inventory(position, inventory, enable_looted, force, allow_belts, max_radius, use_start_position_on_failure, drop_full_stack) end

--- Spill items on the ground centered at a given location.
---@param position MapPosition @Center of the spillage
---@param stack ItemStackIdentification @Stack of items to spill
---@param enable_looted boolean|nil @When true, each created item will be flagged with the [LuaEntity::to_be_looted](runtime:LuaEntity::to_be_looted) flag. Defaults to `false`.
---@param force ForceID|nil @When provided (and not `nil`) the items will be marked for deconstruction by this force.
---@param allow_belts boolean|nil @Whether items can be spilled onto belts. Defaults to `true`.
---@param max_radius double|nil @Max radius from the specified `position` to spill items.
---@param use_start_position_on_failure boolean|nil @Allow spilling items at `position` if no non-colliding position is found. Note: Setting to false might cause some items not to be spilled. Defaults to `true`.
---@param drop_full_stack boolean|nil @If item on ground should be made out of an entire provided stack. Defaults to `false`.
---@overload fun(position: MapPosition, stack: ItemStackIdentification, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil, max_radius: double|nil, use_start_position_on_failure: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, stack: ItemStackIdentification, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil, max_radius: double|nil): LuaEntity[]
---@overload fun(position: MapPosition, stack: ItemStackIdentification, enable_looted: boolean|nil, force: ForceID|nil, allow_belts: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, stack: ItemStackIdentification, enable_looted: boolean|nil, force: ForceID|nil): LuaEntity[]
---@overload fun(position: MapPosition, stack: ItemStackIdentification, enable_looted: boolean|nil): LuaEntity[]
---@overload fun(position: MapPosition, stack: ItemStackIdentification): LuaEntity[]
---@return LuaEntity[] @The created item-on-ground entities.
function LuaSurface.spill_item_stack(position, stack, enable_looted, force, allow_belts, max_radius, use_start_position_on_failure, drop_full_stack) end

--- Place an upgrade request.
---@param area BoundingBox @The area to mark for upgrade.
---@param force ForceID @The force whose bots should perform the upgrade.
---@param player PlayerIdentification|nil @The player to set the last_user to if any.
---@param skip_fog_of_war boolean|nil @If chunks covered by fog-of-war are skipped.
---@param item LuaItemStack @The upgrade item to use.
function LuaSurface.upgrade_area(area, force, player, skip_fog_of_war, item) end

---@class LuaSurfacePropertyPrototype: any @Prototype of a surface property.
...
---@class LuaSurfacePrototype: any @Prototype of a surface.
  ---@field factoriopedia_alternative LuaSurfacePrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaTechnology: any @One research item.
  ...
  ---@field level uint32 @The current level of this technology. For level-based technology writing to this is the same as researching the technology to the previous level. Writing the level will set [LuaTechnology::enabled](runtime:LuaTechnology::enabled) to `true`.
  ---@field localised_description LocalisedString
  ...
  ---@field research_unit_count uint32 @The number of research units required for this technology. This is multiplied by the current research cost multiplier, unless [LuaTechnologyPrototype::ignore_tech_cost_multiplier](runtime:LuaTechnologyPrototype::ignore_tech_cost_multiplier) is `true`.
...
---@class LuaTechnologyPrototype: any @A Technology prototype.
  ...
  ---@field factoriopedia_alternative LuaTechnologyPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ...
  ---@field level uint32 @The level of this research.
  ---@field max_level uint32 @The max level of this research.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaTerritory: any @A set of chunks on a single [LuaSurface](runtime:LuaSurface) that can be guarded by one or more [LuaSegmentedUnit](runtime:LuaSegmentedUnit)s. A territory is owned by the surface for which it was created. It comprises any number of disconnected or connected chunks. A chunk can only be owned by at most one territory. A territory's chunks may or may not be generated. Territories may be patrolled by any number of [LuaSegmentedUnit](runtime:LuaSegmentedUnit)s. A territory with no units will not appear on player's maps. Territories may define a patrol path that [LuaSegmentedUnit](runtime:LuaSegmentedUnit)s will follow. If no such path is defined, then units will wander randomly throughout the territory chunks. If a territory contains no patrol path and no chunks, then units will behave as if they are assigned to any territory. The game will automatically destroy any territory that does not have at least one chunk that is generated or requested to be generated. This is to prevent bloat when chunks are deleted. This can happen as a result of any operation that modifies a territory's chunks, including but not limited to [LuaSurface::delete_chunk](runtime:LuaSurface::delete_chunk), [LuaSurface::set_territory_for_chunks](runtime:LuaSurface::set_territory_for_chunks), and [LuaSurface::clear_territory_for_chunks](runtime:LuaSurface::clear_territory_for_chunks).
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field surface LuaSurface @The surface on which this territory is located.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaTerritory = {}
...
---@return MapPosition[]
function LuaTerritory.get_patrol_path() end

--- Gets the [LuaSegmentedUnit](runtime:LuaSegmentedUnit)s that guard this territory.
---@return LuaSegmentedUnit[]
function LuaTerritory.get_segmented_units() end
...
function LuaTerritory.regenerate_patrol_path() end
...
function LuaTerritory.regenerate_segmented_units() end
...
function LuaTerritory.set_patrol_path(patrol_path) end
...
---@class LuaTilePrototype: any @Prototype of a tile.
  ...
  ---@field factoriopedia_alternative LuaTilePrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ...
  ---@field items_to_place_this ItemToPlace[] @ nilable; Items that when placed will produce this tile, if any. Construction bots will choose the first item in the list to build this tile.
  ---@field layer uint32
...
---@class LuaTrain: any @A train. Trains are a sequence of connected rolling stocks -- locomotives and wagons.
  ...
  ---@field id uint32 @The unique train ID.
  ---@field kill_count uint32 @The total number of kills by this train.
  ---@field killed_players table<uint32, uint32> @The players killed by this train. The keys are the player indices, the values are how often this train killed that player.
...
---@return ItemWithQualityCounts @List of all items in the train.
function LuaTrain.get_contents() end

--- Gets a mapping of the train's fluid inventory.
---@return table<string, FluidAmount> @The counts, indexed by fluid names.
...
---@param item ItemFilter|nil @If not given, counts all items.
---@overload fun(): uint32
---@return uint32
...
---@param train_id uint32 @Train ID to search
...
---@param type TrainPathRequestType|nil @Request type. Determines the return type of the method. Defaults to `"path"`.
---@param train LuaTrain|nil @Mandatory if `starts` is not provided, optional otherwise. Selects a context for the pathfinder to decide which train to exclude from penalties and which signals are considered possible to reacquire. If `starts` is not provided, then it is also used to collect front and back ends for the search
---@param goals TrainPathFinderGoal[]
---@param return_path boolean|nil @Only relevant if request type is `"path"`. Returning a full path is expensive due to multiple LuaEntity created. In order for path to be returned, true must be provided here. Defaults to false in which case a path will not be provided.
---@param starts RailEndStart[]|nil @Manually provided starting positions.
---@param search_direction ("respect-movement-direction" | "any-direction-with-locomotives")|nil @Only relevant if `starts` was not provided in which case 2 starts (front and back) are deduced from the train. Selects which train ends should be considered as starts. Defaults to `"any-direction-with-locomotives"`.
---@param in_chain_signal_section boolean|nil @Defaults to `false`. If set to true, pathfinder will not return a path that cannot have its start immediately reserved. A path that cannot have its start immediately reserved could cause a train to stop inside of an intersection.
---@param steps_limit uint32|nil @Maximum amount of steps pathfinder is allowed to perform.
---@param shortest_path boolean|nil @Defaults to `false`. If set to true, only length of rails is added to penalties causing search to look for shortest path (not smallest penalty)
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[], return_path: boolean|nil, starts: RailEndStart[]|nil, search_direction: ("respect-movement-direction" | "any-direction-with-locomotives")|nil, in_chain_signal_section: boolean|nil, steps_limit: uint32|nil): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[], return_path: boolean|nil, starts: RailEndStart[]|nil, search_direction: ("respect-movement-direction" | "any-direction-with-locomotives")|nil, in_chain_signal_section: boolean|nil): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[], return_path: boolean|nil, starts: RailEndStart[]|nil, search_direction: ("respect-movement-direction" | "any-direction-with-locomotives")|nil): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[], return_path: boolean|nil, starts: RailEndStart[]|nil): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[], return_path: boolean|nil): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@overload fun(type: TrainPathRequestType|nil, train: LuaTrain|nil, goals: TrainPathFinderGoal[]): TrainPathFinderOneGoalResult | TrainPathAllGoalsResult
---@return TrainPathFinderOneGoalResult | TrainPathAllGoalsResult @The type of the returned value depends on `type`.
function LuaTrainManager.request_train_path(type, train, goals, return_path, starts, search_direction, in_chain_signal_section, steps_limit, shortest_path) end

---@class LuaTrainStopControlBehavior: any @Control behavior for train stops.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaTransportBeltControlBehavior: any @Control behavior for transport belts.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaTransportLine: any @One line on a transport belt.
  ...
  ---@field total_segment_length double @Total length of segment which consists of this line, all lines in front and lines in the back directly connected.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaTransportLine = {}
...
---@overload fun(position: float, items: ItemStackIdentification)
function LuaTransportLine.force_insert_at(position, items, belt_stack_size) end

--- Get counts of all items on this line, similar to how [LuaInventory::get_contents](runtime:LuaInventory::get_contents) does.
---@return ItemWithQualityCounts @List of all items on this line.
...
---@param item ItemFilter|nil @If not specified, count all items.
---@overload fun(): uint32
---@return uint32
...
---@class LuaTurretControlBehavior: any @Control behavior for turrets.
...
---@class LuaUndoRedoStack: any @The undo queue for a player. The term `item_index` refers to the index of an undo item in the queue, while `action_index` refers to the index of one of the individual actions that make up an undo item. Items are added to the undo queue through player actions and Lua methods that emulate player actions like [LuaEntity::order_upgrade](runtime:LuaEntity::order_upgrade).
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ---@field player_index uint32 @The index of the player to whom this stack belongs to.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
LuaUndoRedoStack = {}

--- Gets an undo item from the redo stack.
---@param index uint32 @The index of the item to get, ordered from most recent to oldest.
...
---@param item_index uint32 @The index of the redo item, ordered from most recent to oldest.
---@param action_index uint32 @The index of the redo action.
...
---@param index uint32 @The index of the undo item to get, ordered from most recent to oldest.
---@return UndoRedoAction[]
...
---@param item_index uint32 @The index of the undo item, ordered from most recent to oldest.
---@param action_index uint32 @The index of the undo action.
---@param tag_name string @The name of the tag to get.
---@return AnyBasic
...
---@param item_index uint32 @The index of the undo item to change, ordered from most recent to oldest.
---@param action_index uint32 @The index of the undo action to remove.
function LuaUndoRedoStack.remove_redo_action(item_index, action_index) end

--- Removes an undo item from the redo stack.
---@param index uint32 @The index of the undo item to remove, ordered from most recent to oldest.
...
---@class LuaVirtualSignalPrototype: any @Prototype of a virtual signal.
  ---@field factoriopedia_alternative LuaVirtualSignalPrototype @ nilable; An alternative prototype that will be used to display info about this prototype in Factoriopedia.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
...
---@class LuaWallControlBehavior: any @Control behavior for walls.
...
---@class LuaWireConnector: any @A wire connector of a given entity. Allows to find wires, add or remove wires and do some basic operations specific to those connectors.
  ---@field connection_count uint32 @Amount of wires going out of this connector. It includes all wires (ghost wires and real wires).
  ---@field connections WireConnection[] @All wire connectors this connector is connected to. It includes all wires (ghost wires and real wires).
  ...
  ---@field network_id uint32 @Index of a CircuitNetwork or ElectricSubNetwork which is going through this wire connector. Returns 0 if there is no network associated with this wire connector right now. CircuitNetwork indexes are independent of indexes of ElectricSubNetwork so they may collide with each other.
  ---@field object_name string @The class name of this object. Available even when `valid` is false. For LuaStruct objects it may also be suffixed with a dotted path to a member of the struct.
  ...
  ---@field real_connection_count uint32 @Amount of real wires going out of this connector. It only includes wires for which both wire connectors are real (not ghosts).
  ---@field real_connections WireConnection[] @All wire connectors this connector is connected to with real wires. It only includes wires that are between two non-ghost entities.
  ---@field valid boolean @Is this object valid? This Lua object holds a reference to an object within the game engine. It is possible that the game-engine object is removed whilst a mod still holds the corresponding Lua object. If that happens, the object becomes invalid, i.e. this attribute will be `false`. Mods are advised to check for object validity if any change to the game state might have occurred between the creation of the Lua object and its access.
...
---@class CustomInputEvent: EventData @Called when a [CustomInputPrototype](prototype:CustomInputPrototype) is activated.
  ---@field cursor_direction defines.direction @nilable; Cursor direction.
  ...
  ---@field element LuaGuiElement @nilable; The GUI element under the cursor when the custom input was activated.
  ---@field in_gui boolean @If the cursor was over any GUI when the custom input was activated.
  ---@field input_name string @The prototype name of the custom input that was activated.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player that activated the custom input.
...
---@class OnAiCommandCompleted: EventData @Called when a unit/group completes a command.
  ...
  ---@field tick uint32 @Tick the event was generated.
  ---@field unit_number uint32 @unit_number/group_number of the unit/group which just completed a command.
...
---@class OnBuiltEntity: EventData @Called when player builds something.
  ---@field consumed_items LuaInventory @A temporary inventory containing all items that the game used to build the entity. This inventory is temporary and thus invalidated after the event.
  ---@field entity LuaEntity @The entity that was built.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the building.
...
---@class OnCancelledDeconstruction: EventData @Called when the deconstruction of an entity is canceled.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnCargoPodDeliveredCargo: EventData @Called after a cargo pod has delivered its cargo.
  ---@field cargo_pod LuaEntity
  ---@field name defines.events @Identifier of the event
  ---@field spawned_container LuaEntity @nilable; The spawned container if any. Created when destination type is [surface](runtime:defines.cargo_destination.surface).
  ---@field tick uint32 @Tick the event was generated.

---@class OnCargoPodFinishedAscending: EventData @Called when a cargo pod departs a surface.
  ---@field cargo_pod LuaEntity
  ---@field launched_by_rocket boolean @True for pods spawned on a rocket. This event triggers for platform and modded pods as well, but only when true will the pod count towards rocket launch statistics and trigger 'rocket-launched' achievement with objective_condition.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that is riding the cargo pod, if any.
  ---@field tick uint32 @Tick the event was generated.

---@class OnCargoPodFinishedDescending: EventData @Called when a cargo pods lands on a surface, either at a station or on the ground.
  ---@field cargo_pod LuaEntity
  ---@field launched_by_rocket boolean @True for pods spawned on a rocket.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that is riding the cargo pod, if any.
  ---@field tick uint32 @Tick the event was generated.

---@class OnCargoPodStartedAscending: EventData @Called when a cargo pod departs from a space platform hub or by another method not attached to a rocket.
  ---@field cargo_pod LuaEntity
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that is riding the cargo pod, if any.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnChartTagModified: EventData @Called when a chart tag is modified by a player or by script.
  ---@field force LuaForce
  ---@field name defines.events @Identifier of the event
  ---@field old_icon SignalID
  ---@field old_player_index uint32 @nilable
...
---@class OnConsoleChat: EventData @Called when a message is sent to the in-game console, either by a player or through the server interface. This event only fires for plain messages, not for any commands (including `/shout` or `/whisper`).
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player doing the chatting, if any.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnConsoleCommand: EventData @Called when someone enters a command-like message regardless of it being a valid command.
  ...
  ---@field player_index uint32 @nilable; The player if any.
  ---@field tick uint32 @Tick the event was generated.

---@class OnCutsceneCancelled: EventData @Called when a cutscene is cancelled by the player or by script.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player the cutscene was shown to.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnCutsceneStarted: EventData @Called when a cutscene starts.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player the cutscene is being shown to.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnCutsceneWaypointReached: EventData @Called when a cutscene is playing, each time it reaches a waypoint in that cutscene. This refers to an index in the table previously passed to set_controller which started the cutscene.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player index of the player viewing the cutscene.
  ---@field tick uint32 @Tick the event was generated.
  ---@field waypoint_index uint32 @The index of the waypoint we just completed.
...
---@class OnEntityLogisticSlotChanged: EventData @Called when one of an entity's logistic slots changes.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player who changed the slot, or `nil` if changed by script.
  ---@field section LuaLogisticSection @The section changed.
  ---@field slot_index uint32 @The slot index that was changed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnEntityRenamed: EventData @Called after an entity has been renamed either by the player or through script.
  ...
  ---@field player_index uint32 @nilable; If by_script is true this will not be included.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnEquipmentRemoved: EventData @Called after equipment is removed from an equipment grid.
  ---@field count uint32 @The count of equipment removed.
...
---@class OnForcesMerged: EventData @Called after two forces have been merged using `game.merge_forces()`. The source force is invalidated before this event is called and the name can be re-used in this event if desired.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field source_index uint32 @The index of the destroyed force.
...
---@class OnGuiCheckedStateChanged: EventData @Called when [LuaGuiElement](runtime:LuaGuiElement) checked state is changed (related to checkboxes and radio buttons).
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the change.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnGuiClick: EventData @Called when [LuaGuiElement](runtime:LuaGuiElement) is clicked.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the clicking.
...
---@class OnGuiClosed: EventData @Called when the player closes the GUI they have open. This can only be raised when the GUI's player controller is still valid. If a GUI is thus closed due to the player disconnecting, dying, or becoming a spectator in other ways, it won't cause this event to be raised. It's not advised to open any other GUI during this event because if this is run as a request to open a different GUI the game will force close the new opened GUI without notice to ensure the original requested GUI is opened.
  ---@field element LuaGuiElement @nilable; The custom GUI element that was closed.
  ---@field entity LuaEntity @nilable; The entity or entity grid whose GUI was closed.
  ---@field equipment LuaEquipment @nilable; The equipment whose GUI was closed.
  ---@field gui_type defines.gui_type @The type of GUI that was closed.
  ---@field inventory LuaInventory @nilable; The script inventory whose GUI was closed.
  ---@field item LuaItemStack @nilable; The item whose GUI was closed.
  ---@field name defines.events @Identifier of the event
  ---@field other_player LuaPlayer @nilable; The other player whose GUI was closed.
  ---@field player_index uint32 @The player closing the GUI.
  ---@field surface_index uint32 @nilable; The surface index of the global electric network whose GUI was closed.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tile_position TilePosition @nilable; The position of the tile whose GUI was closed.
...
---@class OnGuiConfirmed: EventData @Called when a [LuaGuiElement](runtime:LuaGuiElement) is confirmed, for example by pressing Enter in a textfield.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the confirming.
  ---@field shift boolean @If shift was pressed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnGuiHover: EventData @Called when [LuaGuiElement](runtime:LuaGuiElement) is hovered by the mouse. Only fired for events whose [LuaGuiElement::raise_hover_events](runtime:LuaGuiElement::raise_hover_events) is `true`.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player whose cursor is hovering.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnGuiLeave: EventData @Called when the player's cursor leaves a [LuaGuiElement](runtime:LuaGuiElement) that was previously hovered. Only fired for events whose [LuaGuiElement::raise_hover_events](runtime:LuaGuiElement::raise_hover_events) is `true`.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player whose cursor was hovering.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnGuiOpened: EventData @Called when the player opens a GUI.
  ...
  ---@field entity LuaEntity @nilable; The entity or entity grid whose GUI was opened.
  ---@field equipment LuaEquipment @nilable; The equipment whose GUI was opened.
  ---@field gui_type defines.gui_type @The type of GUI that was opened.
  ---@field inventory LuaInventory @nilable; The script inventory whose GUI was opened.
  ---@field item LuaItemStack @nilable; The item whose GUI was opened.
  ---@field name defines.events @Identifier of the event
  ---@field other_player LuaPlayer @nilable; The other player whose GUI was opened.
  ---@field player_index uint32 @The player closing the GUI.
  ---@field surface_index uint32 @nilable; The surface index of the global electric network whose GUI was opened.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tile_position TilePosition @nilable; The position of the tile whose GUI was opened.
...
---@class OnGuiTextChanged: EventData @Called when [LuaGuiElement](runtime:LuaGuiElement) text is changed by the player.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the edit.
...
---@class OnMarkedForUpgrade: EventData @Called when an entity is marked for upgrade with the upgrade planner or via script.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable
  ---@field previous_quality LuaQualityPrototype @nilable; Previous upgrade target quality, if entity was already marked for upgrade.
  ---@field previous_target LuaEntityPrototype @nilable; Previous upgrade target of the entity, if entity was already marked for upgrade.
  ---@field quality LuaQualityPrototype @The target quality.
  ---@field target LuaEntityPrototype
  ---@field tick uint32 @Tick the event was generated.

---@class OnMarketItemPurchased: EventData @Called after a player purchases some offer from a `market` entity.
  ---@field count uint32 @The amount of offers purchased.
  ---@field market LuaEntity @The market entity.
  ---@field name defines.events @Identifier of the event
  ---@field offer_index uint32 @The index of the offer purchased.
  ---@field player_index uint32 @The player who did the purchasing.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnModItemOpened: EventData @Called when the player uses the 'Open item GUI' control on an item defined with the 'mod-openable' flag
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player.
  ---@field quality LuaQualityPrototype @The item quality clicked on.
  ---@field tick uint32 @Tick the event was generated.

---@class OnMultiplayerInit: EventData @Called when [LuaGameScript::is_multiplayer](runtime:LuaGameScript::is_multiplayer) changes to true. May also be raised when it was already true but a game was loaded from a save file and with hosting.
  ---@field name defines.events @Identifier of the event
  ---@field tick uint32 @Tick the event was generated.

---@class OnObjectDestroyed: EventData @Called after an object is destroyed which was registered with [LuaBootstrap::register_on_object_destroyed](runtime:LuaBootstrap::register_on_object_destroyed) previously. Depending on when a given object is destroyed, this event will be fired at the end of the current tick or at the end of the next tick. The event's timing is independent of the in-world object being destroyed.
  ---@field name defines.events @Identifier of the event
  ...
  ---@field useful_id uint64 @The [useful identifier](runtime:RegistrationTarget) of the object. Same as second value returned by [LuaBootstrap::register_on_object_destroyed](runtime:LuaBootstrap::register_on_object_destroyed)
...
---@class OnPermissionGroupAdded: EventData @Called directly after a permission group is added.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that added the group or `nil` if by a mod.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPermissionGroupDeleted: EventData @Called directly after a permission group is deleted.
  ...
  ---@field id uint32 @The group id that was deleted.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player doing the deletion or `nil` if by a mod.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPermissionGroupEdited: EventData @Called directly after a permission group is edited in some way.
  ...
  ---@field other_player_index uint32 @The other player when the `type` is `"add-player"` or `"remove-player"`.
  ---@field player_index uint32 @nilable; The player that did the editing or `nil` if by a mod.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPermissionStringImported: EventData @Called directly after a permission string is imported.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player that imported the string.
  ---@field tick uint32 @Tick the event was generated.

---@class OnPickedUpItem: EventData @Called when a player picks up an item.
  ---@field item_stack ItemWithQualityCount
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerAltReverseSelectedArea: EventData @Called after a player alt-reverse-selects an area with a selection-tool item.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player doing the selection.
...
---@class OnPlayerBanned: EventData @Called when a player is banned.
  ---@field by_player uint32 @nilable; The player that did the banning if any.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player banned.
...
---@class OnPlayerBuiltTile: EventData @Called after a player builds tiles.
  ...
  ---@field surface_index uint32 @The surface the tile(s) were built on.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerCancelledCrafting: EventData @Called when a player cancels crafting.
  ---@field cancel_count uint32 @The number of crafts that have been cancelled.
  ---@field items LuaInventory @The crafting items returned to the player's inventory.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player that did the crafting.
...
---@class OnPlayerChangedForce: EventData @Called after a player changes forces.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who changed forces.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerChangedSurface: EventData @Called after a player changes surfaces.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who changed surfaces.
  ---@field surface_index uint32 @nilable; The surface index the player was on - may be `nil` if the surface no longer exists.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerClickedGpsTag: EventData @Called when a player clicks a gps tag
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @Index of the player
...
---@class OnPlayerControllerChanged: EventData @Called after a player changes controller types.
  ...
  ---@field player_index uint32 @The player who changed controllers.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerCraftedItem: EventData @Called when the player finishes crafting an item. This event fires just before the results are inserted into the player's inventory, not when the crafting is queued (see [on_pre_player_crafted_item](runtime:on_pre_player_crafted_item)).
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player doing the crafting.
...
---@class OnPlayerDeconstructedArea: EventData @Called when a player selects an area with a deconstruction planner.
  ...
  ---@field player_index uint32 @The player doing the selection.
  ---@field quality string @The item quality used to select the area.
  ---@field record LuaRecord @nilable; The record that was used to select the area.
...
---@class OnPlayerDroppedItemIntoEntity: EventData @Called when a player drops a single item into an entity.
  ---@field entity LuaEntity @The entity the item was dropped into.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerFastTransferred: EventData @Called when a player fast-transfers something to or from an entity.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player transferred from or to.
  ---@field tick uint32 @Tick the event was generated.

---@class OnPlayerFlippedEntity: EventData @Called when the player flips an entity. This event is only fired when the entity actually changes its orientation or mirroring, so it won't be triggered when pressing the flip keys on an entity that can't be flipped. This event reflects a change in the [LuaEntity::mirroring](runtime:LuaEntity::mirroring) property.
  ---@field entity LuaEntity @The flipped entity.
  ---@field horizontal boolean @The enacted flip. `true` means a horizontal flip, `false` a vertical one.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerInputMethodChanged: EventData @Called when a player's input method changes. See [LuaPlayer::input_method](runtime:LuaPlayer::input_method).
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player whose input method changed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerKicked: EventData @Called when a player is kicked.
  ---@field by_player uint32 @nilable; The player that did the kicking if any.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player kicked.
  ---@field reason string @nilable; The reason given if any.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerLocaleChanged: EventData @Called when a player's active locale changes. See [LuaPlayer::locale](runtime:LuaPlayer::locale).
  ...
  ---@field player_index uint32 @The player whose locale was changed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerMinedEntity: EventData @Called after the results of an entity being mined are collected just before the entity is destroyed. After this event any items in the buffer will be transferred into the player as if they came from mining the entity. The buffer inventory is special in that it's only valid during this event and has a dynamic size expanding as more items are transferred into it.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The index of the player doing the mining.
  ---@field tick uint32 @Tick the event was generated.

---@class OnPlayerMinedItem: EventData @Called when the player mines something.
  ---@field item_stack ItemWithQualityCount @The item given to the player
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerMinedTile: EventData @Called after a player mines tiles.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32
  ---@field surface_index uint32 @The surface the tile(s) were mined from.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tiles OldTileAndPosition[] @The position data.
...
---@class OnPlayerRemoved: EventData @Called when a player is removed (deleted) from the game. This is markedly different from a player temporarily [leaving](runtime:on_player_left_game) the game, and instead behaves like the player never existed in the save file.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The index of the removed player.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerSetupBlueprint: EventData @Called when a player selects an area with a blueprint.
  ...
  ---@field area BoundingBox @The area selected.
  ---@field item string @The item used to select the area.
  ---@field mapping table<uint32, LuaEntity> @The blueprint entity index to source entity mapping. Note: if any mod changes the blueprint this will be incorrect.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player doing the selection.
  ---@field quality string @The item quality used to select the area.
  ---@field record LuaRecord @nilable; The record that is being reassigned.
  ---@field stack LuaItemStack @nilable; The item stack used to select the area.
  ---@field surface LuaSurface @The surface selected.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPlayerUnbanned: EventData @Called when a player is un-banned.
  ---@field by_player uint32 @nilable; The player that did the un-banning if any.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player un-banned.
...
---@class OnPlayerUsedSpidertronRemote: EventData @Called when a player uses spidertron remote to send all selected units to a given position
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player that used the remote.
...
---@class OnPostEntityDied: EventData @Called after an entity dies.
  ...
  ---@field surface_index uint32 @The surface the entity was on.
  ---@field tick uint32 @Tick the event was generated.
  ---@field unit_number uint32 @nilable; The unit number the entity had if any.

---@class OnPostSegmentedUnitDied: EventData @Called after a segmented unit dies.
  ---@field damage_type LuaDamagePrototype @nilable; The damage type that did the killing if any.
  ---@field force LuaForce @nilable; The force that did the killing if any.
  ---@field name defines.events @Identifier of the event
  ---@field prototype LuaEntityPrototype @The prototype of the unit that died.
  ---@field quality LuaQualityPrototype @The quality of the unit that died.
  ---@field segments PostSegmentDiedData @Information about each of the unit's individual segments when it died.
  ---@field surface_index uint32 @The surface the entity was on.
  ---@field tick uint32 @Tick the event was generated.
  ---@field unit_number uint32 @The unit number of the unit that died.
...
---@class OnPreBuild: EventData @Called when players uses an item to build something. Called before [on_built_entity](runtime:on_built_entity).
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who did the placing.
...
---@class OnPreGhostDeconstructed: EventData @Called before a ghost entity is destroyed as a result of being marked for deconstruction. Also called for item request proxies before they are destroyed as a result of being marked for deconstruction.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that did the deconstruction if any.
  ---@field tick uint32 @Tick the event was generated.

---@class OnPreGhostUpgraded: EventData @Called before a ghost entity is upgraded.
  ---@field ghost LuaEntity
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that did the upgrade if any.
  ---@field quality LuaQualityPrototype
  ---@field target LuaEntityPrototype
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPrePermissionStringImported: EventData @Called directly before a permission string is imported.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player importing the string.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPrePlayerCraftedItem: EventData @Called when a player queues something to be crafted.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player doing the crafting.
  ---@field queued_count uint32 @The number of times the recipe is being queued.
...
---@class OnPreScenarioFinished: EventData @Called just before the scenario finishes.
  ---@field name defines.events @Identifier of the event
  ---@field player_won boolean @If a player won
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnPreScriptInventoryResized: EventData @Called just before a script inventory is resized.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field new_size uint32 @The new inventory size.
  ---@field old_size uint32 @The old inventory size.
  ---@field player_index uint32 @nilable; If done by console command; the player who ran the command.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnRedoApplied: EventData @Called when the player triggers "redo".
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who triggered the redo action.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnResearchCancelled: EventData @Called when research is cancelled.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player who cancelled the research if any.
  ---@field research table<string, uint32> @A mapping of technology name to how many times it was cancelled.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnResearchMoved: EventData @Called when research is moved forwards or backwards in the research queue.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player who did the re-arranging if any.
  ---@field tick uint32 @Tick the event was generated.

---@class OnResearchQueued: EventData @Called when research is queued.
  ---@field force LuaForce @The force whose research was queued.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player who queued the research if any.
  ---@field research LuaTechnology @The technology queued
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnRobotBuiltTile: EventData @Called after a robot builds tiles.
  ...
  ---@field surface_index uint32 @The surface the tile(s) are build on.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tile LuaTilePrototype @The tile prototype that was placed.
  ---@field tiles OldTileAndPosition[] @The position data.
...
---@class OnRobotMined: EventData @Called when a robot mines an entity.
  ---@field item_stack ItemWithQualityCount @The entity the robot just picked up.
  ---@field name defines.events @Identifier of the event
...
---@class OnRobotMinedTile: EventData @Called after a robot mines tiles.
  ---@field name defines.events @Identifier of the event
  ---@field robot LuaEntity @The robot.
  ---@field surface_index uint32 @The surface the tile(s) were mined on.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tiles OldTileAndPosition[] @The position data.
...
---@class OnRocketLaunchOrdered: EventData @Called when a rocket silo is ordered to be launched.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player that is riding the rocket, if any.
  ---@field rocket LuaEntity
  ---@field rocket_silo LuaEntity
  ---@field tick uint32 @Tick the event was generated.

---@class OnRocketLaunched: EventData @Called when a rocket finishes ascending. (Triggers listening for finished rocket launch past 2.0 have been moved to 'on_cargo_pod_finished_ascending' as rocket and cargo pod are two separate entities)
  ---@field name defines.events @Identifier of the event
  ---@field rocket LuaEntity
...
---@class OnScriptPathRequestFinished: EventData @Called when a [LuaSurface::request_path](runtime:LuaSurface::request_path) call completes.
  ---@field id uint32 @Handle to associate the callback with a particular call to [LuaSurface::request_path](runtime:LuaSurface::request_path).
  ---@field name defines.events @Identifier of the event
...
---@class OnScriptTriggerEffect: EventData @Called when a script trigger effect is triggered.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field quality string @nilable
  ---@field source_entity LuaEntity @nilable
  ---@field source_position MapPosition @nilable
  ---@field surface_index uint32 @The surface the effect happened on.
...
---@class OnSegmentedUnitCreated: EventData @Called when a segmented unit is created for any reason.
  ---@field cause defines.segmented_unit_created_cause @The reason that the segmented unit was created.
  ---@field clone_source LuaSegmentedUnit @nilable; If the new segmented unit was cloned, the segmented unit from which the new unit was cloned.
  ---@field name defines.events @Identifier of the event
  ---@field segmented_unit LuaSegmentedUnit @The segmented unit that was created.
  ---@field tick uint32 @Tick the event was generated.

---@class OnSegmentedUnitDamaged: EventData @Called when a segmented unit is damaged. This is not called when a segmented unit's health is set directly by another mod.
  ---@field cause LuaEntity @nilable; The entity that originally triggered the events that led to this damage, if available (e.g. the character, turret, etc. that pulled the trigger).
  ---@field damage_type LuaDamagePrototype
  ---@field final_damage_amount float @The damage amount after resistances.
  ---@field final_health float @The health of the unit after the damage was applied.
  ---@field force LuaForce @nilable; The force that did the attacking.
  ---@field name defines.events @Identifier of the event
  ---@field original_damage_amount float @The damage amount before resistances.
...
---@class OnSegmentedUnitDied: EventData @Called when a segmented unit dies.
  ---@field cause LuaEntity @nilable; The entity that did the killing if available.
  ---@field damage_type LuaDamagePrototype @nilable; The damage type if any.
  ---@field force LuaForce @nilable; The force that did the killing if any.
  ---@field name defines.events @Identifier of the event
  ---@field segmented_unit LuaSegmentedUnit @The unit that died.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnSelectedEntityChanged: EventData @Called after the selected entity changes for a given player.
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player whose selected entity changed.
  ---@field tick uint32 @Tick the event was generated.

---@class OnSingleplayerInit: EventData @Called when [LuaGameScript::is_multiplayer](runtime:LuaGameScript::is_multiplayer) changes to false. May also be raised when it was already false but a game was loaded from a save file without hosting.
  ---@field name defines.events @Identifier of the event
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnSpacePlatformMinedItem: EventData @Called when a platform mines an entity.
  ---@field item_stack ItemWithQualityCount @The entity the platform just picked up.
  ---@field name defines.events @Identifier of the event
...
---@class OnStringTranslated: EventData @Called when a translation request generated through [LuaPlayer::request_translation](runtime:LuaPlayer::request_translation) or [LuaPlayer::request_translations](runtime:LuaPlayer::request_translations) has been completed.
  ---@field id uint32 @The unique id for this translation request.
  ---@field localised_string LocalisedString @The localised string being translated.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player whose locale was used for the translation.
...
---@class OnTerritoryCreated: EventData @Called when a territory is created for any reason.
  ---@field cause defines.territory_created_cause @The reason the territory was created.
  ---@field name defines.events @Identifier of the event
  ---@field territory LuaTerritory @The territory that was created.
  ---@field tick uint32 @Tick the event was generated.

---@class OnTerritoryDestroyed: EventData @Called when a territory is destroyed from a surface.
  ---@field name defines.events @Identifier of the event
  ---@field territory LuaTerritory @The territory that will be destroyed. This object will be valid so that you can still read and modify its properties before it is finally destroyed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnTowerMinedPlant: EventData @Called after the results of an entity being mined are collected just before the entity is destroyed. After this event any items in the buffer will be transferred into the tower as if they came from mining the entity. The buffer inventory is special in that it's only valid during this event and has a dynamic size expanding as more items are transferred into it.
  ---@field buffer LuaInventory @The temporary inventory that holds the result of mining the entity.
  ---@field name defines.events @Identifier of the event
  ---@field plant LuaEntity @The entity that has been mined.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tower LuaEntity @The tower doing the mining.

---@class OnTowerPlantedSeed: EventData @Called before an agricultural tower plants a seed.
  ---@field name defines.events @Identifier of the event
  ---@field plant LuaEntity @The plant that was planted.
  ---@field seed ItemIDAndQualityIDPair @The seed that was used.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tower LuaEntity @The tower that did the planting.

---@class OnTowerPreMinedPlant: EventData @Called before an agricultural tower mines a plant.
  ---@field name defines.events @Identifier of the event
  ---@field plant LuaEntity @The plant that is about to be mined.
  ---@field tick uint32 @Tick the event was generated.
  ---@field tower LuaEntity @The tower that is about to do the mining.
...
---@class OnTrainCreated: EventData @Called when a new train is created either through disconnecting/connecting an existing one or building a new one.
  ---@field name defines.events @Identifier of the event
  ---@field old_train_id_1 uint32 @nilable; The first old train id when splitting/merging trains.
  ---@field old_train_id_2 uint32 @nilable; The second old train id when splitting/merging trains.
  ---@field tick uint32 @Tick the event was generated.
  ---@field train LuaTrain

---@class OnTrainScheduleChanged: EventData @Called when a trains schedule is changed either by the player or through script.
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @nilable; The player who made the change if any.
  ---@field tick uint32 @Tick the event was generated.
  ---@field train LuaTrain
...
---@class OnUdpPacketReceived: EventData @Called when new packets are processed by [LuaHelpers::recv_udp](runtime:LuaHelpers::recv_udp).
  ---@field name defines.events @Identifier of the event
  ---@field payload string @The packet data
  ---@field player_index uint32 @The player index whose instance received this packet, or 0 if received on the server
  ---@field source_port uint16 @The source port the packet was received from
  ---@field tick uint32 @Tick the event was generated.
...
---@class OnUndoApplied: EventData @Called when the player triggers "undo".
  ...
  ---@field name defines.events @Identifier of the event
  ---@field player_index uint32 @The player who triggered the undo action.
  ---@field tick uint32 @Tick the event was generated.
...
---@class ScriptRaisedSetTiles: EventData @A static event mods can use to tell other mods they changed tiles on a surface by script. This event is only raised if a mod does so with [LuaBootstrap::raise_event](runtime:LuaBootstrap::raise_event) or [LuaBootstrap::raise_script_set_tiles](runtime:LuaBootstrap::raise_script_set_tiles), or when `raise_event` is passed to [LuaSurface::set_tiles](runtime:LuaSurface::set_tiles).
  ---@field name defines.events @Identifier of the event
  ---@field surface_index uint32 @The surface whose tiles were changed.
  ---@field tick uint32 @Tick the event was generated.
...
---@class GameViewSettings
  ...
  ---@field show_hotkey_suggestions boolean @Shows or hides the mouse and keyboard/controller button hints in the bottom left corner if they are enabled in the interface settings.
  ---@field show_surface_list boolean @Shows or hides the surface list while in Remote View.
...
---@class MapSettings
  ...
  ---@field max_failed_behavior_count uint32 @If a behavior fails this many times, the enemy (or enemy group) is destroyed. This solves biters getting stuck within their own base.
